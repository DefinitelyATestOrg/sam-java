...
To set a documented parameter or property to an undocumented or not yet supported _value_, pass a [`JsonValue`](sam-java-core/src/main/kotlin/me/elborai/api/core/JsonValue.kt) object to its setter:
...
Map<String, JsonValue> additionalProperties = client.user().create(params)._additionalProperties();
...
JsonField<Object> field = client.user().create(params)._field();
...
User user = client.user().create(params).validate();
```
