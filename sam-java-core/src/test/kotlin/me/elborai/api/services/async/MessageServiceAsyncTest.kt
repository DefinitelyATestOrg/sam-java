...
class MessageServiceAsyncTest {
    ...
    fun create() {
      ...
      val messageFuture = messageServiceAsync.create(MessageCreateParams.builder()
          ...
          .stream(true)
          .systemOfRequestTextBlocks(listOf(MessageCreateParams.System.RequestTextBlock.builder()
              .text("Today's date is 2024-06-01.")
              .type(MessageCreateParams.System.RequestTextBlock.Type.TEXT)
              .cacheControl(MessageCreateParams.System.RequestTextBlock.CacheControl.builder()
                  .type(MessageCreateParams.System.RequestTextBlock.CacheControl.Type.EPHEMERAL)
                  .build())
              .addCitation(MessageCreateParams.System.RequestTextBlock.Citation.RequestCharLocationCitation.builder()
                  .citedText("cited_text")
                  .documentIndex(0L)
                  .documentTitle("x")
                  .endCharIndex(0L)
                  .startCharIndex(0L)
                  .type(MessageCreateParams.System.RequestTextBlock.Citation.RequestCharLocationCitation.Type.CHAR_LOCATION)
                  .build())
              .build()))
          .temperature(1.0)
          .configEnabledThinking(1024L)
          .toolChoice(MessageCreateParams.ToolChoice.ToolChoiceAuto.builder()
              .type(MessageCreateParams.ToolChoice.ToolChoiceAuto.Type.AUTO)
              .disableParallelToolUse(true)
              .build())
          .addTool(MessageCreateParams.Tool.InnerTool.builder()
              .inputSchema(MessageCreateParams.Tool.InnerTool.InputSchema.builder()
                  ...
                  .build())
              .name("name")
              .cacheControl(MessageCreateParams.Tool.InnerTool.CacheControl.builder()
    ...
    fun countTokens() {
      ...
      val responseFuture = messageServiceAsync.countTokens(MessageCountTokensParams.builder()
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
          .addMessage(MessageCountTokensParams.Message.builder()
              .content("Hello, world")
              .role(MessageCountTokensParams.Message.Role.USER)
              .build())
          .model("claude-3-7-sonnet-20250219")
          .systemOfRequestTextBlocks(listOf(MessageCountTokensParams.System.RequestTextBlock.builder()
              .text("Today's date is 2024-06-01.")
              .type(MessageCountTokensParams.System.RequestTextBlock.Type.TEXT)
              .cacheControl(MessageCountTokensParams.System.RequestTextBlock.CacheControl.builder()
                  .type(MessageCountTokensParams.System.RequestTextBlock.CacheControl.Type.EPHEMERAL)
                  .build())
              .addCitation(MessageCountTokensParams.System.RequestTextBlock.Citation.RequestCharLocationCitation.builder()
                  .citedText("cited_text")
                  .documentIndex(0L)
                  .documentTitle("x")
                  .endCharIndex(0L)
                  .startCharIndex(0L)
                  .type(MessageCountTokensParams.System.RequestTextBlock.Citation.RequestCharLocationCitation.Type.CHAR_LOCATION)
                  .build())
              .build()))
          .configEnabledThinking(1024L)
          .toolChoice(MessageCountTokensParams.ToolChoice.ToolChoiceAuto.builder()
              .type(MessageCountTokensParams.ToolChoice.ToolChoiceAuto.Type.AUTO)
              .disableParallelToolUse(true)
              .build())
          .addTool(MessageCountTokensParams.Tool.InnerTool.builder()
              .inputSchema(MessageCountTokensParams.Tool.InnerTool.InputSchema.builder()
                  ...
                  .build())
              .name("name")
              .cacheControl(MessageCountTokensParams.Tool.InnerTool.CacheControl.builder()
                  .type(MessageCountTokensParams.Tool.InnerTool.CacheControl.Type.EPHEMERAL)
                  .build())
              .description("Get the current weather in a given location")
              .build())
          .build())
    ...
    fun countTokensBeta() {
      ...
      val responseFuture = messageServiceAsync.countTokensBeta(MessageCountTokensBetaParams.builder()
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
