...
class BatchServiceTest {
    ...
    fun create() {
      ...
      val batch = batchService.create(BatchCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val batch = batchService.retrieve(BatchRetrieveParams.builder()
    ...
    fun list() {
      ...
      val batch = batchService.list(BatchListParams.builder()
          .afterId("after_id")
          .beforeId("before_id")
          .limit(1L)
          .addAnthropicBeta("string")
    ...
    fun delete() {
      ...
      val batch = batchService.delete(BatchDeleteParams.builder()
          .messageBatchId("message_batch_id")
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
    ...
    fun cancel() {
      ...
      val response = batchService.cancel(BatchCancelParams.builder()
          .messageBatchId("message_batch_id")
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
    ...
    fun cancelBeta() {
      ...
      val response = batchService.cancelBeta(BatchCancelBetaParams.builder()
          .messageBatchId("message_batch_id")
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
    ...
    fun resultsStreaming() {
      ...
      val responseStreamResponse = batchService.resultsStreaming(BatchResultsParams.builder()
          .messageBatchId("message_batch_id")
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
      ...
      responseStreamResponse.use {
          responseStreamResponse.stream().forEach { response ->
              response.validate()
          }
      }
    }
    ...
    fun resultsBetaStreaming() {
      ...
      val responseStreamResponse = batchService.resultsBetaStreaming(BatchResultsBetaParams.builder()
          .messageBatchId("message_batch_id")
          .addAnthropicBeta("string")
          .anthropicVersion("anthropic-version")
          .xApiKey("x-api-key")
