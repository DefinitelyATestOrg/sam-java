...
internal class BatchesBetaTrueServiceAsyncTest {
    ...
    fun create() {
        ...
        val batchesBetaTrueFuture =
            batchesBetaTrueServiceAsync.create(
    ...
    fun list() {
        ...
        val batchesBetaTrues = batchesBetaTruesFuture.get()
