...
class MessagesBetaTrueServiceAsyncTest {
    ...
    fun create() {
      val client = SamOkHttpClientAsync.builder()
          ...
          .apiKey("My API Key")
          .build()
      val messagesBetaTrueServiceAsync = client.messagesBetaTrue()

      val messagesBetaTrueFuture = messagesBetaTrueServiceAsync.create(MessagesBetaTrueCreateParams.builder()
      ...
      val messagesBetaTrue = messagesBetaTrueFuture.get()
