...
class BatchesBetaTrueListResponseTest {

    @Test
    fun createBatchesBetaTrueListResponse() {
      val batchesBetaTrueListResponse = BatchesBetaTrueListResponse.builder()
          .addData(BatchesBetaTrueListResponse.Data.builder()
              ...
              .requestCounts(BatchesBetaTrueListResponse.Data.RequestCounts.builder()
                  .canceled(10L)
                  .errored(30L)
                  .expired(10L)
                  .processing(100L)
          ...
          .lastId("last_id")
          .build()
      assertThat(batchesBetaTrueListResponse).isNotNull
      assertThat(batchesBetaTrueListResponse.data()).containsExactly(BatchesBetaTrueListResponse.Data.builder()
          .id("msgbatch_013Zva2CMHLNnXjNJJKqJ2EF")
          .archivedAt(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
          .cancelInitiatedAt(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
          .createdAt(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
          ...
          .type(BatchesBetaTrueListResponse.Data.Type.MESSAGE_BATCH)
          .build())
      assertThat(batchesBetaTrueListResponse.firstId()).contains("first_id")
      assertThat(batchesBetaTrueListResponse.hasMore()).isEqualTo(true)
      assertThat(batchesBetaTrueListResponse.lastId()).contains("last_id")
    }
}
