...
class ModelsBetaTrueListResponseTest {
    ...
    fun createModelsBetaTrueListResponse() {
        ...
        assertThat(modelsBetaTrueListResponse.firstId()).contains("first_id")
        assertThat(modelsBetaTrueListResponse.hasMore()).isEqualTo(true)
        assertThat(modelsBetaTrueListResponse.lastId()).contains("last_id")
    }
}
