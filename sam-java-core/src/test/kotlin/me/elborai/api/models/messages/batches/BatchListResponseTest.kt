...
class BatchListResponseTest {
    ...
    fun createBatchListResponse() {
      val batchListResponse = BatchListResponse.builder()
          .addData(BatchListResponse.Data.builder()
              ...
              .requestCounts(BatchListResponse.Data.RequestCounts.builder()
                  .canceled(10L)
                  .errored(30L)
                  .expired(10L)
                  .processing(100L)
      ...
      assertThat(batchListResponse.data()).containsExactly(BatchListResponse.Data.builder()
          .id("msgbatch_013Zva2CMHLNnXjNJJKqJ2EF")
          .archivedAt(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
          .cancelInitiatedAt(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
          .createdAt(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
          ...
          .type(BatchListResponse.Data.Type.MESSAGE_BATCH)
          .build())
      assertThat(batchListResponse.firstId()).contains("first_id")
      assertThat(batchListResponse.hasMore()).isEqualTo(true)
      assertThat(batchListResponse.lastId()).contains("last_id")
    }
}
