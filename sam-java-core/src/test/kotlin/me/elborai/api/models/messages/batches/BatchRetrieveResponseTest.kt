...
class BatchRetrieveResponseTest {
    ...
    fun createBatchRetrieveResponse() {
      ...
      assertThat(batchRetrieveResponse.archivedAt()).contains(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
      assertThat(batchRetrieveResponse.cancelInitiatedAt()).contains(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
      assertThat(batchRetrieveResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
      assertThat(batchRetrieveResponse.endedAt()).contains(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
      ...
      assertThat(batchRetrieveResponse.requestCounts()).isEqualTo(BatchRetrieveResponse.RequestCounts.builder()
          ...
          .succeeded(50L)
          .build())
      assertThat(batchRetrieveResponse.resultsUrl()).contains("https://api.anthropic.com/v1/messages/batches/msgbatch_013Zva2CMHLNnXjNJJKqJ2EF/results")
