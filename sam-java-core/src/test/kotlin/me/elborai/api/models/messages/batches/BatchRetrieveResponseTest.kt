    ...
    fun create() {
        val batchRetrieveResponse =
            BatchRetrieveResponse.builder()
                ...
                .requestCounts(
                    BatchRetrieveResponse.RequestCounts.builder()
                        .canceled(10L)
                        .errored(30L)
                        .expired(10L)
                        .processing(100L)
        ...
        assertThat(batchRetrieveResponse.archivedAt())
            .contains(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
        assertThat(batchRetrieveResponse.cancelInitiatedAt())
            .contains(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
        assertThat(batchRetrieveResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
        assertThat(batchRetrieveResponse.endedAt())
            .contains(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
        assertThat(batchRetrieveResponse.expiresAt())
            .isEqualTo(OffsetDateTime.parse("2024-08-20T18:37:24.100435Z"))
        assertThat(batchRetrieveResponse.processingStatus())
            .isEqualTo(BatchRetrieveResponse.ProcessingStatus.IN_PROGRESS)
        assertThat(batchRetrieveResponse.requestCounts())
            .isEqualTo(
                BatchRetrieveResponse.RequestCounts.builder()
                    .canceled(10L)
                    .errored(30L)
        ...
        assertThat(batchRetrieveResponse.resultsUrl())
            .contains(
                "https://api.anthropic.com/v1/messages/batches/msgbatch_013Zva2CMHLNnXjNJJKqJ2EF/results"
            )
    }
