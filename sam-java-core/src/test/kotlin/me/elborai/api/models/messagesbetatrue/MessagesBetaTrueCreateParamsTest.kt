...
class MessagesBetaTrueCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.metadata()).contains(MessagesBetaTrueCreateParams.Metadata.builder()
          .userId("13803d75-b4b5-4c3e-b2a2-6f21399b021b")
          .build())
      assertThat(body.stopSequences()).contains(listOf("string"))
      assertThat(body.stream()).contains(true)
      assertThat(body.system()).contains(MessagesBetaTrueCreateParams.System.ofBetaRequestTextBlocks(listOf(MessagesBetaTrueCreateParams.System.BetaRequestTextBlock.builder()
          .text("Today's date is 2024-06-01.")
          .type(MessagesBetaTrueCreateParams.System.BetaRequestTextBlock.Type.TEXT)
          .cacheControl(MessagesBetaTrueCreateParams.System.BetaRequestTextBlock.CacheControl.builder()
              .type(MessagesBetaTrueCreateParams.System.BetaRequestTextBlock.CacheControl.Type.EPHEMERAL)
      ...
      assertThat(body.thinking()).contains(MessagesBetaTrueCreateParams.Thinking.ofBetaThinkingConfigEnabled(MessagesBetaTrueCreateParams.Thinking.BetaThinkingConfigEnabled.builder()
          .budgetTokens(1024L)
          .type(MessagesBetaTrueCreateParams.Thinking.BetaThinkingConfigEnabled.Type.ENABLED)
          .build()))
      assertThat(body.toolChoice()).contains(MessagesBetaTrueCreateParams.ToolChoice.ofBetaToolChoiceAuto(MessagesBetaTrueCreateParams.ToolChoice.BetaToolChoiceAuto.builder()
          .type(MessagesBetaTrueCreateParams.ToolChoice.BetaToolChoiceAuto.Type.AUTO)
          .disableParallelToolUse(true)
          .build()))
      assertThat(body.tools()).contains(listOf(MessagesBetaTrueCreateParams.Tool.ofBeta(MessagesBetaTrueCreateParams.Tool.BetaTool.builder()
          .inputSchema(MessagesBetaTrueCreateParams.Tool.BetaTool.InputSchema.builder()
              .type(MessagesBetaTrueCreateParams.Tool.BetaTool.InputSchema.Type.OBJECT)
              .properties(JsonValue.from(mapOf(
                "location" to mapOf(
