...
class InboundFundsHoldReleaseResponseTest {
    ...
    fun createInboundFundsHoldReleaseResponse() {
      ...
      assertThat(inboundFundsHoldReleaseResponse.heldTransactionId()).contains("held_transaction_id")
      assertThat(inboundFundsHoldReleaseResponse.pendingTransactionId()).contains("pending_transaction_id")
      assertThat(inboundFundsHoldReleaseResponse.releasedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
