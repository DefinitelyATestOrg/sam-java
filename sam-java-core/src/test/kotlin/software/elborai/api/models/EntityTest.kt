...
class EntityTest {
    ...
    fun createEntity() {
      val entity = Entity.builder()
          ...
          .supplementalDocuments(listOf(Entity.SupplementalDocument.builder()
              .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .fileId("file_id")
              .idempotencyKey("idempotency_key")
      ...
      assertThat(entity.corporation()).contains(Entity.Corporation.builder()
          .address(Entity.Corporation.Address.builder()
              .city("city")
              .line1("line1")
              .line2("line2")
      ...
      assertThat(entity.detailsConfirmedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(entity.governmentAuthority()).contains(Entity.GovernmentAuthority.builder()
          .address(Entity.GovernmentAuthority.Address.builder()
              .city("city")
              .line1("line1")
              .line2("line2")
      ...
      assertThat(entity.joint()).contains(Entity.Joint.builder()
          .individuals(listOf(Entity.Joint.Individual.builder()
              .address(Entity.Joint.Individual.Address.builder()
                  .city("city")
                  .line1("line1")
          ...
          .name("name")
          .build())
      assertThat(entity.naturalPerson()).contains(Entity.NaturalPerson.builder()
          .address(Entity.NaturalPerson.Address.builder()
              .city("city")
              .line1("line1")
              .line2("line2")
      ...
      assertThat(entity.supplementalDocuments()).containsExactly(Entity.SupplementalDocument.builder()
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .fileId("file_id")
          .idempotencyKey("idempotency_key")
          .type(Entity.SupplementalDocument.Type.ENTITY_SUPPLEMENTAL_DOCUMENT)
          .build())
      assertThat(entity.trust()).contains(Entity.Trust.builder()
          .address(Entity.Trust.Address.builder()
              .city("city")
              .line1("line1")
              .line2("line2")
