...
class InboundAchTransferTest {
    ...
    fun createInboundAchTransfer() {
        ...
        assertThat(inboundAchTransfer.originatorCompanyDescriptiveDate()).contains("string")
        assertThat(inboundAchTransfer.originatorCompanyDiscretionaryData()).contains("string")
        ...
        assertThat(inboundAchTransfer.receiverIdNumber()).contains("string")
        assertThat(inboundAchTransfer.receiverName()).contains("string")
