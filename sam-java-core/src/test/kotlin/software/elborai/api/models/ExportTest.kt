...
class ExportTest {
    ...
    fun createExport() {
        ...
        assertThat(export.fileDownloadUrl()).contains("file_download_url")
        assertThat(export.fileId()).contains("file_id")
        assertThat(export.idempotencyKey()).contains("idempotency_key")
