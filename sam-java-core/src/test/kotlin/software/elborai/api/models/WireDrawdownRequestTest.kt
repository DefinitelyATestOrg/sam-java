...
class WireDrawdownRequestTest {
    ...
    fun createWireDrawdownRequest() {
      ...
      assertThat(wireDrawdownRequest.fulfillmentTransactionId()).contains("fulfillment_transaction_id")
      ...
      assertThat(wireDrawdownRequest.originatorAddressLine1()).contains("originator_address_line1")
      assertThat(wireDrawdownRequest.originatorAddressLine2()).contains("originator_address_line2")
      assertThat(wireDrawdownRequest.originatorAddressLine3()).contains("originator_address_line3")
