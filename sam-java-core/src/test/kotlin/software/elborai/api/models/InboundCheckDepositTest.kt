...
class InboundCheckDepositTest {
    ...
    fun createInboundCheckDeposit() {
      ...
      assertThat(inboundCheckDeposit.acceptedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(inboundCheckDeposit.bankOfFirstDepositRoutingNumber()).contains("bank_of_first_deposit_routing_number")
      ...
      assertThat(inboundCheckDeposit.declinedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(inboundCheckDeposit.declinedTransactionId()).contains("declined_transaction_id")
      assertThat(inboundCheckDeposit.depositReturn()).contains(InboundCheckDeposit.DepositReturn.builder()
          .returnedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .transactionId("transaction_id")
          .build())
