...
class AccountTransferTest {
    ...
    fun createAccountTransfer() {
      ...
      assertThat(accountTransfer.approval()).contains(AccountTransfer.Approval.builder()
          .approvedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .approvedBy("approved_by")
          .build())
      assertThat(accountTransfer.cancellation()).contains(AccountTransfer.Cancellation.builder()
          .canceledAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .canceledBy("canceled_by")
          .build())
      assertThat(accountTransfer.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(accountTransfer.createdBy()).contains(AccountTransfer.CreatedBy.builder()
          .apiKey(AccountTransfer.CreatedBy.ApiKey.builder()
              .description("description")
              .build())
          .category(AccountTransfer.CreatedBy.Category.API_KEY)
      ...
      assertThat(accountTransfer.destinationTransactionId()).contains("destination_transaction_id")
