...
class InboundMailItemTest {
    ...
    fun createInboundMailItem() {
      ...
      assertThat(inboundMailItem.rejectionReason()).contains(InboundMailItem.RejectionReason.NO_MATCHING_LOCKBOX)
      assertThat(inboundMailItem.returnAddress()).contains(InboundMailItem.ReturnAddress.builder()
          .city("city")
          .line1("line1")
          .line2("line2")
          .name("name")
