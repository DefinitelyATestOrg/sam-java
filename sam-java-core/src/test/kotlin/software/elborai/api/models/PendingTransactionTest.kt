...
class PendingTransactionTest {
    ...
    fun createPendingTransaction() {
      ...
      assertThat(pendingTransaction.completedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(pendingTransaction.routeType()).contains(PendingTransaction.RouteType.ACCOUNT_NUMBER)
