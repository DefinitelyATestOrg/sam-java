...
class InboundInternationalAchTransferTest {
    ...
    fun createInboundInternationalAchTransfer() {
      ...
      assertThat(inboundInternationalAchTransfer.foreignExchangeReference()).contains("foreign_exchange_reference")
      ...
      assertThat(inboundInternationalAchTransfer.foreignTraceNumber()).contains("foreign_trace_number")
      ...
      assertThat(inboundInternationalAchTransfer.originatorPostalCode()).contains("originator_postal_code")
      assertThat(inboundInternationalAchTransfer.originatorStateOrProvince()).contains("originator_state_or_province")
      assertThat(inboundInternationalAchTransfer.originatorStreetAddress()).isEqualTo("originator_street_address")
      assertThat(inboundInternationalAchTransfer.paymentRelatedInformation()).contains("payment_related_information")
      assertThat(inboundInternationalAchTransfer.paymentRelatedInformation2()).contains("payment_related_information2")
      ...
      assertThat(inboundInternationalAchTransfer.receiverIdentificationNumber()).contains("receiver_identification_number")
      assertThat(inboundInternationalAchTransfer.receiverPostalCode()).contains("receiver_postal_code")
      assertThat(inboundInternationalAchTransfer.receiverStateOrProvince()).contains("receiver_state_or_province")
