...
class InboundWireTransferTest {
    ...
    fun createInboundWireTransfer() {
      ...
      assertThat(inboundWireTransfer.beneficiaryAddressLine1()).contains("beneficiary_address_line1")
      assertThat(inboundWireTransfer.beneficiaryAddressLine2()).contains("beneficiary_address_line2")
      assertThat(inboundWireTransfer.beneficiaryAddressLine3()).contains("beneficiary_address_line3")
      ...
      assertThat(inboundWireTransfer.inputMessageAccountabilityData()).contains("input_message_accountability_data")
      assertThat(inboundWireTransfer.originatorAddressLine1()).contains("originator_address_line1")
      assertThat(inboundWireTransfer.originatorAddressLine2()).contains("originator_address_line2")
      assertThat(inboundWireTransfer.originatorAddressLine3()).contains("originator_address_line3")
      assertThat(inboundWireTransfer.originatorName()).contains("originator_name")
      assertThat(inboundWireTransfer.originatorRoutingNumber()).contains("originator_routing_number")
      assertThat(inboundWireTransfer.originatorToBeneficiaryInformation()).contains("originator_to_beneficiary_information")
      assertThat(inboundWireTransfer.originatorToBeneficiaryInformationLine1()).contains("originator_to_beneficiary_information_line1")
      assertThat(inboundWireTransfer.originatorToBeneficiaryInformationLine2()).contains("originator_to_beneficiary_information_line2")
      assertThat(inboundWireTransfer.originatorToBeneficiaryInformationLine3()).contains("originator_to_beneficiary_information_line3")
      assertThat(inboundWireTransfer.originatorToBeneficiaryInformationLine4()).contains("originator_to_beneficiary_information_line4")
