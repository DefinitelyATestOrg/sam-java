...
class ProofOfAuthorizationRequestSubmissionTest {
    ...
    fun createProofOfAuthorizationRequestSubmission() {
      ...
      assertThat(proofOfAuthorizationRequestSubmission.authorizerCompany()).contains("authorizer_company")
      assertThat(proofOfAuthorizationRequestSubmission.authorizerEmail()).contains("authorizer_email")
      assertThat(proofOfAuthorizationRequestSubmission.authorizerIpAddress()).contains("authorizer_ip_address")
      assertThat(proofOfAuthorizationRequestSubmission.authorizerName()).contains("authorizer_name")
      assertThat(proofOfAuthorizationRequestSubmission.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(proofOfAuthorizationRequestSubmission.customerHasBeenOffboarded()).contains(true)
      assertThat(proofOfAuthorizationRequestSubmission.idempotencyKey()).contains("idempotency_key")
      ...
      assertThat(proofOfAuthorizationRequestSubmission.validatedAccountOwnershipViaCredential()).contains(true)
      assertThat(proofOfAuthorizationRequestSubmission.validatedAccountOwnershipWithAccountStatement()).contains(true)
      assertThat(proofOfAuthorizationRequestSubmission.validatedAccountOwnershipWithMicrodeposit()).contains(true)
    }
}
