...
class SamPlopPlopCreateMessageResponse
private constructor(
    ...
    /** A builder for [SamPlopPlopCreateMessageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(samPlopPlopCreateMessageResponse: SamPlopPlopCreateMessageResponse) =
            apply {
                id = samPlopPlopCreateMessageResponse.id
                content = samPlopPlopCreateMessageResponse.content.map { it.toMutableList() }
                model = samPlopPlopCreateMessageResponse.model
                role = samPlopPlopCreateMessageResponse.role
                stopReason = samPlopPlopCreateMessageResponse.stopReason
                stopSequence = samPlopPlopCreateMessageResponse.stopSequence
                type = samPlopPlopCreateMessageResponse.type
                usage = samPlopPlopCreateMessageResponse.usage
                additionalProperties =
                    samPlopPlopCreateMessageResponse.additionalProperties.toMutableMap()
            }
         ...
         *     .type(SamPlopPlopCreateMessageResponse.Content.ResponseRedactedThinkingBlock.Type.REDACTED_THINKING)
         *     .data(data)
         *     .build()
         * ```
         */
        fun addResponseRedactedThinkingBlockContent(data: String) =
            addContent(
                Content.ResponseRedactedThinkingBlock.builder()
                    .type(
                        SamPlopPlopCreateMessageResponse.Content.ResponseRedactedThinkingBlock.Type
                            .REDACTED_THINKING
                    )
                    .data(data)
                    .build()
        ...
        /**
         * Returns an immutable instance of [SamPlopPlopCreateMessageResponse].
         *
         ...
         */
        fun build(): SamPlopPlopCreateMessageResponse =
            SamPlopPlopCreateMessageResponse(
                checkRequired("id", id),
    ...
    fun validate(): SamPlopPlopCreateMessageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                fun responseContentBlockLocation(): Optional<ResponseContentBlockLocationCitation> =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SamPlopPlopCreateMessageResponse && id == other.id && content == other.content && model == other.model && role == other.role && stopReason == other.stopReason && stopSequence == other.stopSequence && type == other.type && usage == other.usage && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "SamPlopPlopCreateMessageResponse{id=$id, content=$content, model=$model, role=$role, stopReason=$stopReason, stopSequence=$stopSequence, type=$type, usage=$usage, additionalProperties=$additionalProperties}"
}
