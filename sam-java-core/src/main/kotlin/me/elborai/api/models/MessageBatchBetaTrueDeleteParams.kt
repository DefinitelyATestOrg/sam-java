 ...
 */
class MessageBatchBetaTrueDeleteParams
private constructor(
    ...
    companion object {
         ...
         * [MessageBatchBetaTrueDeleteParams].
         *
    ...
    /** A builder for [MessageBatchBetaTrueDeleteParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchBetaTrueDeleteParams: MessageBatchBetaTrueDeleteParams) =
            apply {
                messageBatchId = messageBatchBetaTrueDeleteParams.messageBatchId
                anthropicBeta = messageBatchBetaTrueDeleteParams.anthropicBeta?.toMutableList()
                anthropicVersion = messageBatchBetaTrueDeleteParams.anthropicVersion
                xApiKey = messageBatchBetaTrueDeleteParams.xApiKey
                additionalHeaders = messageBatchBetaTrueDeleteParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    messageBatchBetaTrueDeleteParams.additionalQueryParams.toBuilder()
                additionalBodyProperties =
                    messageBatchBetaTrueDeleteParams.additionalBodyProperties.toMutableMap()
            }
        ...
        fun build(): MessageBatchBetaTrueDeleteParams =
            MessageBatchBetaTrueDeleteParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchBetaTrueDeleteParams && messageBatchId == other.messageBatchId && anthropicBeta == other.anthropicBeta && anthropicVersion == other.anthropicVersion && xApiKey == other.xApiKey && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchBetaTrueDeleteParams{messageBatchId=$messageBatchId, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
