 ...
 */
class BatchListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchListParams: BatchListParams) =
            apply {
                afterId = batchListParams.afterId
                beforeId = batchListParams.beforeId
                limit = batchListParams.limit
                anthropicBeta = batchListParams.anthropicBeta?.toMutableList()
                anthropicVersion = batchListParams.anthropicVersion
                xApiKey = batchListParams.xApiKey
    ...
    override fun toString() = "BatchListParams{afterId=$afterId, beforeId=$beforeId, limit=$limit, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
