...
@NoAutoDetect
class MessageBatchCancelResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageBatchCancelResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageBatchCancelResponse].
         *
    ...
    /** A builder for [MessageBatchCancelResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchCancelResponse: MessageBatchCancelResponse) = apply {
            id = messageBatchCancelResponse.id
            archivedAt = messageBatchCancelResponse.archivedAt
            cancelInitiatedAt = messageBatchCancelResponse.cancelInitiatedAt
            createdAt = messageBatchCancelResponse.createdAt
            endedAt = messageBatchCancelResponse.endedAt
            expiresAt = messageBatchCancelResponse.expiresAt
            processingStatus = messageBatchCancelResponse.processingStatus
            requestCounts = messageBatchCancelResponse.requestCounts
            resultsUrl = messageBatchCancelResponse.resultsUrl
            type = messageBatchCancelResponse.type
            additionalProperties = messageBatchCancelResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageBatchCancelResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchCancelResponse && id == other.id && archivedAt == other.archivedAt && cancelInitiatedAt == other.cancelInitiatedAt && createdAt == other.createdAt && endedAt == other.endedAt && expiresAt == other.expiresAt && processingStatus == other.processingStatus && requestCounts == other.requestCounts && resultsUrl == other.resultsUrl && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchCancelResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
