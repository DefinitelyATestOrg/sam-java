...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BetaTrueDeleteParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BetaTrueDeleteParams]. */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaTrueDeleteParams: BetaTrueDeleteParams) = apply {
        ...
        /**
         * Returns an immutable instance of [BetaTrueDeleteParams].
         *
    ...
    override fun toString() =
        "BetaTrueDeleteParams{messageBatchId=$messageBatchId, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
