...
@NoAutoDetect
class BetaTrueRetrieveResponse @JsonCreator private constructor(
    ...
    fun validate(): BetaTrueRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaTrueRetrieveResponse: BetaTrueRetrieveResponse) =
            apply {
    ...
    override fun toString() = "BetaTrueRetrieveResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
