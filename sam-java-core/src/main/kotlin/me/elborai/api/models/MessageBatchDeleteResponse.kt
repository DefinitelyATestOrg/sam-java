...
private constructor(
    ...
    fun validate(): MessageBatchDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageBatchDeleteResponse].
         *
    ...
    /** A builder for [MessageBatchDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchDeleteResponse: MessageBatchDeleteResponse) = apply {
            id = messageBatchDeleteResponse.id
            type = messageBatchDeleteResponse.type
            additionalProperties = messageBatchDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageBatchDeleteResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchDeleteResponse && id == other.id && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchDeleteResponse{id=$id, type=$type, additionalProperties=$additionalProperties}"
}
