...
@NoAutoDetect
class CompleteCreateResponse @JsonCreator private constructor(
    @JsonProperty("id") @ExcludeMissing private val id: JsonField<String> = JsonMissing.of(),
    @JsonProperty("completion") @ExcludeMissing private val completion: JsonField<String> = JsonMissing.of(),
    @JsonProperty("model") @ExcludeMissing private val model: JsonField<String> = JsonMissing.of(),
    @JsonProperty("stop_reason") @ExcludeMissing private val stopReason: JsonField<String> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _completion(): JsonField<String> = completion
    ...
    @ExcludeMissing
    fun _stopReason(): JsonField<String> = stopReason
    ...
    fun validate(): CompleteCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(completeCreateResponse: CompleteCreateResponse) =
            apply {
        ...
        /** The resulting completion up to and excluding the stop sequences. */
        fun completion(completion: JsonField<String>) =
            apply {
         ...
         * - `"max_tokens"`: we exceeded `max_tokens_to_sample` or the model's maximum
         */
        fun stopReason(stopReason: JsonField<String>) =
            apply {
    ...
    override fun toString() = "CompleteCreateResponse{id=$id, completion=$completion, model=$model, stopReason=$stopReason, type=$type, additionalProperties=$additionalProperties}"
}
