...
@NoAutoDetect
class ModelRetrieveResponse @JsonCreator private constructor(
    ...
    fun validate(): ModelRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(modelRetrieveResponse: ModelRetrieveResponse) =
            apply {
    ...
    override fun toString() = "ModelRetrieveResponse{id=$id, createdAt=$createdAt, displayName=$displayName, type=$type, additionalProperties=$additionalProperties}"
}
