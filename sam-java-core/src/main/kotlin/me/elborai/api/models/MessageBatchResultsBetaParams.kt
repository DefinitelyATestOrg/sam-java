 ...
 */
class MessageBatchResultsBetaParams
private constructor(
    ...
    /** A builder for [MessageBatchResultsBetaParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchResultsBetaParams: MessageBatchResultsBetaParams) = apply {
            messageBatchId = messageBatchResultsBetaParams.messageBatchId
            anthropicBeta = messageBatchResultsBetaParams.anthropicBeta?.toMutableList()
            anthropicVersion = messageBatchResultsBetaParams.anthropicVersion
            xApiKey = messageBatchResultsBetaParams.xApiKey
            additionalHeaders = messageBatchResultsBetaParams.additionalHeaders.toBuilder()
            additionalQueryParams = messageBatchResultsBetaParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): MessageBatchResultsBetaParams =
            MessageBatchResultsBetaParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchResultsBetaParams && messageBatchId == other.messageBatchId && anthropicBeta == other.anthropicBeta && anthropicVersion == other.anthropicVersion && xApiKey == other.xApiKey && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchResultsBetaParams{messageBatchId=$messageBatchId, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
