...
@NoAutoDetect
class MessageBatchCreateResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageBatchCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageBatchCreateResponse].
         *
    ...
    /** A builder for [MessageBatchCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchCreateResponse: MessageBatchCreateResponse) = apply {
            id = messageBatchCreateResponse.id
            archivedAt = messageBatchCreateResponse.archivedAt
            cancelInitiatedAt = messageBatchCreateResponse.cancelInitiatedAt
            createdAt = messageBatchCreateResponse.createdAt
            endedAt = messageBatchCreateResponse.endedAt
            expiresAt = messageBatchCreateResponse.expiresAt
            processingStatus = messageBatchCreateResponse.processingStatus
            requestCounts = messageBatchCreateResponse.requestCounts
            resultsUrl = messageBatchCreateResponse.resultsUrl
            type = messageBatchCreateResponse.type
            additionalProperties = messageBatchCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageBatchCreateResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchCreateResponse && id == other.id && archivedAt == other.archivedAt && cancelInitiatedAt == other.cancelInitiatedAt && createdAt == other.createdAt && endedAt == other.endedAt && expiresAt == other.expiresAt && processingStatus == other.processingStatus && requestCounts == other.requestCounts && resultsUrl == other.resultsUrl && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchCreateResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
