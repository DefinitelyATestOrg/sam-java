...
@NoAutoDetect
class MessageBatchesBetaTrueListResponse
@JsonCreator
private constructor(
    @JsonProperty("data")
    @ExcludeMissing
    ...
    fun validate(): MessageBatchesBetaTrueListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [MessageBatchesBetaTrueListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchesBetaTrueListResponse: MessageBatchesBetaTrueListResponse) =
            apply {
                data = messageBatchesBetaTrueListResponse.data.map { it.toMutableList() }
                firstId = messageBatchesBetaTrueListResponse.firstId
                hasMore = messageBatchesBetaTrueListResponse.hasMore
                lastId = messageBatchesBetaTrueListResponse.lastId
                additionalProperties =
                    messageBatchesBetaTrueListResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): MessageBatchesBetaTrueListResponse =
            MessageBatchesBetaTrueListResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchesBetaTrueListResponse && data == other.data && firstId == other.firstId && hasMore == other.hasMore && lastId == other.lastId && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchesBetaTrueListResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, additionalProperties=$additionalProperties}"
}
