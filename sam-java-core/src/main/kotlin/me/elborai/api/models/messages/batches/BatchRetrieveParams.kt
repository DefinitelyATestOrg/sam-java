 ...
 */
class BatchRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchRetrieveParams: BatchRetrieveParams) =
            apply {
                messageBatchId = batchRetrieveParams.messageBatchId
                anthropicBeta = batchRetrieveParams.anthropicBeta?.toMutableList()
                anthropicVersion = batchRetrieveParams.anthropicVersion
                xApiKey = batchRetrieveParams.xApiKey
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BatchRetrieveParams && messageBatchId == other.messageBatchId && anthropicBeta == other.anthropicBeta && anthropicVersion == other.anthropicVersion && xApiKey == other.xApiKey && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "BatchRetrieveParams{messageBatchId=$messageBatchId, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
