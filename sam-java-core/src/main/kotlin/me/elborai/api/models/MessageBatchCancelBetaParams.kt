 ...
 */
class MessageBatchCancelBetaParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageBatchCancelBetaParams].
         *
    ...
    /** A builder for [MessageBatchCancelBetaParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchCancelBetaParams: MessageBatchCancelBetaParams) = apply {
            messageBatchId = messageBatchCancelBetaParams.messageBatchId
            anthropicBeta = messageBatchCancelBetaParams.anthropicBeta?.toMutableList()
            anthropicVersion = messageBatchCancelBetaParams.anthropicVersion
            xApiKey = messageBatchCancelBetaParams.xApiKey
            additionalHeaders = messageBatchCancelBetaParams.additionalHeaders.toBuilder()
            additionalQueryParams = messageBatchCancelBetaParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                messageBatchCancelBetaParams.additionalBodyProperties.toMutableMap()
        }
        ...
        fun build(): MessageBatchCancelBetaParams =
            MessageBatchCancelBetaParams(
    ...
    override fun toString() =
        "MessageBatchCancelBetaParams{messageBatchId=$messageBatchId, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
