 ...
 */
class BatchesBetaTrueListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): BatchesBetaTrueListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchesBetaTrueListParams: BatchesBetaTrueListParams) =
            apply {
    ...
    override fun toString() = "BatchesBetaTrueListParams{afterId=$afterId, beforeId=$beforeId, limit=$limit, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
