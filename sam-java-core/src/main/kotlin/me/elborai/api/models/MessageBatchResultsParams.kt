...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageBatchResultsParams: MessageBatchResultsParams) = apply {
            ...
            anthropicBeta = messageBatchResultsParams.anthropicBeta?.toMutableList()
            anthropicVersion = messageBatchResultsParams.anthropicVersion
            xApiKey = messageBatchResultsParams.xApiKey
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchResultsParams && messageBatchId == other.messageBatchId && anthropicBeta == other.anthropicBeta && anthropicVersion == other.anthropicVersion && xApiKey == other.xApiKey && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchResultsParams{messageBatchId=$messageBatchId, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
