...
@NoAutoDetect
class MessageBatchesBetaTrueCreateResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageBatchesBetaTrueCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [MessageBatchesBetaTrueCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            messageBatchesBetaTrueCreateResponse: MessageBatchesBetaTrueCreateResponse
        ) = apply {
            id = messageBatchesBetaTrueCreateResponse.id
            archivedAt = messageBatchesBetaTrueCreateResponse.archivedAt
            cancelInitiatedAt = messageBatchesBetaTrueCreateResponse.cancelInitiatedAt
            createdAt = messageBatchesBetaTrueCreateResponse.createdAt
            endedAt = messageBatchesBetaTrueCreateResponse.endedAt
            expiresAt = messageBatchesBetaTrueCreateResponse.expiresAt
            processingStatus = messageBatchesBetaTrueCreateResponse.processingStatus
            requestCounts = messageBatchesBetaTrueCreateResponse.requestCounts
            resultsUrl = messageBatchesBetaTrueCreateResponse.resultsUrl
            type = messageBatchesBetaTrueCreateResponse.type
            additionalProperties =
                messageBatchesBetaTrueCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageBatchesBetaTrueCreateResponse =
            MessageBatchesBetaTrueCreateResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchesBetaTrueCreateResponse && id == other.id && archivedAt == other.archivedAt && cancelInitiatedAt == other.cancelInitiatedAt && createdAt == other.createdAt && endedAt == other.endedAt && expiresAt == other.expiresAt && processingStatus == other.processingStatus && requestCounts == other.requestCounts && resultsUrl == other.resultsUrl && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchesBetaTrueCreateResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
