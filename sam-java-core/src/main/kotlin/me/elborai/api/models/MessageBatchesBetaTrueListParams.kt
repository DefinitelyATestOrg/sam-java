 ...
 */
class MessageBatchesBetaTrueListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MessageBatchesBetaTrueListParams = builder().build()
    ...
    /** A builder for [MessageBatchesBetaTrueListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchesBetaTrueListParams: MessageBatchesBetaTrueListParams) =
            apply {
                afterId = messageBatchesBetaTrueListParams.afterId
                beforeId = messageBatchesBetaTrueListParams.beforeId
                limit = messageBatchesBetaTrueListParams.limit
                anthropicBeta = messageBatchesBetaTrueListParams.anthropicBeta?.toMutableList()
                anthropicVersion = messageBatchesBetaTrueListParams.anthropicVersion
                xApiKey = messageBatchesBetaTrueListParams.xApiKey
                additionalHeaders = messageBatchesBetaTrueListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    messageBatchesBetaTrueListParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): MessageBatchesBetaTrueListParams =
            MessageBatchesBetaTrueListParams(
                afterId,
                beforeId,
                limit,
    ...
    override fun toString() =
        "MessageBatchesBetaTrueListParams{afterId=$afterId, beforeId=$beforeId, limit=$limit, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
