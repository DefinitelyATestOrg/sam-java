...
@NoAutoDetect
class MessageBatchRetrieveResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageBatchRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageBatchRetrieveResponse].
         *
    ...
    /** A builder for [MessageBatchRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchRetrieveResponse: MessageBatchRetrieveResponse) = apply {
            id = messageBatchRetrieveResponse.id
            archivedAt = messageBatchRetrieveResponse.archivedAt
            cancelInitiatedAt = messageBatchRetrieveResponse.cancelInitiatedAt
            createdAt = messageBatchRetrieveResponse.createdAt
            endedAt = messageBatchRetrieveResponse.endedAt
            expiresAt = messageBatchRetrieveResponse.expiresAt
            processingStatus = messageBatchRetrieveResponse.processingStatus
            requestCounts = messageBatchRetrieveResponse.requestCounts
            resultsUrl = messageBatchRetrieveResponse.resultsUrl
            type = messageBatchRetrieveResponse.type
            additionalProperties = messageBatchRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageBatchRetrieveResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchRetrieveResponse && id == other.id && archivedAt == other.archivedAt && cancelInitiatedAt == other.cancelInitiatedAt && createdAt == other.createdAt && endedAt == other.endedAt && expiresAt == other.expiresAt && processingStatus == other.processingStatus && requestCounts == other.requestCounts && resultsUrl == other.resultsUrl && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchRetrieveResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
