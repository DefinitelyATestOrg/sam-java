...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StoreOrderRetrieveParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(storeOrderRetrieveParams: StoreOrderRetrieveParams) = apply {
            orderId = storeOrderRetrieveParams.orderId
            additionalHeaders = storeOrderRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = storeOrderRetrieveParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is StoreOrderRetrieveParams && orderId == other.orderId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orderId, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "StoreOrderRetrieveParams{orderId=$orderId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
