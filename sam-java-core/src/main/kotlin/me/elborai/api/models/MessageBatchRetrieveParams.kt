...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageBatchRetrieveParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageBatchRetrieveParams: MessageBatchRetrieveParams) = apply {
            ...
            anthropicBeta = messageBatchRetrieveParams.anthropicBeta?.toMutableList()
            anthropicVersion = messageBatchRetrieveParams.anthropicVersion
            xApiKey = messageBatchRetrieveParams.xApiKey
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchRetrieveParams && messageBatchId == other.messageBatchId && anthropicBeta == other.anthropicBeta && anthropicVersion == other.anthropicVersion && xApiKey == other.xApiKey && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchRetrieveParams{messageBatchId=$messageBatchId, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
