...
@NoAutoDetect
class BatchCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): BatchCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchCreateResponse: BatchCreateResponse) =
            apply {
    ...
    override fun toString() = "BatchCreateResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
