...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchCreateResponse: BatchCreateResponse) = apply {
            ...
            archivedAt = batchCreateResponse.archivedAt
            cancelInitiatedAt = batchCreateResponse.cancelInitiatedAt
            createdAt = batchCreateResponse.createdAt
            endedAt = batchCreateResponse.endedAt
            expiresAt = batchCreateResponse.expiresAt
            processingStatus = batchCreateResponse.processingStatus
            requestCounts = batchCreateResponse.requestCounts
            resultsUrl = batchCreateResponse.resultsUrl
            type = batchCreateResponse.type
    ...
    override fun toString() =
        "BatchCreateResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
