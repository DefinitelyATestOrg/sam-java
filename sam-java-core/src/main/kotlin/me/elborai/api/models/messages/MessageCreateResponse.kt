...
@NoAutoDetect
class MessageCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): MessageCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageCreateResponse: MessageCreateResponse) =
            apply {
    ...
    override fun toString() = "MessageCreateResponse{id=$id, content=$content, model=$model, role=$role, stopReason=$stopReason, stopSequence=$stopSequence, type=$type, usage=$usage, additionalProperties=$additionalProperties}"
}
