...
@NoAutoDetect
class MessageBatchBetaTrueDeleteResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageBatchBetaTrueDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [MessageBatchBetaTrueDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchBetaTrueDeleteResponse: MessageBatchBetaTrueDeleteResponse) =
            apply {
                id = messageBatchBetaTrueDeleteResponse.id
                type = messageBatchBetaTrueDeleteResponse.type
                additionalProperties =
                    messageBatchBetaTrueDeleteResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): MessageBatchBetaTrueDeleteResponse =
            MessageBatchBetaTrueDeleteResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchBetaTrueDeleteResponse && id == other.id && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchBetaTrueDeleteResponse{id=$id, type=$type, additionalProperties=$additionalProperties}"
}
