...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaTrueDeleteResponse].
         *
    ...
    /** A builder for [BetaTrueDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaTrueDeleteResponse: BetaTrueDeleteResponse) = apply {
            id = betaTrueDeleteResponse.id
            type = betaTrueDeleteResponse.type
            additionalProperties = betaTrueDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaTrueDeleteResponse].
         *
         ...
         */
        fun build(): BetaTrueDeleteResponse =
    ...
    fun validate(): BetaTrueDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaTrueDeleteResponse && id == other.id && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BetaTrueDeleteResponse{id=$id, type=$type, additionalProperties=$additionalProperties}"
}
