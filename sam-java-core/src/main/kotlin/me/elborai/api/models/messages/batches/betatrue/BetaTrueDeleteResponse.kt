...
@NoAutoDetect
class BetaTrueDeleteResponse @JsonCreator private constructor(
    ...
    fun validate(): BetaTrueDeleteResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaTrueDeleteResponse: BetaTrueDeleteResponse) =
            apply {
    ...
    override fun toString() = "BetaTrueDeleteResponse{id=$id, type=$type, additionalProperties=$additionalProperties}"
}
