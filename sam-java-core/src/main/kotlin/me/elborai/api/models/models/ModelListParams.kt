 ...
 */
class ModelListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(modelListParams: ModelListParams) =
            apply {
    ...
    override fun toString() = "ModelListParams{afterId=$afterId, beforeId=$beforeId, limit=$limit, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
