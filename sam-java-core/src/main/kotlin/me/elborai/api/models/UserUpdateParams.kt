...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userUpdateParams: UserUpdateParams) = apply {
            username = userUpdateParams.username
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UserUpdateParams && username == other.username && user == other.user && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(username, user, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "UserUpdateParams{username=$username, user=$user, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
