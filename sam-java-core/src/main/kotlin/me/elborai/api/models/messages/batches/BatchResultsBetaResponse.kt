...
class BatchResultsBetaResponse @JsonCreator private constructor(
    ...
    class Result private constructor(
        ...
        fun betaSucceeded(): Optional<BetaSucceededResult> = Optional.ofNullable(betaSucceeded)

        fun betaErrored(): Optional<BetaErroredResult> = Optional.ofNullable(betaErrored)

        fun betaCanceled(): Optional<BetaCanceledResult> = Optional.ofNullable(betaCanceled)

        fun betaExpired(): Optional<BetaExpiredResult> = Optional.ofNullable(betaExpired)
        ...
        class BetaSucceededResult @JsonCreator private constructor(
            ...
            class Message @JsonCreator private constructor(
                 ...
                 */
                fun stopReason(): Optional<StopReason> = Optional.ofNullable(stopReason.getNullable("stop_reason"))
                 ...
                 * generated.
                 */
                fun stopSequence(): Optional<String> = Optional.ofNullable(stopSequence.getNullable("stop_sequence"))
                ...
                class Content private constructor(
                    ...
                    fun betaResponseTextBlock(): Optional<BetaResponseTextBlock> = Optional.ofNullable(betaResponseTextBlock)

                    fun betaResponseToolUseBlock(): Optional<BetaResponseToolUseBlock> = Optional.ofNullable(betaResponseToolUseBlock)

                    fun betaResponseThinkingBlock(): Optional<BetaResponseThinkingBlock> = Optional.ofNullable(betaResponseThinkingBlock)

                    fun betaResponseRedactedThinkingBlock(): Optional<BetaResponseRedactedThinkingBlock> = Optional.ofNullable(betaResponseRedactedThinkingBlock)
                    ...
                    class BetaResponseTextBlock @JsonCreator private constructor(
                         ...
                         */
                        fun citations(): Optional<List<Citation>> = Optional.ofNullable(citations.getNullable("citations"))
                        ...
                        class Builder internal constructor() {
                             ...
                             * and content document results in `content_block_location`.
                             */
                            fun citations(citations: Optional<List<Citation>>) = citations(citations.getOrNull())
                        ...
                        class Citation private constructor(
                            ...
                            fun betaResponseCharLocation(): Optional<BetaResponseCharLocationCitation> = Optional.ofNullable(betaResponseCharLocation)

                            fun betaResponsePageLocation(): Optional<BetaResponsePageLocationCitation> = Optional.ofNullable(betaResponsePageLocation)

                            fun betaResponseContentBlockLocation(): Optional<BetaResponseContentBlockLocationCitation> = Optional.ofNullable(betaResponseContentBlockLocation)
                            ...
                            class BetaResponseCharLocationCitation @JsonCreator private constructor(
                                ...
                                fun documentTitle(): Optional<String> = Optional.ofNullable(documentTitle.getNullable("document_title"))
                                ...
                                class Builder internal constructor() {
                                    ...
                                    fun documentTitle(documentTitle: Optional<String>) = documentTitle(documentTitle.getOrNull())
                ...
                class Usage @JsonCreator private constructor(
                    ...
                    fun cacheCreationInputTokens(): Optional<Long> = Optional.ofNullable(cacheCreationInputTokens.getNullable("cache_creation_input_tokens"))

                    /** The number of input tokens read from the cache. */
                    fun cacheReadInputTokens(): Optional<Long> = Optional.ofNullable(cacheReadInputTokens.getNullable("cache_read_input_tokens"))
                    ...
                    class Builder internal constructor() {
                        ...
                        /** The number of input tokens used to create the cache entry. */
                        fun cacheCreationInputTokens(cacheCreationInputTokens: Optional<Long>) = cacheCreationInputTokens(cacheCreationInputTokens.getOrNull())
                        ...
                        /** The number of input tokens read from the cache. */
                        fun cacheReadInputTokens(cacheReadInputTokens: Optional<Long>) = cacheReadInputTokens(cacheReadInputTokens.getOrNull())
        ...
        class BetaErroredResult @JsonCreator private constructor(
            ...
            class Error @JsonCreator private constructor(
                ...
                class InnerError private constructor(
                    ...
                    fun betaInvalidRequest(): Optional<BetaInvalidRequestError> = Optional.ofNullable(betaInvalidRequest)

                    fun betaAuthentication(): Optional<BetaAuthenticationError> = Optional.ofNullable(betaAuthentication)

                    fun betaBilling(): Optional<BetaBillingError> = Optional.ofNullable(betaBilling)

                    fun betaPermission(): Optional<BetaPermissionError> = Optional.ofNullable(betaPermission)

                    fun betaNotFound(): Optional<BetaNotFoundError> = Optional.ofNullable(betaNotFound)

                    fun betaRateLimit(): Optional<BetaRateLimitError> = Optional.ofNullable(betaRateLimit)

                    fun betaGatewayTimeout(): Optional<BetaGatewayTimeoutError> = Optional.ofNullable(betaGatewayTimeout)

                    fun betaApi(): Optional<BetaApiError> = Optional.ofNullable(betaApi)

                    fun betaOverloaded(): Optional<BetaOverloadedError> = Optional.ofNullable(betaOverloaded)
