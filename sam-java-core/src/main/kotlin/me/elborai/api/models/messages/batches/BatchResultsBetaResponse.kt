...
private constructor(
    ...
    private constructor(
        ...
        fun canceled(): Optional<JsonValue> = Optional.ofNullable(canceled)

        fun expired(): Optional<JsonValue> = Optional.ofNullable(expired)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResultsBetaResponse &&
