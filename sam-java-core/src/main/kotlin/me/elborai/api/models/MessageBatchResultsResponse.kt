 ...
 */
@NoAutoDetect
class MessageBatchResultsResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageBatchResultsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageBatchResultsResponse].
         *
    ...
    /** A builder for [MessageBatchResultsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchResultsResponse: MessageBatchResultsResponse) = apply {
            customId = messageBatchResultsResponse.customId
            result = messageBatchResultsResponse.result
            additionalProperties = messageBatchResultsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun erroredResult(error: Result.ErroredResult.Error) =
            result(
                Result.ErroredResult.builder()
                    .type(MessageBatchResultsResponse.Result.ErroredResult.Type.ERRORED)
                    .error(error)
                    .build()
            )
        ...
        fun build(): MessageBatchResultsResponse =
        ...
        private constructor(
            ...
            private constructor(
                    ...
                    fun invalidRequestError(message: String) =
                        error(
                            InnerError.InvalidRequestError.builder()
                                .type(
                                    MessageBatchResultsResponse.Result.ErroredResult.Error
                                        .InnerError
                                        .InvalidRequestError
                                        .Type
                ...
                private constructor(
                    ...
                    fun invalidRequest(): Optional<InvalidRequestError> =
                        Optional.ofNullable(invalidRequest)

                    fun authentication(): Optional<AuthenticationError> =
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun build(): CanceledResult =
                    CanceledResult(checkRequired("type", type), additionalProperties.toImmutable())
            }
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun build(): ExpiredResult =
                    ExpiredResult(checkRequired("type", type), additionalProperties.toImmutable())
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchResultsResponse && customId == other.customId && result == other.result && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchResultsResponse{customId=$customId, result=$result, additionalProperties=$additionalProperties}"
}
