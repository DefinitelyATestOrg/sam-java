...
@NoAutoDetect
class ModelsBetaTrueListResponse @JsonCreator private constructor(
    ...
    fun validate(): ModelsBetaTrueListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(modelsBetaTrueListResponse: ModelsBetaTrueListResponse) =
            apply {
    ...
    override fun toString() = "ModelsBetaTrueListResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, additionalProperties=$additionalProperties}"
}
