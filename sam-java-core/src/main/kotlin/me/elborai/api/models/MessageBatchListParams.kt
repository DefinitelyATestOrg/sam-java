...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageBatchListParams: MessageBatchListParams) = apply {
            ...
            anthropicBeta = messageBatchListParams.anthropicBeta?.toMutableList()
            anthropicVersion = messageBatchListParams.anthropicVersion
            xApiKey = messageBatchListParams.xApiKey
    ...
    override fun toString() =
        "MessageBatchListParams{afterId=$afterId, beforeId=$beforeId, limit=$limit, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
