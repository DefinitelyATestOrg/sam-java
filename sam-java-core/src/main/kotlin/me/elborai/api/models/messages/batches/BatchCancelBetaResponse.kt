...
private constructor(
    ...
    fun validate(): BatchCancelBetaResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchCancelBetaResponse].
         *
    ...
    /** A builder for [BatchCancelBetaResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchCancelBetaResponse: BatchCancelBetaResponse) = apply {
            id = batchCancelBetaResponse.id
            archivedAt = batchCancelBetaResponse.archivedAt
            cancelInitiatedAt = batchCancelBetaResponse.cancelInitiatedAt
            createdAt = batchCancelBetaResponse.createdAt
            endedAt = batchCancelBetaResponse.endedAt
            expiresAt = batchCancelBetaResponse.expiresAt
            processingStatus = batchCancelBetaResponse.processingStatus
            requestCounts = batchCancelBetaResponse.requestCounts
            resultsUrl = batchCancelBetaResponse.resultsUrl
            type = batchCancelBetaResponse.type
            additionalProperties = batchCancelBetaResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.requestCounts] with a well-typed [RequestCounts] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Returns an immutable instance of [BatchCancelBetaResponse].
         *
         ...
         */
        fun build(): BatchCancelBetaResponse =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.canceled] with a well-typed [Long] value instead.
             ...
             *
             * You should usually call [Builder.processing] with a well-typed [Long] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatchCancelBetaResponse && id == other.id && archivedAt == other.archivedAt && cancelInitiatedAt == other.cancelInitiatedAt && createdAt == other.createdAt && endedAt == other.endedAt && expiresAt == other.expiresAt && processingStatus == other.processingStatus && requestCounts == other.requestCounts && resultsUrl == other.resultsUrl && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BatchCancelBetaResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
