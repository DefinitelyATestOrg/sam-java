...
@NoAutoDetect
class BatchCancelBetaResponse @JsonCreator private constructor(
    ...
    fun validate(): BatchCancelBetaResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchCancelBetaResponse: BatchCancelBetaResponse) =
            apply {
    ...
    override fun toString() = "BatchCancelBetaResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
