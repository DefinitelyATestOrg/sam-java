...
private constructor(
    ...
    fun validate(): MessageBatchListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageBatchListResponse].
         *
    ...
    /** A builder for [MessageBatchListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchListResponse: MessageBatchListResponse) = apply {
            data = messageBatchListResponse.data.map { it.toMutableList() }
            firstId = messageBatchListResponse.firstId
            hasMore = messageBatchListResponse.hasMore
            lastId = messageBatchListResponse.lastId
            additionalProperties = messageBatchListResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageBatchListResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchListResponse && data == other.data && firstId == other.firstId && hasMore == other.hasMore && lastId == other.lastId && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchListResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, additionalProperties=$additionalProperties}"
}
