...
@NoAutoDetect
class MessagesBetaTrueCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): MessagesBetaTrueCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messagesBetaTrueCreateResponse: MessagesBetaTrueCreateResponse) =
            apply {
                ...
                additionalProperties = messagesBetaTrueCreateResponse.additionalProperties.toMutableMap()
            }
    ...
    override fun toString() = "MessagesBetaTrueCreateResponse{id=$id, content=$content, model=$model, role=$role, stopReason=$stopReason, stopSequence=$stopSequence, type=$type, usage=$usage, additionalProperties=$additionalProperties}"
}
