...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         *     .type(MessagesBetaTrueCreateResponse.Content.RedactedThinking.Type.REDACTED_THINKING)
         *     .data(data)
         *     .build()
         * ```
         */
        fun addRedactedThinkingContent(data: String) =
            addContent(
                Content.RedactedThinking.builder()
                    .type(
                        MessagesBetaTrueCreateResponse.Content.RedactedThinking.Type
                            .REDACTED_THINKING
                    )
                    .data(data)
                    .build()
    ...
    private constructor(
        ...
        fun redactedThinking(): Optional<RedactedThinking> = Optional.ofNullable(redactedThinking)
        ...
        private constructor(
            ...
            private constructor(
                ...
                fun charLocation(): Optional<CharLocation> = Optional.ofNullable(charLocation)

                fun pageLocation(): Optional<PageLocation> = Optional.ofNullable(pageLocation)
