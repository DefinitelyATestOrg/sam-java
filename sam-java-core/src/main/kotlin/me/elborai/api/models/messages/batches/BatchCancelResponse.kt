...
@NoAutoDetect
class BatchCancelResponse @JsonCreator private constructor(
    ...
    fun validate(): BatchCancelResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchCancelResponse: BatchCancelResponse) =
            apply {
    ...
    override fun toString() = "BatchCancelResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
