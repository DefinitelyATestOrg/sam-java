...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchCancelResponse: BatchCancelResponse) = apply {
            id = batchCancelResponse.id
            archivedAt = batchCancelResponse.archivedAt
            cancelInitiatedAt = batchCancelResponse.cancelInitiatedAt
            createdAt = batchCancelResponse.createdAt
            endedAt = batchCancelResponse.endedAt
            expiresAt = batchCancelResponse.expiresAt
            processingStatus = batchCancelResponse.processingStatus
            requestCounts = batchCancelResponse.requestCounts
            resultsUrl = batchCancelResponse.resultsUrl
            type = batchCancelResponse.type
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatchCancelResponse && id == other.id && archivedAt == other.archivedAt && cancelInitiatedAt == other.cancelInitiatedAt && createdAt == other.createdAt && endedAt == other.endedAt && expiresAt == other.expiresAt && processingStatus == other.processingStatus && requestCounts == other.requestCounts && resultsUrl == other.resultsUrl && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BatchCancelResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
