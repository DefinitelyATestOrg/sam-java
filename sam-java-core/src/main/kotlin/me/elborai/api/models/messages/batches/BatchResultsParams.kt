 ...
 */
class BatchResultsParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResultsParams: BatchResultsParams) =
            apply {
                messageBatchId = batchResultsParams.messageBatchId
                anthropicBeta = batchResultsParams.anthropicBeta?.toMutableList()
                anthropicVersion = batchResultsParams.anthropicVersion
                xApiKey = batchResultsParams.xApiKey
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is BatchResultsParams && messageBatchId == other.messageBatchId && anthropicBeta == other.anthropicBeta && anthropicVersion == other.anthropicVersion && xApiKey == other.xApiKey && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() = "BatchResultsParams{messageBatchId=$messageBatchId, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
