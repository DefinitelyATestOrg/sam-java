...
class MessageCountTokensBetaResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageCountTokensBetaResponse: MessageCountTokensBetaResponse) = apply {
            inputTokens = messageCountTokensBetaResponse.inputTokens
            additionalProperties =
                messageCountTokensBetaResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageCountTokensBetaResponse].
         *
    ...
    fun validate(): MessageCountTokensBetaResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageCountTokensBetaResponse &&
    ...
    override fun toString() =
        "MessageCountTokensBetaResponse{inputTokens=$inputTokens, additionalProperties=$additionalProperties}"
}
