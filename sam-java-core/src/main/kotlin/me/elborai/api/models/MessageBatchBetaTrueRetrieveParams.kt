 ...
 */
class MessageBatchBetaTrueRetrieveParams
private constructor(
    ...
    companion object {
         ...
         * [MessageBatchBetaTrueRetrieveParams].
         *
    ...
    /** A builder for [MessageBatchBetaTrueRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchBetaTrueRetrieveParams: MessageBatchBetaTrueRetrieveParams) =
            apply {
                messageBatchId = messageBatchBetaTrueRetrieveParams.messageBatchId
                anthropicBeta = messageBatchBetaTrueRetrieveParams.anthropicBeta?.toMutableList()
                anthropicVersion = messageBatchBetaTrueRetrieveParams.anthropicVersion
                xApiKey = messageBatchBetaTrueRetrieveParams.xApiKey
                additionalHeaders = messageBatchBetaTrueRetrieveParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    messageBatchBetaTrueRetrieveParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): MessageBatchBetaTrueRetrieveParams =
            MessageBatchBetaTrueRetrieveParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchBetaTrueRetrieveParams && messageBatchId == other.messageBatchId && anthropicBeta == other.anthropicBeta && anthropicVersion == other.anthropicVersion && xApiKey == other.xApiKey && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchBetaTrueRetrieveParams{messageBatchId=$messageBatchId, anthropicBeta=$anthropicBeta, anthropicVersion=$anthropicVersion, xApiKey=$xApiKey, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
