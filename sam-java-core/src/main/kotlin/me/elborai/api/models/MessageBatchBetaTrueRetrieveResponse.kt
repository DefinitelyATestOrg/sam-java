...
@NoAutoDetect
class MessageBatchBetaTrueRetrieveResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageBatchBetaTrueRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [MessageBatchBetaTrueRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            messageBatchBetaTrueRetrieveResponse: MessageBatchBetaTrueRetrieveResponse
        ) = apply {
            id = messageBatchBetaTrueRetrieveResponse.id
            archivedAt = messageBatchBetaTrueRetrieveResponse.archivedAt
            cancelInitiatedAt = messageBatchBetaTrueRetrieveResponse.cancelInitiatedAt
            createdAt = messageBatchBetaTrueRetrieveResponse.createdAt
            endedAt = messageBatchBetaTrueRetrieveResponse.endedAt
            expiresAt = messageBatchBetaTrueRetrieveResponse.expiresAt
            processingStatus = messageBatchBetaTrueRetrieveResponse.processingStatus
            requestCounts = messageBatchBetaTrueRetrieveResponse.requestCounts
            resultsUrl = messageBatchBetaTrueRetrieveResponse.resultsUrl
            type = messageBatchBetaTrueRetrieveResponse.type
            additionalProperties =
                messageBatchBetaTrueRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageBatchBetaTrueRetrieveResponse =
            MessageBatchBetaTrueRetrieveResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchBetaTrueRetrieveResponse && id == other.id && archivedAt == other.archivedAt && cancelInitiatedAt == other.cancelInitiatedAt && createdAt == other.createdAt && endedAt == other.endedAt && expiresAt == other.expiresAt && processingStatus == other.processingStatus && requestCounts == other.requestCounts && resultsUrl == other.resultsUrl && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchBetaTrueRetrieveResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
