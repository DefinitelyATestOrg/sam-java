...
@NoAutoDetect
class MessageBatchCancelBetaResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageBatchCancelBetaResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [MessageBatchCancelBetaResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchCancelBetaResponse: MessageBatchCancelBetaResponse) = apply {
            id = messageBatchCancelBetaResponse.id
            archivedAt = messageBatchCancelBetaResponse.archivedAt
            cancelInitiatedAt = messageBatchCancelBetaResponse.cancelInitiatedAt
            createdAt = messageBatchCancelBetaResponse.createdAt
            endedAt = messageBatchCancelBetaResponse.endedAt
            expiresAt = messageBatchCancelBetaResponse.expiresAt
            processingStatus = messageBatchCancelBetaResponse.processingStatus
            requestCounts = messageBatchCancelBetaResponse.requestCounts
            resultsUrl = messageBatchCancelBetaResponse.resultsUrl
            type = messageBatchCancelBetaResponse.type
            additionalProperties =
                messageBatchCancelBetaResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageBatchCancelBetaResponse =
            MessageBatchCancelBetaResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchCancelBetaResponse && id == other.id && archivedAt == other.archivedAt && cancelInitiatedAt == other.cancelInitiatedAt && createdAt == other.createdAt && endedAt == other.endedAt && expiresAt == other.expiresAt && processingStatus == other.processingStatus && requestCounts == other.requestCounts && resultsUrl == other.resultsUrl && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchCancelBetaResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
