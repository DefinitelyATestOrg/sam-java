        ...
        class SucceededResult @JsonCreator private constructor(
            ...
            class Message @JsonCreator private constructor(
                ...
                class Content private constructor(
                    ...
                    fun responseTextBlock(): Optional<ResponseTextBlock> = Optional.ofNullable(responseTextBlock)

                    fun responseToolUseBlock(): Optional<ResponseToolUseBlock> = Optional.ofNullable(responseToolUseBlock)

                    fun responseThinkingBlock(): Optional<ResponseThinkingBlock> = Optional.ofNullable(responseThinkingBlock)

                    fun responseRedactedThinkingBlock(): Optional<ResponseRedactedThinkingBlock> = Optional.ofNullable(responseRedactedThinkingBlock)
                    ...
                    class ResponseTextBlock @JsonCreator private constructor(
                        ...
                        class Citation private constructor(
                            ...
                            fun responseCharLocation(): Optional<ResponseCharLocationCitation> = Optional.ofNullable(responseCharLocation)

                            fun responsePageLocation(): Optional<ResponsePageLocationCitation> = Optional.ofNullable(responsePageLocation)

                            fun responseContentBlockLocation(): Optional<ResponseContentBlockLocationCitation> = Optional.ofNullable(responseContentBlockLocation)
        ...
        class ErroredResult @JsonCreator private constructor(
            ...
            class Error @JsonCreator private constructor(
                ...
                class InnerError private constructor(
                    ...
                    fun invalidRequest(): Optional<InvalidRequestError> = Optional.ofNullable(invalidRequest)

                    fun authentication(): Optional<AuthenticationError> = Optional.ofNullable(authentication)

                    fun billing(): Optional<BillingError> = Optional.ofNullable(billing)

                    fun permission(): Optional<PermissionError> = Optional.ofNullable(permission)

                    fun notFound(): Optional<NotFoundError> = Optional.ofNullable(notFound)

                    fun rateLimit(): Optional<RateLimitError> = Optional.ofNullable(rateLimit)

                    fun gatewayTimeout(): Optional<GatewayTimeoutError> = Optional.ofNullable(gatewayTimeout)

                    fun api(): Optional<ApiError> = Optional.ofNullable(api)

                    fun overloaded(): Optional<OverloadedError> = Optional.ofNullable(overloaded)
