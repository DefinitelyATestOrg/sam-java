...
private constructor(
    ...
    /** A builder for [BatchesBetaTrueCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchesBetaTrueCreateResponse: BatchesBetaTrueCreateResponse) = apply {
            id = batchesBetaTrueCreateResponse.id
            archivedAt = batchesBetaTrueCreateResponse.archivedAt
            cancelInitiatedAt = batchesBetaTrueCreateResponse.cancelInitiatedAt
            createdAt = batchesBetaTrueCreateResponse.createdAt
            endedAt = batchesBetaTrueCreateResponse.endedAt
            expiresAt = batchesBetaTrueCreateResponse.expiresAt
            processingStatus = batchesBetaTrueCreateResponse.processingStatus
            requestCounts = batchesBetaTrueCreateResponse.requestCounts
            resultsUrl = batchesBetaTrueCreateResponse.resultsUrl
            type = batchesBetaTrueCreateResponse.type
            additionalProperties = batchesBetaTrueCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchesBetaTrueCreateResponse].
         *
         ...
         */
        fun build(): BatchesBetaTrueCreateResponse =
            BatchesBetaTrueCreateResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatchesBetaTrueCreateResponse && id == other.id && archivedAt == other.archivedAt && cancelInitiatedAt == other.cancelInitiatedAt && createdAt == other.createdAt && endedAt == other.endedAt && expiresAt == other.expiresAt && processingStatus == other.processingStatus && requestCounts == other.requestCounts && resultsUrl == other.resultsUrl && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BatchesBetaTrueCreateResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
