...
@NoAutoDetect
class BatchesBetaTrueCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): BatchesBetaTrueCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchesBetaTrueCreateResponse: BatchesBetaTrueCreateResponse) =
            apply {
    ...
    override fun toString() = "BatchesBetaTrueCreateResponse{id=$id, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, createdAt=$createdAt, endedAt=$endedAt, expiresAt=$expiresAt, processingStatus=$processingStatus, requestCounts=$requestCounts, resultsUrl=$resultsUrl, type=$type, additionalProperties=$additionalProperties}"
}
