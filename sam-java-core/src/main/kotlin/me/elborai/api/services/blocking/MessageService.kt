...
interface MessageService {
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun countTokens(params: MessageCountTokensParams): HttpResponseFor<MessageCountTokensResponse> =
            countTokens(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun countTokensBeta(params: MessageCountTokensBetaParams): HttpResponseFor<MessageCountTokensBetaResponse> =
            countTokensBeta(
              params, RequestOptions.none()
            )
