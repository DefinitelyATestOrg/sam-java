...
class BatchesBetaTrueServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BatchesBetaTrueServiceAsync {

    private val withRawResponse: BatchesBetaTrueServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): BatchesBetaTrueServiceAsync.WithRawResponse = withRawResponse

    override fun create(params: BatchesBetaTrueCreateParams, requestOptions: RequestOptions): CompletableFuture<BatchesBetaTrueCreateResponse> =
        // post /v1/messages/batches?beta=true
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun list(params: BatchesBetaTrueListParams, requestOptions: RequestOptions): CompletableFuture<BatchesBetaTrueListResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: BatchesBetaTrueCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BatchesBetaTrueCreateResponse>> {
        ...
        override fun list(params: BatchesBetaTrueListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BatchesBetaTrueListResponse>> {
          val request = HttpRequest.builder()
