...
interface BetaTrueServiceAsync {
    ...
    /** @see [retrieve] */
    fun retrieve(params: BetaTrueRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<BetaTrueRetrieveResponse>
    ...
    /** @see [delete] */
    fun delete(params: BetaTrueDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<BetaTrueDeleteResponse>
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun retrieve(params: BetaTrueRetrieveParams): CompletableFuture<HttpResponseFor<BetaTrueRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        /** @see [retrieve] */
        @MustBeClosed
        fun retrieve(params: BetaTrueRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<BetaTrueRetrieveResponse>>
         ...
         */
        @MustBeClosed
        fun delete(params: BetaTrueDeleteParams): CompletableFuture<HttpResponseFor<BetaTrueDeleteResponse>> =
            delete(
              params, RequestOptions.none()
            )
        ...
        /** @see [delete] */
        @MustBeClosed
        fun delete(params: BetaTrueDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<BetaTrueDeleteResponse>>
    }
}
