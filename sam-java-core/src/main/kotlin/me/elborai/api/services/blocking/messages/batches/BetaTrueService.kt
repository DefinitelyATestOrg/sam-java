...
interface BetaTrueService {
    ...
    /** @see [retrieve] */
    fun retrieve(params: BetaTrueRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): BetaTrueRetrieveResponse
    ...
    /** @see [delete] */
    fun delete(params: BetaTrueDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): BetaTrueDeleteResponse

    /**
     * A view of [BetaTrueService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * same as [BetaTrueService.retrieve].
         */
        @MustBeClosed
        ...
        /** @see [retrieve] */
        @MustBeClosed
        fun retrieve(params: BetaTrueRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<BetaTrueRetrieveResponse>

        /**
         * Returns a raw HTTP response for
         * `delete /v1/messages/batches/{message_batch_id}?beta=true`, but is otherwise the
         * same as [BetaTrueService.delete].
         */
        @MustBeClosed
        ...
        /** @see [delete] */
        @MustBeClosed
        fun delete(params: BetaTrueDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<BetaTrueDeleteResponse>
    }
}
