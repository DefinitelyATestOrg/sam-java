...
interface ModelService {
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<ModelListResponse> = list(ModelListParams.none())
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: ModelListParams = ModelListParams.none()): HttpResponseFor<ModelListResponse> =
            list(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun retrieveBeta(params: ModelRetrieveBetaParams): HttpResponseFor<ModelRetrieveBetaResponse> =
            retrieveBeta(
              params, RequestOptions.none()
            )
