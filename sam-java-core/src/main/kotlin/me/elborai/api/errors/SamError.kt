...
@NoAutoDetect
class SamError @JsonCreator private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SamError]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [SamError]. */
    class Builder internal constructor() {

        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(samError: SamError) =
            apply {
