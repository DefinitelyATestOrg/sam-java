...
class SamClientImpl(
    ...
    private val withRawResponse: SamClient.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    private val complete: CompleteService by lazy { CompleteServiceImpl(clientOptionsWithUserAgent) }

    private val models: ModelService by lazy { ModelServiceImpl(clientOptionsWithUserAgent) }

    private val messagesBetaTrue: MessagesBetaTrueService by lazy { MessagesBetaTrueServiceImpl(clientOptionsWithUserAgent) }

    private val modelsBetaTrue: ModelsBetaTrueService by lazy { ModelsBetaTrueServiceImpl(clientOptionsWithUserAgent) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val store: StoreService.WithRawResponse by lazy { StoreServiceImpl.WithRawResponseImpl(clientOptions) }

        private val user: UserService.WithRawResponse by lazy { UserServiceImpl.WithRawResponseImpl(clientOptions) }

        private val messages: MessageService.WithRawResponse by lazy { MessageServiceImpl.WithRawResponseImpl(clientOptions) }

        private val complete: CompleteService.WithRawResponse by lazy { CompleteServiceImpl.WithRawResponseImpl(clientOptions) }

        private val models: ModelService.WithRawResponse by lazy { ModelServiceImpl.WithRawResponseImpl(clientOptions) }

        private val messagesBetaTrue: MessagesBetaTrueService.WithRawResponse by lazy { MessagesBetaTrueServiceImpl.WithRawResponseImpl(clientOptions) }

        private val modelsBetaTrue: ModelsBetaTrueService.WithRawResponse by lazy { ModelsBetaTrueServiceImpl.WithRawResponseImpl(clientOptions) }
