...
private constructor(
     ...
     *
     * Use the one published in `sam-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [me.elborai.api.core.jsonMapper]. The default is usually sufficient and rarely
                            ...
                            object : ThreadFactory {
                                ...
                                override fun newThread(runnable: Runnable): Thread =
                                    threadFactory.newThread(runnable).also {
                                        it.name =
                                            "sam-stream-handler-thread-${count.getAndIncrement()}"
                                    }
                            }
                        )
                    )
