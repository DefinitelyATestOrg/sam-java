    ...
    class Category private constructor(private val in_: List<In>?, private val additionalProperties: Map<String, List<String>>, ) {
        ...
        class In @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
            ...
            companion object {
                ...
                @JvmField val INBOUND_REAL_TIME_PAYMENTS_TRANSFER_DECLINE = In(JsonField.of("inbound_real_time_payments_transfer_decline"))

                @JvmField val INTERNATIONAL_ACH_DECLINE = In(JsonField.of("international_ach_decline"))
