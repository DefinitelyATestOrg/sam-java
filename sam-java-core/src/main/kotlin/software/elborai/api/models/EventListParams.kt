    ...
    class Category private constructor(private val in_: List<In>?, private val additionalProperties: Map<String, List<String>>, ) {
        ...
        class In @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
            ...
            companion object {
                ...
                @JvmField val BOOKKEEPING_ACCOUNT_CREATED = In(JsonField.of("bookkeeping_account.created"))

                @JvmField val BOOKKEEPING_ACCOUNT_UPDATED = In(JsonField.of("bookkeeping_account.updated"))

                @JvmField val BOOKKEEPING_ENTRY_SET_UPDATED = In(JsonField.of("bookkeeping_entry_set.updated"))
                ...
                @JvmField val DIGITAL_CARD_PROFILE_CREATED = In(JsonField.of("digital_card_profile.created"))

                @JvmField val DIGITAL_CARD_PROFILE_UPDATED = In(JsonField.of("digital_card_profile.updated"))
                ...
                @JvmField val EVENT_SUBSCRIPTION_CREATED = In(JsonField.of("event_subscription.created"))

                @JvmField val EVENT_SUBSCRIPTION_UPDATED = In(JsonField.of("event_subscription.updated"))
                ...
                @JvmField val EXTERNAL_ACCOUNT_UPDATED = In(JsonField.of("external_account.updated"))
                ...
                @JvmField val INBOUND_ACH_TRANSFER_CREATED = In(JsonField.of("inbound_ach_transfer.created"))

                @JvmField val INBOUND_ACH_TRANSFER_UPDATED = In(JsonField.of("inbound_ach_transfer.updated"))
                ...
                @JvmField val INBOUND_CHECK_DEPOSIT_CREATED = In(JsonField.of("inbound_check_deposit.created"))

                @JvmField val INBOUND_CHECK_DEPOSIT_UPDATED = In(JsonField.of("inbound_check_deposit.updated"))

                @JvmField val INBOUND_MAIL_ITEM_CREATED = In(JsonField.of("inbound_mail_item.created"))

                @JvmField val INBOUND_MAIL_ITEM_UPDATED = In(JsonField.of("inbound_mail_item.updated"))

                @JvmField val INBOUND_WIRE_DRAWDOWN_REQUEST_CREATED = In(JsonField.of("inbound_wire_drawdown_request.created"))

                @JvmField val INBOUND_WIRE_TRANSFER_CREATED = In(JsonField.of("inbound_wire_transfer.created"))

                @JvmField val INBOUND_WIRE_TRANSFER_UPDATED = In(JsonField.of("inbound_wire_transfer.updated"))

                @JvmField val INTRAFI_ACCOUNT_ENROLLMENT_CREATED = In(JsonField.of("intrafi_account_enrollment.created"))

                @JvmField val INTRAFI_ACCOUNT_ENROLLMENT_UPDATED = In(JsonField.of("intrafi_account_enrollment.updated"))

                @JvmField val INTRAFI_EXCLUSION_CREATED = In(JsonField.of("intrafi_exclusion.created"))

                @JvmField val INTRAFI_EXCLUSION_UPDATED = In(JsonField.of("intrafi_exclusion.updated"))
                ...
                @JvmField val PHYSICAL_CARD_PROFILE_CREATED = In(JsonField.of("physical_card_profile.created"))

                @JvmField val PHYSICAL_CARD_PROFILE_UPDATED = In(JsonField.of("physical_card_profile.updated"))

                @JvmField val PROOF_OF_AUTHORIZATION_REQUEST_CREATED = In(JsonField.of("proof_of_authorization_request.created"))

                @JvmField val PROOF_OF_AUTHORIZATION_REQUEST_UPDATED = In(JsonField.of("proof_of_authorization_request.updated"))

                @JvmField val PROOF_OF_AUTHORIZATION_REQUEST_SUBMISSION_CREATED = In(JsonField.of("proof_of_authorization_request_submission.created"))

                @JvmField val PROOF_OF_AUTHORIZATION_REQUEST_SUBMISSION_UPDATED = In(JsonField.of("proof_of_authorization_request_submission.updated"))
