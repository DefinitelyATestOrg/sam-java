...
import software.elborai.api.services.blocking.BookkeepingAccountService
...
class BookkeepingAccountListPage private constructor(private val bookkeepingAccountsService: BookkeepingAccountService, private val params: BookkeepingAccountListParams, private val response: Response, ) {
    ...
    class AutoPager constructor(private val firstPage: BookkeepingAccountListPage, ) : Iterable<BookkeepingAccount> {
