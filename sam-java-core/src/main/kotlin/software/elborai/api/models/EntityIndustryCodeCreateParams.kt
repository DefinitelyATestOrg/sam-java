...
class EntityIndustryCodeCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class EntityIndustryCodeCreateBody internal constructor(private val industryCode: String?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "EntityIndustryCodeCreateBody{industryCode=$industryCode, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): EntityIndustryCodeCreateBody = EntityIndustryCodeCreateBody(checkNotNull(industryCode) {
    ...
    override fun toString() = "EntityIndustryCodeCreateParams{entityId=$entityId, industryCode=$industryCode, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): EntityIndustryCodeCreateParams = EntityIndustryCodeCreateParams(
