...
constructor(
    ...
    fun chatIcon(): Optional<String> = Optional.ofNullable(chatIcon)

    fun chatIconDeleted(): Optional<Boolean> = Optional.ofNullable(chatIconDeleted)

    fun logo(): Optional<String> = Optional.ofNullable(logo)

    fun logoDeleted(): Optional<Boolean> = Optional.ofNullable(logoDeleted)
    ...
    internal constructor(
        ...
        @JsonProperty("agent") fun agent(): Agent? = agent

        @JsonProperty("chatIcon") fun chatIcon(): String? = chatIcon

        @JsonProperty("chatIconDeleted") fun chatIconDeleted(): Boolean? = chatIconDeleted

        @JsonProperty("logo") fun logo(): String? = logo

        @JsonProperty("logoDeleted") fun logoDeleted(): Boolean? = logoDeleted
        ...
        override fun toString() =
            "AgentUpdateBody{agent=$agent, chatIcon=$chatIcon, chatIconDeleted=$chatIconDeleted, logo=$logo, logoDeleted=$logoDeleted, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JsonProperty("agent") fun agent(agent: Agent) = apply { this.agent = agent }

            @JsonProperty("chatIcon")
            fun chatIcon(chatIcon: String) = apply { this.chatIcon = chatIcon }
            ...
            @JsonProperty("logo") fun logo(logo: String) = apply { this.logo = logo }

            @JsonProperty("logoDeleted")
            fun logoDeleted(logoDeleted: Boolean) = apply { this.logoDeleted = logoDeleted }
            ...
            fun build(): AgentUpdateBody =
                AgentUpdateBody(
                    checkNotNull(agent) { "`agent` is required but was not set" },
                    chatIcon,
                    chatIconDeleted,
                    logo,
                    logoDeleted,
    ...
    override fun toString() =
        "AgentUpdateParams{id=$id, agent=$agent, chatIcon=$chatIcon, chatIconDeleted=$chatIconDeleted, logo=$logo, logoDeleted=$logoDeleted, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun agent(agent: Agent) = apply { this.agent = agent }
    ...
    private constructor(
        ...
        @JsonProperty("brandColor") fun brandColor(): String? = brandColor

        @JsonProperty("organizationId") fun organizationId(): String? = organizationId

        @JsonProperty("persona") fun persona(): Persona? = persona

        @JsonProperty("additionalPromptText")
        fun additionalPromptText(): String? = additionalPromptText

        @JsonProperty("popularQuestions") fun popularQuestions(): List<String>? = popularQuestions

        @JsonProperty("bailoutType") fun bailoutType(): BailoutType? = bailoutType

        @JsonProperty("bailoutText") fun bailoutText(): String? = bailoutText

        @JsonProperty("bailoutIntegration")
        fun bailoutIntegration(): BailoutIntegration? = bailoutIntegration

        @JsonProperty("hiddenTicketTags") fun hiddenTicketTags(): List<String>? = hiddenTicketTags

        @JsonProperty("internal__salesStatus")
        fun internalSalesStatus(): InternalSalesStatus? = internalSalesStatus

        @JsonProperty("createdAt") fun createdAt(): OffsetDateTime? = createdAt

        @JsonProperty("updatedAt") fun updatedAt(): OffsetDateTime? = updatedAt
        ...
        class Builder {
            ...
            fun brandColor(brandColor: String) = apply { this.brandColor = brandColor }
            ...
            fun bailoutType(bailoutType: BailoutType) = apply { this.bailoutType = bailoutType }

            @JsonProperty("bailoutText")
            fun bailoutText(bailoutText: String) = apply { this.bailoutText = bailoutText }
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is BailoutIntegration && this.value == other.value
            }
            ...
            companion object {
                ...
                @JvmField val SALESFORCE = BailoutIntegration(JsonField.of("SALESFORCE"))

                @JvmField val ZENDESK = BailoutIntegration(JsonField.of("ZENDESK"))

                @JvmField val FRESHDESK = BailoutIntegration(JsonField.of("FRESHDESK"))

                @JvmField val SLACK_QA_BOT = BailoutIntegration(JsonField.of("SLACK_QA_BOT"))

                @JvmField val TWILIO = BailoutIntegration(JsonField.of("TWILIO"))

                @JvmStatic fun of(value: String) = BailoutIntegration(JsonField.of(value))
            }
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is BailoutType && this.value == other.value
            }
            ...
            companion object {
                ...
                @JvmField val INTEGRATION = BailoutType(JsonField.of("INTEGRATION"))

                @JvmField val TEXT = BailoutType(JsonField.of("TEXT"))

                @JvmStatic fun of(value: String) = BailoutType(JsonField.of(value))
            }
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is InternalSalesStatus && this.value == other.value
            }
            ...
            companion object {
                ...
                @JvmField val LIVE = InternalSalesStatus(JsonField.of("LIVE"))

                @JvmField val ONBOARDING = InternalSalesStatus(JsonField.of("ONBOARDING"))

                @JvmField val PROSPECT = InternalSalesStatus(JsonField.of("PROSPECT"))

                @JvmField val TESTING = InternalSalesStatus(JsonField.of("TESTING"))

                @JvmField val Z_INACTIVE = InternalSalesStatus(JsonField.of("Z_INACTIVE"))

                @JvmStatic fun of(value: String) = InternalSalesStatus(JsonField.of(value))
            }
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is Persona && this.value == other.value
            }
            ...
            companion object {
                ...
                @JvmField val ANY = Persona(JsonField.of("ANY"))

                @JvmField val CASUAL_BUDDY = Persona(JsonField.of("CASUAL_BUDDY"))

                @JvmField val EMPATHETIC_SUPPORTER = Persona(JsonField.of("EMPATHETIC_SUPPORTER"))

                @JvmField val FORMAL_PROFESSIONAL = Persona(JsonField.of("FORMAL_PROFESSIONAL"))

                @JvmField val CONCISE_EXPERT = Persona(JsonField.of("CONCISE_EXPERT"))

                @JvmField val ENTHUSIASTIC_HELPER = Persona(JsonField.of("ENTHUSIASTIC_HELPER"))

                @JvmField val PATIENT_EDUCATOR = Persona(JsonField.of("PATIENT_EDUCATOR"))

                @JvmField val PIRATE = Persona(JsonField.of("PIRATE"))

                @JvmStatic fun of(value: String) = Persona(JsonField.of(value))
            }
