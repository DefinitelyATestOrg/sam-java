...
class CorporaUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    fun crawlSpec(): Optional<CrawlSpec> = Optional.ofNullable(crawlSpec)

    fun createdBy(): Optional<CreatedBy> = Optional.ofNullable(createdBy)

    fun excludeLastUpdatedBefore(): Optional<OffsetDateTime> = Optional.ofNullable(excludeLastUpdatedBefore)

    fun htmlTransformer(): Optional<HtmlTransformer> = Optional.ofNullable(htmlTransformer)

    fun includedKbArticleIds(): Optional<List<String>> = Optional.ofNullable(includedKbArticleIds)

    fun integration(): Optional<Integration> = Optional.ofNullable(integration)

    fun integrationCategoryId(): Optional<String> = Optional.ofNullable(integrationCategoryId)

    fun sourceUrl(): Optional<String> = Optional.ofNullable(sourceUrl)
    ...
    fun urlExclusionPatterns(): Optional<List<String>> = Optional.ofNullable(urlExclusionPatterns)
    ...
    @NoAutoDetect
    class CorporaUpdateBody internal constructor(
      private val agentId: String?,
      private val name: String?,
      private val active: Boolean?,
      private val crawlSpec: CrawlSpec?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            @JsonProperty("crawlSpec")
            fun crawlSpec(crawlSpec: CrawlSpec) = apply {
            ...
            fun build(): CorporaUpdateBody = CorporaUpdateBody(
    ...
    class Builder {
        ...
        fun corpusId(corpusId: String) = apply {
        ...
        fun build(): CorporaUpdateParams = CorporaUpdateParams(
            checkNotNull(corpusId) {
                "`corpusId` is required but was not set"
            },
            checkNotNull(agentId) {
                "`agentId` is required but was not set"
            },
    ...
    @NoAutoDetect
    class CrawlSpec private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun startUrls(): List<String>? = startUrls
        ...
        fun maxCrawlDepth(): Long? = maxCrawlDepth

        @JsonProperty("maxCrawlPages")
        fun maxCrawlPages(): Long? = maxCrawlPages

        @JsonProperty("initialConcurrency")
        fun initialConcurrency(): Long? = initialConcurrency

        @JsonProperty("maxConcurrency")
        fun maxConcurrency(): Long? = maxConcurrency

        @JsonProperty("timeoutSeconds")
        fun timeoutSeconds(): Long? = timeoutSeconds

        @JsonProperty("saveHtml")
        fun saveHtml(): Boolean? = saveHtml

        @JsonProperty("saveMarkdown")
        fun saveMarkdown(): Boolean? = saveMarkdown

        @JsonProperty("useSitemaps")
        fun useSitemaps(): Boolean? = useSitemaps
        ...
        class Builder {
            ...
            @JsonProperty("startUrls")
            fun startUrls(startUrls: List<String>) = apply {
            ...
            @JsonProperty("maxCrawlDepth")
            fun maxCrawlDepth(maxCrawlDepth: Long) = apply {
                this.maxCrawlDepth = maxCrawlDepth
            }

            @JsonProperty("maxCrawlPages")
            fun maxCrawlPages(maxCrawlPages: Long) = apply {
            ...
            @JsonProperty("saveHtml")
            fun saveHtml(saveHtml: Boolean) = apply {
                this.saveHtml = saveHtml
            }

            @JsonProperty("saveMarkdown")
            fun saveMarkdown(saveMarkdown: Boolean) = apply {
                this.saveMarkdown = saveMarkdown
            }

            @JsonProperty("useSitemaps")
            fun useSitemaps(useSitemaps: Boolean) = apply {
        ...
        class HtmlTransformer @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is HtmlTransformer &&
            ...
            companion object {
                ...
                @JvmField val NONE = HtmlTransformer(JsonField.of("NONE"))

                @JvmField val EXTRACTUS = HtmlTransformer(JsonField.of("EXTRACTUS"))

                @JvmField val READABLE_TEXT = HtmlTransformer(JsonField.of("READABLE_TEXT"))

                @JvmField val READABLE_TEXT_IF_POSSIBLE = HtmlTransformer(JsonField.of("READABLE_TEXT_IF_POSSIBLE"))

                @JvmStatic fun of(value: String) = HtmlTransformer(JsonField.of(value))
            }
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val READY = Status(JsonField.of("READY"))
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val FILE_UPLOAD = Type(JsonField.of("FILE_UPLOAD"))

            @JvmField val EXTERNAL_INTEGRATION = Type(JsonField.of("EXTERNAL_INTEGRATION"))

            @JvmField val FRESHDESK_KB = Type(JsonField.of("FRESHDESK_KB"))

            @JvmField val ZENDESK_KB = Type(JsonField.of("ZENDESK_KB"))

            @JvmField val CSV = Type(JsonField.of("CSV"))
