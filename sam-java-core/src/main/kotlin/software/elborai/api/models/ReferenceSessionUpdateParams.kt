...
class ReferenceSessionUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    fun bodyId(): Optional<String> = Optional.ofNullable(bodyId)

    fun createdBy(): Optional<CreatedBy> = Optional.ofNullable(createdBy)

    fun questions(): Optional<List<Question>> = Optional.ofNullable(questions)

    fun referenceSetId(): Optional<String> = Optional.ofNullable(referenceSetId)
    ...
    @NoAutoDetect
    class ReferenceSessionUpdateBody internal constructor(
      private val bodyId: String?,
      private val createdBy: CreatedBy?,
      private val questions: List<Question>?,
      private val referenceSetId: String?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "ReferenceSessionUpdateBody{bodyId=$bodyId, createdBy=$createdBy, questions=$questions, referenceSetId=$referenceSetId, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): ReferenceSessionUpdateBody = ReferenceSessionUpdateBody(
                bodyId,
                createdBy,
    ...
    override fun toString() = "ReferenceSessionUpdateParams{pathId=$pathId, bodyId=$bodyId, createdBy=$createdBy, questions=$questions, referenceSetId=$referenceSetId, updatedBy=$updatedBy, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): ReferenceSessionUpdateParams = ReferenceSessionUpdateParams(
            checkNotNull(pathId) {
    ...
    @NoAutoDetect
    class Question private constructor(private val question: String?, private val expectedAnswer: String?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        fun expectedAnswer(): String? = expectedAnswer
        ...
        override fun toString() = "Question{question=$question, expectedAnswer=$expectedAnswer, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JsonProperty("question")
            fun question(question: String) = apply {
