...
class ExportCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    fun accountStatementOfx(): Optional<AccountStatementOfx> = Optional.ofNullable(accountStatementOfx)

    fun balanceCsv(): Optional<BalanceCsv> = Optional.ofNullable(balanceCsv)

    fun bookkeepingAccountBalanceCsv(): Optional<BookkeepingAccountBalanceCsv> = Optional.ofNullable(bookkeepingAccountBalanceCsv)
    ...
    class Category @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val BOOKKEEPING_ACCOUNT_BALANCE_CSV = Category(JsonField.of("bookkeeping_account_balance_csv"))
    ...
    @NoAutoDetect
    class BalanceCsv private constructor(private val accountId: String?, private val createdAt: CreatedAt?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "BalanceCsv{accountId=$accountId, createdAt=$createdAt, additionalProperties=$additionalProperties}"
    ...
    @NoAutoDetect
    class TransactionCsv private constructor(private val accountId: String?, private val createdAt: CreatedAt?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "TransactionCsv{accountId=$accountId, createdAt=$createdAt, additionalProperties=$additionalProperties}"
