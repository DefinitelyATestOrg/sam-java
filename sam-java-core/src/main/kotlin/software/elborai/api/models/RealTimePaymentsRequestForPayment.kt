  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Refusal private constructor(private val refusalReasonCode: JsonField<RefusalReasonCode>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        class RefusalReasonCode @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
            ...
            companion object {
                ...
                @JvmField val TRANSACTION_FORBIDDEN = RefusalReasonCode(JsonField.of("transaction_forbidden"))

                @JvmField val TRANSACTION_TYPE_NOT_SUPPORTED = RefusalReasonCode(JsonField.of("transaction_type_not_supported"))

                @JvmField val UNEXPECTED_AMOUNT = RefusalReasonCode(JsonField.of("unexpected_amount"))

                @JvmField val AMOUNT_EXCEEDS_BANK_LIMITS = RefusalReasonCode(JsonField.of("amount_exceeds_bank_limits"))

                @JvmField val INVALID_DEBTOR_ADDRESS = RefusalReasonCode(JsonField.of("invalid_debtor_address"))

                @JvmField val INVALID_CREDITOR_ADDRESS = RefusalReasonCode(JsonField.of("invalid_creditor_address"))

                @JvmField val CREDITOR_IDENTIFIER_INCORRECT = RefusalReasonCode(JsonField.of("creditor_identifier_incorrect"))

                @JvmField val REQUESTED_BY_CUSTOMER = RefusalReasonCode(JsonField.of("requested_by_customer"))

                @JvmField val ORDER_REJECTED = RefusalReasonCode(JsonField.of("order_rejected"))

                @JvmField val END_CUSTOMER_DECEASED = RefusalReasonCode(JsonField.of("end_customer_deceased"))

                @JvmField val CUSTOMER_HAS_OPTED_OUT = RefusalReasonCode(JsonField.of("customer_has_opted_out"))
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val REAL_TIME_PAYMENTS_REQUEST_FOR_PAYMENT = Type(JsonField.of("real_time_payments_request_for_payment"))
