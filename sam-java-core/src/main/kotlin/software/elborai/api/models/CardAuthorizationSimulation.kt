...
@NoAutoDetect
class CardAuthorizationSimulation private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
     ...
     */
    fun declinedTransaction(): Optional<DeclinedTransaction> = Optional.ofNullable(declinedTransaction.getNullable("declined_transaction"))
     ...
     */
    fun pendingTransaction(): Optional<PendingTransaction> = Optional.ofNullable(pendingTransaction.getNullable("pending_transaction"))
    ...
    override fun toString() = "CardAuthorizationSimulation{declinedTransaction=$declinedTransaction, pendingTransaction=$pendingTransaction, type=$type, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): CardAuthorizationSimulation = CardAuthorizationSimulation(
            declinedTransaction,
            pendingTransaction,
            type,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Source private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
             ...
             */
            fun achDecline(): Optional<AchDecline> = Optional.ofNullable(achDecline.getNullable("ach_decline"))
             ...
             */
            fun checkDecline(): Optional<CheckDecline> = Optional.ofNullable(checkDecline.getNullable("check_decline"))
             ...
             */
            fun checkDepositRejection(): Optional<CheckDepositRejection> = Optional.ofNullable(checkDepositRejection.getNullable("check_deposit_rejection"))
             ...
             */
            fun inboundRealTimePaymentsTransferDecline(): Optional<InboundRealTimePaymentsTransferDecline> = Optional.ofNullable(inboundRealTimePaymentsTransferDecline.getNullable("inbound_real_time_payments_transfer_decline"))

            /**
             * An International ACH Decline object. This field will be present in the JSON
             * response if and only if `category` is equal to `international_ach_decline`.
             */
            fun internationalAchDecline(): Optional<InternationalAchDecline> = Optional.ofNullable(internationalAchDecline.getNullable("international_ach_decline"))

            /**
             * A Wire Decline object. This field will be present in the JSON response if and
             * only if `category` is equal to `wire_decline`.
             */
            fun wireDecline(): Optional<WireDecline> = Optional.ofNullable(wireDecline.getNullable("wire_decline"))
            ...
            fun validate(): Source = apply {
                if (!validated) {
                  ...
                  checkDepositRejection().map { it.validate() }
            ...
            class Builder {
                ...
                private var internationalAchDecline: JsonField<InternationalAchDecline> = JsonMissing.of()
                 ...
                 * response if and only if `category` is equal to `international_ach_decline`.
                 */
                fun internationalAchDecline(internationalAchDecline: InternationalAchDecline) = internationalAchDecline(JsonField.of(internationalAchDecline))
                ...
                @JsonProperty("international_ach_decline")
                @ExcludeMissing
                fun internationalAchDecline(internationalAchDecline: JsonField<InternationalAchDecline>) = apply {
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Reason @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                    ...
                    companion object {
                        ...
                        @JvmField val RETURN_OF_ERRONEOUS_OR_REVERSING_DEBIT = Reason(JsonField.of("return_of_erroneous_or_reversing_debit"))
            ...
            class Category @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val INBOUND_REAL_TIME_PAYMENTS_TRANSFER_DECLINE = Category(JsonField.of("inbound_real_time_payments_transfer_decline"))

                    @JvmField val INTERNATIONAL_ACH_DECLINE = Category(JsonField.of("international_ach_decline"))

                    @JvmField val WIRE_DECLINE = Category(JsonField.of("wire_decline"))

                    @JvmField val CHECK_DEPOSIT_REJECTION = Category(JsonField.of("check_deposit_rejection"))
            ...
            class CheckDecline private constructor(
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                fun checkTransferId(): Optional<String> = Optional.ofNullable(checkTransferId.getNullable("check_transfer_id"))
                ...
                class Reason @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                    ...
                    companion object {
                        ...
                        @JvmField val STOP_PAYMENT_REQUESTED = Reason(JsonField.of("stop_payment_requested"))
                        ...
                        @JvmField val NO_ACCOUNT_NUMBER_FOUND = Reason(JsonField.of("no_account_number_found"))
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Reason @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                    ...
                    companion object {
                        ...
                        @JvmField val NOT_ELIGIBLE_FOR_MOBILE_DEPOSIT = Reason(JsonField.of("not_eligible_for_mobile_deposit"))

                        @JvmField val MISSING_REQUIRED_DATA_ELEMENTS = Reason(JsonField.of("missing_required_data_elements"))

                        @JvmField val SUSPECTED_FRAUD = Reason(JsonField.of("suspected_fraud"))

                        @JvmField val DEPOSIT_WINDOW_EXPIRED = Reason(JsonField.of("deposit_window_expired"))
            ...
            @NoAutoDetect
            class InternationalAchDecline private constructor(
              private val amount: JsonField<Long>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Builder {
                    ...
                    internal fun from(internationalAchDecline: InternationalAchDecline) = apply {
                        ...
                        this.foreignExchangeReferenceIndicator = internationalAchDecline.foreignExchangeReferenceIndicator
                        ...
                        this.internationalTransactionTypeCode = internationalAchDecline.internationalTransactionTypeCode
                        this.originatingCurrencyCode = internationalAchDecline.originatingCurrencyCode
                        this.originatingDepositoryFinancialInstitutionBranchCountry = internationalAchDecline.originatingDepositoryFinancialInstitutionBranchCountry
                        this.originatingDepositoryFinancialInstitutionId = internationalAchDecline.originatingDepositoryFinancialInstitutionId
                        this.originatingDepositoryFinancialInstitutionIdQualifier = internationalAchDecline.originatingDepositoryFinancialInstitutionIdQualifier
                        this.originatingDepositoryFinancialInstitutionName = internationalAchDecline.originatingDepositoryFinancialInstitutionName
                        this.originatorCity = internationalAchDecline.originatorCity
                        this.originatorCompanyEntryDescription = internationalAchDecline.originatorCompanyEntryDescription
                        ...
                        this.originatorStateOrProvince = internationalAchDecline.originatorStateOrProvince
                        this.originatorStreetAddress = internationalAchDecline.originatorStreetAddress
                        this.paymentRelatedInformation = internationalAchDecline.paymentRelatedInformation
                        this.paymentRelatedInformation2 = internationalAchDecline.paymentRelatedInformation2
                        this.receiverCity = internationalAchDecline.receiverCity
                        this.receiverCountry = internationalAchDecline.receiverCountry
                        this.receiverIdentificationNumber = internationalAchDecline.receiverIdentificationNumber
                        ...
                        this.receivingCompanyOrIndividualName = internationalAchDecline.receivingCompanyOrIndividualName
                        this.receivingDepositoryFinancialInstitutionCountry = internationalAchDecline.receivingDepositoryFinancialInstitutionCountry
                        this.receivingDepositoryFinancialInstitutionId = internationalAchDecline.receivingDepositoryFinancialInstitutionId
                        this.receivingDepositoryFinancialInstitutionIdQualifier = internationalAchDecline.receivingDepositoryFinancialInstitutionIdQualifier
                        this.receivingDepositoryFinancialInstitutionName = internationalAchDecline.receivingDepositoryFinancialInstitutionName
                    ...
                    fun build(): InternationalAchDecline = InternationalAchDecline(
                        amount,
                        destinationCountryCode,
                        destinationCurrencyCode,
                        foreignExchangeIndicator,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Source private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
             ...
             */
            fun accountTransferInstruction(): Optional<AccountTransferInstruction> = Optional.ofNullable(accountTransferInstruction.getNullable("account_transfer_instruction"))

            /**
             * An ACH Transfer Instruction object. This field will be present in the JSON
             * response if and only if `category` is equal to `ach_transfer_instruction`.
             */
            fun achTransferInstruction(): Optional<AchTransferInstruction> = Optional.ofNullable(achTransferInstruction.getNullable("ach_transfer_instruction"))
             ...
             */
            fun checkDepositInstruction(): Optional<CheckDepositInstruction> = Optional.ofNullable(checkDepositInstruction.getNullable("check_deposit_instruction"))

            /**
             * A Check Transfer Instruction object. This field will be present in the JSON
             * response if and only if `category` is equal to `check_transfer_instruction`.
             */
            fun checkTransferInstruction(): Optional<CheckTransferInstruction> = Optional.ofNullable(checkTransferInstruction.getNullable("check_transfer_instruction"))

            /**
             * An Inbound Funds Hold object. This field will be present in the JSON response if
             * and only if `category` is equal to `inbound_funds_hold`.
             */
            fun inboundFundsHold(): Optional<InboundFundsHold> = Optional.ofNullable(inboundFundsHold.getNullable("inbound_funds_hold"))
             ...
             */
            fun realTimePaymentsTransferInstruction(): Optional<RealTimePaymentsTransferInstruction> = Optional.ofNullable(realTimePaymentsTransferInstruction.getNullable("real_time_payments_transfer_instruction"))

            /**
             * A Wire Transfer Instruction object. This field will be present in the JSON
             * response if and only if `category` is equal to `wire_transfer_instruction`.
             */
            fun wireTransferInstruction(): Optional<WireTransferInstruction> = Optional.ofNullable(wireTransferInstruction.getNullable("wire_transfer_instruction"))
            ...
            class Category @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val ACCOUNT_TRANSFER_INSTRUCTION = Category(JsonField.of("account_transfer_instruction"))

                    @JvmField val ACH_TRANSFER_INSTRUCTION = Category(JsonField.of("ach_transfer_instruction"))

                    @JvmField val CARD_AUTHORIZATION = Category(JsonField.of("card_authorization"))

                    @JvmField val CHECK_DEPOSIT_INSTRUCTION = Category(JsonField.of("check_deposit_instruction"))

                    @JvmField val CHECK_TRANSFER_INSTRUCTION = Category(JsonField.of("check_transfer_instruction"))

                    @JvmField val INBOUND_FUNDS_HOLD = Category(JsonField.of("inbound_funds_hold"))

                    @JvmField val REAL_TIME_PAYMENTS_TRANSFER_INSTRUCTION = Category(JsonField.of("real_time_payments_transfer_instruction"))

                    @JvmField val WIRE_TRANSFER_INSTRUCTION = Category(JsonField.of("wire_transfer_instruction"))
            ...
            class CheckDepositInstruction private constructor(
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                fun checkDepositId(): Optional<String> = Optional.ofNullable(checkDepositId.getNullable("check_deposit_id"))
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val INBOUND_CARD_AUTHORIZATION_SIMULATION_RESULT = Type(JsonField.of("inbound_card_authorization_simulation_result"))
