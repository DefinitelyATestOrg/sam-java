...
class IntrafiAccountEnrollmentListPage private constructor(private val accountEnrollmentsService: AccountEnrollmentService, private val params: IntrafiAccountEnrollmentListParams, private val response: Response, ) {
    ...
    override fun toString() = "IntrafiAccountEnrollmentListPage{accountEnrollmentsService=$accountEnrollmentsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<IntrafiAccountEnrollmentListPage> {
      return getNextPageParams().map { accountEnrollmentsService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(accountEnrollmentsService: AccountEnrollmentService, params: IntrafiAccountEnrollmentListParams, response: Response) = IntrafiAccountEnrollmentListPage(
            accountEnrollmentsService,
            params,
            response,
        )
    ...
    class AutoPager constructor(private val firstPage: IntrafiAccountEnrollmentListPage, ) : Iterable<IntrafiAccountEnrollment> {
