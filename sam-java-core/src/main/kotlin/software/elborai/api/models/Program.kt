...
class Program private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    fun billingAccountId(): Optional<String> = Optional.ofNullable(billingAccountId.getNullable("billing_account_id"))
    ...
    fun defaultDigitalCardProfileId(): Optional<String> = Optional.ofNullable(defaultDigitalCardProfileId.getNullable("default_digital_card_profile_id"))
