  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Source private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
         ...
         */
        fun accountTransferIntention(): Optional<AccountTransferIntention> = Optional.ofNullable(accountTransferIntention.getNullable("account_transfer_intention"))

        /**
         * An ACH Transfer Intention object. This field will be present in the JSON
         * response if and only if `category` is equal to `ach_transfer_intention`.
         */
        fun achTransferIntention(): Optional<AchTransferIntention> = Optional.ofNullable(achTransferIntention.getNullable("ach_transfer_intention"))

        /**
         * An ACH Transfer Rejection object. This field will be present in the JSON
         * response if and only if `category` is equal to `ach_transfer_rejection`.
         */
        fun achTransferRejection(): Optional<AchTransferRejection> = Optional.ofNullable(achTransferRejection.getNullable("ach_transfer_rejection"))

        /**
         * An ACH Transfer Return object. This field will be present in the JSON response
         * if and only if `category` is equal to `ach_transfer_return`.
         */
        fun achTransferReturn(): Optional<AchTransferReturn> = Optional.ofNullable(achTransferReturn.getNullable("ach_transfer_return"))

        /**
         * A Card Dispute Acceptance object. This field will be present in the JSON
         * response if and only if `category` is equal to `card_dispute_acceptance`.
         */
        fun cardDisputeAcceptance(): Optional<CardDisputeAcceptance> = Optional.ofNullable(cardDisputeAcceptance.getNullable("card_dispute_acceptance"))
         ...
         */
        fun cardDisputeLoss(): Optional<CardDisputeLoss> = Optional.ofNullable(cardDisputeLoss.getNullable("card_dispute_loss"))

        /**
         * A Card Refund object. This field will be present in the JSON response if and
         * only if `category` is equal to `card_refund`.
         */
        fun cardRefund(): Optional<CardRefund> = Optional.ofNullable(cardRefund.getNullable("card_refund"))

        /**
         * A Card Revenue Payment object. This field will be present in the JSON response
         * if and only if `category` is equal to `card_revenue_payment`.
         */
        fun cardRevenuePayment(): Optional<CardRevenuePayment> = Optional.ofNullable(cardRevenuePayment.getNullable("card_revenue_payment"))

        /**
         * A Card Settlement object. This field will be present in the JSON response if and
         * only if `category` is equal to `card_settlement`.
         */
        fun cardSettlement(): Optional<CardSettlement> = Optional.ofNullable(cardSettlement.getNullable("card_settlement"))
         ...
         */
        fun cashbackPayment(): Optional<CashbackPayment> = Optional.ofNullable(cashbackPayment.getNullable("cashback_payment"))
         ...
         */
        fun checkDepositAcceptance(): Optional<CheckDepositAcceptance> = Optional.ofNullable(checkDepositAcceptance.getNullable("check_deposit_acceptance"))

        /**
         * A Check Deposit Return object. This field will be present in the JSON response
         * if and only if `category` is equal to `check_deposit_return`.
         */
        fun checkDepositReturn(): Optional<CheckDepositReturn> = Optional.ofNullable(checkDepositReturn.getNullable("check_deposit_return"))

        /**
         * A Check Transfer Deposit object. This field will be present in the JSON response
         * if and only if `category` is equal to `check_transfer_deposit`.
         */
        fun checkTransferDeposit(): Optional<CheckTransferDeposit> = Optional.ofNullable(checkTransferDeposit.getNullable("check_transfer_deposit"))
         ...
         */
        fun checkTransferStopPaymentRequest(): Optional<CheckTransferStopPaymentRequest> = Optional.ofNullable(checkTransferStopPaymentRequest.getNullable("check_transfer_stop_payment_request"))

        /**
         * A Fee Payment object. This field will be present in the JSON response if and
         * only if `category` is equal to `fee_payment`.
         */
        fun feePayment(): Optional<FeePayment> = Optional.ofNullable(feePayment.getNullable("fee_payment"))

        /**
         * An Inbound ACH Transfer Intention object. This field will be present in the JSON
         * response if and only if `category` is equal to `inbound_ach_transfer`.
         */
        fun inboundAchTransfer(): Optional<InboundAchTransfer> = Optional.ofNullable(inboundAchTransfer.getNullable("inbound_ach_transfer"))
         ...
         */
        fun inboundInternationalAchTransfer(): Optional<InboundInternationalAchTransfer> = Optional.ofNullable(inboundInternationalAchTransfer.getNullable("inbound_international_ach_transfer"))
         ...
         */
        fun inboundRealTimePaymentsTransferConfirmation(): Optional<InboundRealTimePaymentsTransferConfirmation> = Optional.ofNullable(inboundRealTimePaymentsTransferConfirmation.getNullable("inbound_real_time_payments_transfer_confirmation"))

        /**
         * An Inbound Wire Drawdown Payment object. This field will be present in the JSON
         * response if and only if `category` is equal to `inbound_wire_drawdown_payment`.
         */
        fun inboundWireDrawdownPayment(): Optional<InboundWireDrawdownPayment> = Optional.ofNullable(inboundWireDrawdownPayment.getNullable("inbound_wire_drawdown_payment"))

        /**
         * An Inbound Wire Reversal object. This field will be present in the JSON response
         * if and only if `category` is equal to `inbound_wire_reversal`.
         */
        fun inboundWireReversal(): Optional<InboundWireReversal> = Optional.ofNullable(inboundWireReversal.getNullable("inbound_wire_reversal"))

        /**
         * An Inbound Wire Transfer Intention object. This field will be present in the
         * JSON response if and only if `category` is equal to `inbound_wire_transfer`.
         */
        fun inboundWireTransfer(): Optional<InboundWireTransfer> = Optional.ofNullable(inboundWireTransfer.getNullable("inbound_wire_transfer"))

        /**
         * An Interest Payment object. This field will be present in the JSON response if
         * and only if `category` is equal to `interest_payment`.
         */
        fun interestPayment(): Optional<InterestPayment> = Optional.ofNullable(interestPayment.getNullable("interest_payment"))

        /**
         * An Internal Source object. This field will be present in the JSON response if
         * and only if `category` is equal to `internal_source`.
         */
        fun internalSource(): Optional<InternalSource> = Optional.ofNullable(internalSource.getNullable("internal_source"))
         ...
         */
        fun realTimePaymentsTransferAcknowledgement(): Optional<RealTimePaymentsTransferAcknowledgement> = Optional.ofNullable(realTimePaymentsTransferAcknowledgement.getNullable("real_time_payments_transfer_acknowledgement"))

        /**
         * A Sample Funds object. This field will be present in the JSON response if and
         * only if `category` is equal to `sample_funds`.
         */
        fun sampleFunds(): Optional<SampleFunds> = Optional.ofNullable(sampleFunds.getNullable("sample_funds"))

        /**
         * A Wire Transfer Intention object. This field will be present in the JSON
         * response if and only if `category` is equal to `wire_transfer_intention`.
         */
        fun wireTransferIntention(): Optional<WireTransferIntention> = Optional.ofNullable(wireTransferIntention.getNullable("wire_transfer_intention"))

        /**
         * A Wire Transfer Rejection object. This field will be present in the JSON
         * response if and only if `category` is equal to `wire_transfer_rejection`.
         */
        fun wireTransferRejection(): Optional<WireTransferRejection> = Optional.ofNullable(wireTransferRejection.getNullable("wire_transfer_rejection"))
        ...
        fun validate(): Source = apply {
            if (!validated) {
              ...
              internalSource().map { it.validate() }
        ...
        class Builder {
            ...
            private var checkTransferStopPaymentRequest: JsonField<CheckTransferStopPaymentRequest> = JsonMissing.of()
            ...
            private var inboundInternationalAchTransfer: JsonField<InboundInternationalAchTransfer> = JsonMissing.of()
            ...
            private var inboundWireDrawdownPayment: JsonField<InboundWireDrawdownPayment> = JsonMissing.of()
             ...
             * `check_transfer_stop_payment_request`.
             */
            fun checkTransferStopPaymentRequest(checkTransferStopPaymentRequest: CheckTransferStopPaymentRequest) = checkTransferStopPaymentRequest(JsonField.of(checkTransferStopPaymentRequest))
            ...
            @JsonProperty("check_transfer_stop_payment_request")
            @ExcludeMissing
            fun checkTransferStopPaymentRequest(checkTransferStopPaymentRequest: JsonField<CheckTransferStopPaymentRequest>) = apply {
             ...
             * `inbound_international_ach_transfer`.
             */
            fun inboundInternationalAchTransfer(inboundInternationalAchTransfer: InboundInternationalAchTransfer) = inboundInternationalAchTransfer(JsonField.of(inboundInternationalAchTransfer))
            ...
            @JsonProperty("inbound_international_ach_transfer")
            @ExcludeMissing
            fun inboundInternationalAchTransfer(inboundInternationalAchTransfer: JsonField<InboundInternationalAchTransfer>) = apply {
             ...
             * response if and only if `category` is equal to `inbound_wire_drawdown_payment`.
             */
            fun inboundWireDrawdownPayment(inboundWireDrawdownPayment: InboundWireDrawdownPayment) = inboundWireDrawdownPayment(JsonField.of(inboundWireDrawdownPayment))
            ...
            @JsonProperty("inbound_wire_drawdown_payment")
            @ExcludeMissing
            fun inboundWireDrawdownPayment(inboundWireDrawdownPayment: JsonField<InboundWireDrawdownPayment>) = apply {
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            class ReturnReasonCode @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val INSUFFICIENT_FUND = ReturnReasonCode(JsonField.of("insufficient_fund"))
                    ...
                    @JvmField val INVALID_ACCOUNT_NUMBER_STRUCTURE = ReturnReasonCode(JsonField.of("invalid_account_number_structure"))

                    @JvmField val ACCOUNT_FROZEN_ENTRY_RETURNED_PER_OFAC_INSTRUCTION = ReturnReasonCode(JsonField.of("account_frozen_entry_returned_per_ofac_instruction"))

                    @JvmField val CREDIT_ENTRY_REFUSED_BY_RECEIVER = ReturnReasonCode(JsonField.of("credit_entry_refused_by_receiver"))

                    @JvmField val UNAUTHORIZED_DEBIT_TO_CONSUMER_ACCOUNT_USING_CORPORATE_SEC_CODE = ReturnReasonCode(JsonField.of("unauthorized_debit_to_consumer_account_using_corporate_sec_code"))

                    @JvmField val CORPORATE_CUSTOMER_ADVISED_NOT_AUTHORIZED = ReturnReasonCode(JsonField.of("corporate_customer_advised_not_authorized"))

                    @JvmField val PAYMENT_STOPPED = ReturnReasonCode(JsonField.of("payment_stopped"))

                    @JvmField val NON_TRANSACTION_ACCOUNT = ReturnReasonCode(JsonField.of("non_transaction_account"))

                    @JvmField val UNCOLLECTED_FUNDS = ReturnReasonCode(JsonField.of("uncollected_funds"))

                    @JvmField val ROUTING_NUMBER_CHECK_DIGIT_ERROR = ReturnReasonCode(JsonField.of("routing_number_check_digit_error"))

                    @JvmField val CUSTOMER_ADVISED_UNAUTHORIZED_IMPROPER_INELIGIBLE_OR_INCOMPLETE = ReturnReasonCode(JsonField.of("customer_advised_unauthorized_improper_ineligible_or_incomplete"))

                    @JvmField val AMOUNT_FIELD_ERROR = ReturnReasonCode(JsonField.of("amount_field_error"))

                    @JvmField val AUTHORIZATION_REVOKED_BY_CUSTOMER = ReturnReasonCode(JsonField.of("authorization_revoked_by_customer"))

                    @JvmField val INVALID_ACH_ROUTING_NUMBER = ReturnReasonCode(JsonField.of("invalid_ach_routing_number"))

                    @JvmField val FILE_RECORD_EDIT_CRITERIA = ReturnReasonCode(JsonField.of("file_record_edit_criteria"))

                    @JvmField val ENR_INVALID_INDIVIDUAL_NAME = ReturnReasonCode(JsonField.of("enr_invalid_individual_name"))

                    @JvmField val RETURNED_PER_ODFI_REQUEST = ReturnReasonCode(JsonField.of("returned_per_odfi_request"))

                    @JvmField val LIMITED_PARTICIPATION_DFI = ReturnReasonCode(JsonField.of("limited_participation_dfi"))

                    @JvmField val INCORRECTLY_CODED_OUTBOUND_INTERNATIONAL_PAYMENT = ReturnReasonCode(JsonField.of("incorrectly_coded_outbound_international_payment"))

                    @JvmField val ACCOUNT_SOLD_TO_ANOTHER_DFI = ReturnReasonCode(JsonField.of("account_sold_to_another_dfi"))

                    @JvmField val ADDENDA_ERROR = ReturnReasonCode(JsonField.of("addenda_error"))

                    @JvmField val BENEFICIARY_OR_ACCOUNT_HOLDER_DECEASED = ReturnReasonCode(JsonField.of("beneficiary_or_account_holder_deceased"))

                    @JvmField val CUSTOMER_ADVISED_NOT_WITHIN_AUTHORIZATION_TERMS = ReturnReasonCode(JsonField.of("customer_advised_not_within_authorization_terms"))
                    ...
                    @JvmField val ENR_DUPLICATE_ENROLLMENT = ReturnReasonCode(JsonField.of("enr_duplicate_enrollment"))

                    @JvmField val ENR_INVALID_DFI_ACCOUNT_NUMBER = ReturnReasonCode(JsonField.of("enr_invalid_dfi_account_number"))

                    @JvmField val ENR_INVALID_INDIVIDUAL_ID_NUMBER = ReturnReasonCode(JsonField.of("enr_invalid_individual_id_number"))

                    @JvmField val ENR_INVALID_REPRESENTATIVE_PAYEE_INDICATOR = ReturnReasonCode(JsonField.of("enr_invalid_representative_payee_indicator"))

                    @JvmField val ENR_INVALID_TRANSACTION_CODE = ReturnReasonCode(JsonField.of("enr_invalid_transaction_code"))

                    @JvmField val ENR_RETURN_OF_ENR_ENTRY = ReturnReasonCode(JsonField.of("enr_return_of_enr_entry"))

                    @JvmField val ENR_ROUTING_NUMBER_CHECK_DIGIT_ERROR = ReturnReasonCode(JsonField.of("enr_routing_number_check_digit_error"))

                    @JvmField val ENTRY_NOT_PROCESSED_BY_GATEWAY = ReturnReasonCode(JsonField.of("entry_not_processed_by_gateway"))

                    @JvmField val FIELD_ERROR = ReturnReasonCode(JsonField.of("field_error"))

                    @JvmField val FOREIGN_RECEIVING_DFI_UNABLE_TO_SETTLE = ReturnReasonCode(JsonField.of("foreign_receiving_dfi_unable_to_settle"))

                    @JvmField val IAT_ENTRY_CODING_ERROR = ReturnReasonCode(JsonField.of("iat_entry_coding_error"))

                    @JvmField val IMPROPER_EFFECTIVE_ENTRY_DATE = ReturnReasonCode(JsonField.of("improper_effective_entry_date"))

                    @JvmField val IMPROPER_SOURCE_DOCUMENT_SOURCE_DOCUMENT_PRESENTED = ReturnReasonCode(JsonField.of("improper_source_document_source_document_presented"))

                    @JvmField val INVALID_COMPANY_ID = ReturnReasonCode(JsonField.of("invalid_company_id"))

                    @JvmField val INVALID_FOREIGN_RECEIVING_DFI_IDENTIFICATION = ReturnReasonCode(JsonField.of("invalid_foreign_receiving_dfi_identification"))

                    @JvmField val INVALID_INDIVIDUAL_ID_NUMBER = ReturnReasonCode(JsonField.of("invalid_individual_id_number"))

                    @JvmField val ITEM_AND_RCK_ENTRY_PRESENTED_FOR_PAYMENT = ReturnReasonCode(JsonField.of("item_and_rck_entry_presented_for_payment"))

                    @JvmField val ITEM_RELATED_TO_RCK_ENTRY_IS_INELIGIBLE = ReturnReasonCode(JsonField.of("item_related_to_rck_entry_is_ineligible"))

                    @JvmField val MANDATORY_FIELD_ERROR = ReturnReasonCode(JsonField.of("mandatory_field_error"))

                    @JvmField val MISROUTED_DISHONORED_RETURN = ReturnReasonCode(JsonField.of("misrouted_dishonored_return"))
                    ...
                    @JvmField val NON_ACCEPTANCE_OF_R62_DISHONORED_RETURN = ReturnReasonCode(JsonField.of("non_acceptance_of_r62_dishonored_return"))

                    @JvmField val NON_PARTICIPANT_IN_IAT_PROGRAM = ReturnReasonCode(JsonField.of("non_participant_in_iat_program"))

                    @JvmField val PERMISSIBLE_RETURN_ENTRY = ReturnReasonCode(JsonField.of("permissible_return_entry"))

                    @JvmField val PERMISSIBLE_RETURN_ENTRY_NOT_ACCEPTED = ReturnReasonCode(JsonField.of("permissible_return_entry_not_accepted"))

                    @JvmField val RDFI_NON_SETTLEMENT = ReturnReasonCode(JsonField.of("rdfi_non_settlement"))

                    @JvmField val RDFI_PARTICIPANT_IN_CHECK_TRUNCATION_PROGRAM = ReturnReasonCode(JsonField.of("rdfi_participant_in_check_truncation_program"))

                    @JvmField val REPRESENTATIVE_PAYEE_DECEASED_OR_UNABLE_TO_CONTINUE_IN_THAT_CAPACITY = ReturnReasonCode(JsonField.of("representative_payee_deceased_or_unable_to_continue_in_that_capacity"))

                    @JvmField val RETURN_NOT_A_DUPLICATE = ReturnReasonCode(JsonField.of("return_not_a_duplicate"))

                    @JvmField val RETURN_OF_ERRONEOUS_OR_REVERSING_DEBIT = ReturnReasonCode(JsonField.of("return_of_erroneous_or_reversing_debit"))

                    @JvmField val RETURN_OF_IMPROPER_CREDIT_ENTRY = ReturnReasonCode(JsonField.of("return_of_improper_credit_entry"))

                    @JvmField val RETURN_OF_IMPROPER_DEBIT_ENTRY = ReturnReasonCode(JsonField.of("return_of_improper_debit_entry"))

                    @JvmField val RETURN_OF_XCK_ENTRY = ReturnReasonCode(JsonField.of("return_of_xck_entry"))

                    @JvmField val SOURCE_DOCUMENT_PRESENTED_FOR_PAYMENT = ReturnReasonCode(JsonField.of("source_document_presented_for_payment"))

                    @JvmField val STATE_LAW_AFFECTING_RCK_ACCEPTANCE = ReturnReasonCode(JsonField.of("state_law_affecting_rck_acceptance"))

                    @JvmField val STOP_PAYMENT_ON_ITEM_RELATED_TO_RCK_ENTRY = ReturnReasonCode(JsonField.of("stop_payment_on_item_related_to_rck_entry"))

                    @JvmField val STOP_PAYMENT_ON_SOURCE_DOCUMENT = ReturnReasonCode(JsonField.of("stop_payment_on_source_document"))

                    @JvmField val TIMELY_ORIGINAL_RETURN = ReturnReasonCode(JsonField.of("timely_original_return"))

                    @JvmField val TRACE_NUMBER_ERROR = ReturnReasonCode(JsonField.of("trace_number_error"))

                    @JvmField val UNTIMELY_DISHONORED_RETURN = ReturnReasonCode(JsonField.of("untimely_dishonored_return"))
        ...
        class CardRefund private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
             ...
             * is transacting with.
             */
            fun merchantAcceptorId(): Optional<String> = Optional.ofNullable(merchantAcceptorId.getNullable("merchant_acceptor_id"))
            ...
            fun merchantName(): Optional<String> = Optional.ofNullable(merchantName.getNullable("merchant_name"))

            /** The state the merchant resides in. */
            fun merchantState(): Optional<String> = Optional.ofNullable(merchantState.getNullable("merchant_state"))
             ...
             * fields.
             */
            fun purchaseDetails(): Optional<PurchaseDetails> = Optional.ofNullable(purchaseDetails.getNullable("purchase_details"))
            ...
            class PurchaseDetails private constructor(
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                fun carRental(): Optional<CarRental> = Optional.ofNullable(carRental.getNullable("car_rental"))

                /** An identifier from the merchant for the customer or consumer. */
                fun customerReferenceIdentifier(): Optional<String> = Optional.ofNullable(customerReferenceIdentifier.getNullable("customer_reference_identifier"))

                /** The state or provincial tax amount in minor units. */
                fun localTaxAmount(): Optional<Long> = Optional.ofNullable(localTaxAmount.getNullable("local_tax_amount"))

                /**
                 * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the local tax
                 * assessed.
                 */
                fun localTaxCurrency(): Optional<String> = Optional.ofNullable(localTaxCurrency.getNullable("local_tax_currency"))

                /** Fields specific to lodging. */
                fun lodging(): Optional<Lodging> = Optional.ofNullable(lodging.getNullable("lodging"))

                /** The national tax amount in minor units. */
                fun nationalTaxAmount(): Optional<Long> = Optional.ofNullable(nationalTaxAmount.getNullable("national_tax_amount"))

                /**
                 * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the local tax
                 * assessed.
                 */
                fun nationalTaxCurrency(): Optional<String> = Optional.ofNullable(nationalTaxCurrency.getNullable("national_tax_currency"))

                /** An identifier from the merchant for the purchase to the issuer and cardholder. */
                fun purchaseIdentifier(): Optional<String> = Optional.ofNullable(purchaseIdentifier.getNullable("purchase_identifier"))

                /** The format of the purchase identifier. */
                fun purchaseIdentifierFormat(): Optional<PurchaseIdentifierFormat> = Optional.ofNullable(purchaseIdentifierFormat.getNullable("purchase_identifier_format"))
                ...
                fun validate(): PurchaseDetails = apply {
                    if (!validated) {
                      ...
                      localTaxAmount()
                      localTaxCurrency()
                      lodging().map { it.validate() }
                      nationalTaxAmount()
                      nationalTaxCurrency()
                      purchaseIdentifier()
                      purchaseIdentifierFormat()
                      travel().map { it.validate() }
                      validated = true
                    }
                }
                ...
                class CarRental private constructor(
                  ...
                  private val additionalProperties: Map<String, JsonValue>,
                    ...
                    fun carClassCode(): Optional<String> = Optional.ofNullable(carClassCode.getNullable("car_class_code"))

                    /**
                     * Date the customer picked up the car or, in the case of a no-show or pre-pay
                     * transaction, the scheduled pick up date.
                     */
                    fun checkoutDate(): Optional<LocalDate> = Optional.ofNullable(checkoutDate.getNullable("checkout_date"))

                    /** Daily rate being charged for the vehicle. */
                    fun dailyRentalRateAmount(): Optional<Long> = Optional.ofNullable(dailyRentalRateAmount.getNullable("daily_rental_rate_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the daily rental
                     * rate.
                     */
                    fun dailyRentalRateCurrency(): Optional<String> = Optional.ofNullable(dailyRentalRateCurrency.getNullable("daily_rental_rate_currency"))

                    /** Number of days the vehicle was rented. */
                    fun daysRented(): Optional<Long> = Optional.ofNullable(daysRented.getNullable("days_rented"))

                    /** Additional charges (gas, late fee, etc.) being billed. */
                    fun extraCharges(): Optional<ExtraCharges> = Optional.ofNullable(extraCharges.getNullable("extra_charges"))

                    /** Fuel charges for the vehicle. */
                    fun fuelChargesAmount(): Optional<Long> = Optional.ofNullable(fuelChargesAmount.getNullable("fuel_charges_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the fuel charges
                     * assessed.
                     */
                    fun fuelChargesCurrency(): Optional<String> = Optional.ofNullable(fuelChargesCurrency.getNullable("fuel_charges_currency"))

                    /** Any insurance being charged for the vehicle. */
                    fun insuranceChargesAmount(): Optional<Long> = Optional.ofNullable(insuranceChargesAmount.getNullable("insurance_charges_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the insurance
                     * charges assessed.
                     */
                    fun insuranceChargesCurrency(): Optional<String> = Optional.ofNullable(insuranceChargesCurrency.getNullable("insurance_charges_currency"))

                    /**
                     * An indicator that the cardholder is being billed for a reserved vehicle that was
                     * not actually rented (that is, a "no-show" charge).
                     */
                    fun noShowIndicator(): Optional<NoShowIndicator> = Optional.ofNullable(noShowIndicator.getNullable("no_show_indicator"))

                    /**
                     * Charges for returning the vehicle at a different location than where it was
                     * picked up.
                     */
                    fun oneWayDropOffChargesAmount(): Optional<Long> = Optional.ofNullable(oneWayDropOffChargesAmount.getNullable("one_way_drop_off_charges_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the one-way
                     * drop-off charges assessed.
                     */
                    fun oneWayDropOffChargesCurrency(): Optional<String> = Optional.ofNullable(oneWayDropOffChargesCurrency.getNullable("one_way_drop_off_charges_currency"))

                    /** Name of the person renting the vehicle. */
                    fun renterName(): Optional<String> = Optional.ofNullable(renterName.getNullable("renter_name"))

                    /** Weekly rate being charged for the vehicle. */
                    fun weeklyRentalRateAmount(): Optional<Long> = Optional.ofNullable(weeklyRentalRateAmount.getNullable("weekly_rental_rate_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the weekly
                     * rental rate.
                     */
                    fun weeklyRentalRateCurrency(): Optional<String> = Optional.ofNullable(weeklyRentalRateCurrency.getNullable("weekly_rental_rate_currency"))
                    ...
                    class ExtraCharges @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                        ...
                        companion object {
                            ...
                            @JvmField val NO_EXTRA_CHARGE = ExtraCharges(JsonField.of("no_extra_charge"))

                            @JvmField val GAS = ExtraCharges(JsonField.of("gas"))

                            @JvmField val EXTRA_MILEAGE = ExtraCharges(JsonField.of("extra_mileage"))

                            @JvmField val LATE_RETURN = ExtraCharges(JsonField.of("late_return"))

                            @JvmField val ONE_WAY_SERVICE_FEE = ExtraCharges(JsonField.of("one_way_service_fee"))

                            @JvmField val PARKING_VIOLATION = ExtraCharges(JsonField.of("parking_violation"))
                    ...
                    class NoShowIndicator @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                        ...
                        companion object {
                            ...
                            @JvmField val NOT_APPLICABLE = NoShowIndicator(JsonField.of("not_applicable"))

                            @JvmField val NO_SHOW_FOR_SPECIALIZED_VEHICLE = NoShowIndicator(JsonField.of("no_show_for_specialized_vehicle"))
                ...
                class Lodging private constructor(
                  ...
                  private val additionalProperties: Map<String, JsonValue>,
                    ...
                    fun checkInDate(): Optional<LocalDate> = Optional.ofNullable(checkInDate.getNullable("check_in_date"))

                    /** Daily rate being charged for the room. */
                    fun dailyRoomRateAmount(): Optional<Long> = Optional.ofNullable(dailyRoomRateAmount.getNullable("daily_room_rate_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the daily room
                     * rate.
                     */
                    fun dailyRoomRateCurrency(): Optional<String> = Optional.ofNullable(dailyRoomRateCurrency.getNullable("daily_room_rate_currency"))

                    /** Additional charges (phone, late check-out, etc.) being billed. */
                    fun extraCharges(): Optional<ExtraCharges> = Optional.ofNullable(extraCharges.getNullable("extra_charges"))

                    /** Folio cash advances for the room. */
                    fun folioCashAdvancesAmount(): Optional<Long> = Optional.ofNullable(folioCashAdvancesAmount.getNullable("folio_cash_advances_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the folio cash
                     * advances.
                     */
                    fun folioCashAdvancesCurrency(): Optional<String> = Optional.ofNullable(folioCashAdvancesCurrency.getNullable("folio_cash_advances_currency"))

                    /** Food and beverage charges for the room. */
                    fun foodBeverageChargesAmount(): Optional<Long> = Optional.ofNullable(foodBeverageChargesAmount.getNullable("food_beverage_charges_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the food and
                     * beverage charges.
                     */
                    fun foodBeverageChargesCurrency(): Optional<String> = Optional.ofNullable(foodBeverageChargesCurrency.getNullable("food_beverage_charges_currency"))
                    ...
                    fun prepaidExpensesAmount(): Optional<Long> = Optional.ofNullable(prepaidExpensesAmount.getNullable("prepaid_expenses_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the prepaid
                     * expenses.
                     */
                    fun prepaidExpensesCurrency(): Optional<String> = Optional.ofNullable(prepaidExpensesCurrency.getNullable("prepaid_expenses_currency"))

                    /** Number of nights the room was rented. */
                    fun roomNights(): Optional<Long> = Optional.ofNullable(roomNights.getNullable("room_nights"))

                    /** Total room tax being charged. */
                    fun totalRoomTaxAmount(): Optional<Long> = Optional.ofNullable(totalRoomTaxAmount.getNullable("total_room_tax_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the total room
                     * tax.
                     */
                    fun totalRoomTaxCurrency(): Optional<String> = Optional.ofNullable(totalRoomTaxCurrency.getNullable("total_room_tax_currency"))

                    /** Total tax being charged for the room. */
                    fun totalTaxAmount(): Optional<Long> = Optional.ofNullable(totalTaxAmount.getNullable("total_tax_amount"))

                    /**
                     * The [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) code for the total tax
                     * assessed.
                     */
                    fun totalTaxCurrency(): Optional<String> = Optional.ofNullable(totalTaxCurrency.getNullable("total_tax_currency"))
                    ...
                    class ExtraCharges @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                        ...
                        companion object {
                            ...
                            @JvmField val RESTAURANT = ExtraCharges(JsonField.of("restaurant"))

                            @JvmField val GIFT_SHOP = ExtraCharges(JsonField.of("gift_shop"))

                            @JvmField val MINI_BAR = ExtraCharges(JsonField.of("mini_bar"))

                            @JvmField val TELEPHONE = ExtraCharges(JsonField.of("telephone"))

                            @JvmField val OTHER = ExtraCharges(JsonField.of("other"))

                            @JvmField val LAUNDRY = ExtraCharges(JsonField.of("laundry"))
                    ...
                    class NoShowIndicator @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                        ...
                        companion object {
                            ...
                            @JvmField val NO_SHOW = NoShowIndicator(JsonField.of("no_show"))
                ...
                class PurchaseIdentifierFormat @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                    ...
                    companion object {
                        ...
                        @JvmField val FREE_TEXT = PurchaseIdentifierFormat(JsonField.of("free_text"))

                        @JvmField val ORDER_NUMBER = PurchaseIdentifierFormat(JsonField.of("order_number"))

                        @JvmField val RENTAL_AGREEMENT_NUMBER = PurchaseIdentifierFormat(JsonField.of("rental_agreement_number"))

                        @JvmField val HOTEL_FOLIO_NUMBER = PurchaseIdentifierFormat(JsonField.of("hotel_folio_number"))

                        @JvmField val INVOICE_NUMBER = PurchaseIdentifierFormat(JsonField.of("invoice_number"))

                        @JvmStatic fun of(value: String) = PurchaseIdentifierFormat(JsonField.of(value))
                    }
                ...
                class Travel private constructor(
                  ...
                  private val additionalProperties: Map<String, JsonValue>,
                    ...
                    fun ancillary(): Optional<Ancillary> = Optional.ofNullable(ancillary.getNullable("ancillary"))

                    /** Indicates the computerized reservation system used to book the ticket. */
                    fun computerizedReservationSystem(): Optional<String> = Optional.ofNullable(computerizedReservationSystem.getNullable("computerized_reservation_system"))

                    /** Indicates the reason for a credit to the cardholder. */
                    fun creditReasonIndicator(): Optional<CreditReasonIndicator> = Optional.ofNullable(creditReasonIndicator.getNullable("credit_reason_indicator"))

                    /** Date of departure. */
                    fun departureDate(): Optional<LocalDate> = Optional.ofNullable(departureDate.getNullable("departure_date"))

                    /** Code for the originating city or airport. */
                    fun originationCityAirportCode(): Optional<String> = Optional.ofNullable(originationCityAirportCode.getNullable("origination_city_airport_code"))

                    /** Name of the passenger. */
                    fun passengerName(): Optional<String> = Optional.ofNullable(passengerName.getNullable("passenger_name"))

                    /** Indicates whether this ticket is non-refundable. */
                    fun restrictedTicketIndicator(): Optional<RestrictedTicketIndicator> = Optional.ofNullable(restrictedTicketIndicator.getNullable("restricted_ticket_indicator"))

                    /** Indicates why a ticket was changed. */
                    fun ticketChangeIndicator(): Optional<TicketChangeIndicator> = Optional.ofNullable(ticketChangeIndicator.getNullable("ticket_change_indicator"))

                    /** Ticket number. */
                    fun ticketNumber(): Optional<String> = Optional.ofNullable(ticketNumber.getNullable("ticket_number"))

                    /** Code for the travel agency if the ticket was issued by a travel agency. */
                    fun travelAgencyCode(): Optional<String> = Optional.ofNullable(travelAgencyCode.getNullable("travel_agency_code"))

                    /** Name of the travel agency if the ticket was issued by a travel agency. */
                    fun travelAgencyName(): Optional<String> = Optional.ofNullable(travelAgencyName.getNullable("travel_agency_name"))

                    /** Fields specific to each leg of the journey. */
                    fun tripLegs(): Optional<List<TripLeg>> = Optional.ofNullable(tripLegs.getNullable("trip_legs"))
                    ...
                    fun validate(): Travel = apply {
                        if (!validated) {
                          ...
                          travelAgencyCode()
                          travelAgencyName()
                          tripLegs().map { it.forEach { it.validate() } }
                          validated = true
                        }
                    }
                    ...
                    class Ancillary private constructor(
                      ...
                      private val additionalProperties: Map<String, JsonValue>,
                         ...
                         */
                        fun connectedTicketDocumentNumber(): Optional<String> = Optional.ofNullable(connectedTicketDocumentNumber.getNullable("connected_ticket_document_number"))

                        /** Indicates the reason for a credit to the cardholder. */
                        fun creditReasonIndicator(): Optional<CreditReasonIndicator> = Optional.ofNullable(creditReasonIndicator.getNullable("credit_reason_indicator"))

                        /** Name of the passenger or description of the ancillary purchase. */
                        fun passengerNameOrDescription(): Optional<String> = Optional.ofNullable(passengerNameOrDescription.getNullable("passenger_name_or_description"))

                        /** Additional travel charges, such as baggage fees. */
                        fun services(): List<Service> = services.getRequired("services")

                        /** Ticket document number. */
                        fun ticketDocumentNumber(): Optional<String> = Optional.ofNullable(ticketDocumentNumber.getNullable("ticket_document_number"))
                        ...
                        class CreditReasonIndicator @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                            ...
                            companion object {
                                ...
                                @JvmField val NO_CREDIT = CreditReasonIndicator(JsonField.of("no_credit"))

                                @JvmField val PASSENGER_TRANSPORT_ANCILLARY_PURCHASE_CANCELLATION = CreditReasonIndicator(JsonField.of("passenger_transport_ancillary_purchase_cancellation"))

                                @JvmField val AIRLINE_TICKET_AND_PASSENGER_TRANSPORT_ANCILLARY_PURCHASE_CANCELLATION = CreditReasonIndicator(JsonField.of("airline_ticket_and_passenger_transport_ancillary_purchase_cancellation"))

                                @JvmField val OTHER = CreditReasonIndicator(JsonField.of("other"))

                                @JvmStatic fun of(value: String) = CreditReasonIndicator(JsonField.of(value))
                            }
                        ...
                        class Service private constructor(private val category: JsonField<Category>, private val subCategory: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
                            ...
                            fun subCategory(): Optional<String> = Optional.ofNullable(subCategory.getNullable("sub_category"))
                            ...
                            class Category @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                                ...
                                companion object {
                                    ...
                                    @JvmField val NONE = Category(JsonField.of("none"))

                                    @JvmField val BUNDLED_SERVICE = Category(JsonField.of("bundled_service"))

                                    @JvmField val BAGGAGE_FEE = Category(JsonField.of("baggage_fee"))

                                    @JvmField val CHANGE_FEE = Category(JsonField.of("change_fee"))

                                    @JvmField val CARGO = Category(JsonField.of("cargo"))

                                    @JvmField val CARBON_OFFSET = Category(JsonField.of("carbon_offset"))

                                    @JvmField val FREQUENT_FLYER = Category(JsonField.of("frequent_flyer"))

                                    @JvmField val GIFT_CARD = Category(JsonField.of("gift_card"))

                                    @JvmField val GROUND_TRANSPORT = Category(JsonField.of("ground_transport"))

                                    @JvmField val IN_FLIGHT_ENTERTAINMENT = Category(JsonField.of("in_flight_entertainment"))

                                    @JvmField val LOUNGE = Category(JsonField.of("lounge"))

                                    @JvmField val MEDICAL = Category(JsonField.of("medical"))

                                    @JvmField val MEAL_BEVERAGE = Category(JsonField.of("meal_beverage"))

                                    @JvmField val OTHER = Category(JsonField.of("other"))

                                    @JvmField val PASSENGER_ASSIST_FEE = Category(JsonField.of("passenger_assist_fee"))

                                    @JvmField val PETS = Category(JsonField.of("pets"))

                                    @JvmField val SEAT_FEES = Category(JsonField.of("seat_fees"))

                                    @JvmField val STANDBY = Category(JsonField.of("standby"))

                                    @JvmField val SERVICE_FEE = Category(JsonField.of("service_fee"))

                                    @JvmField val STORE = Category(JsonField.of("store"))

                                    @JvmField val TRAVEL_SERVICE = Category(JsonField.of("travel_service"))

                                    @JvmField val UNACCOMPANIED_TRAVEL = Category(JsonField.of("unaccompanied_travel"))

                                    @JvmField val UPGRADES = Category(JsonField.of("upgrades"))

                                    @JvmField val WIFI = Category(JsonField.of("wifi"))
                    ...
                    class CreditReasonIndicator @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                        ...
                        companion object {
                            ...
                            @JvmField val AIRLINE_TICKET_CANCELLATION = CreditReasonIndicator(JsonField.of("airline_ticket_cancellation"))

                            @JvmField val OTHER = CreditReasonIndicator(JsonField.of("other"))

                            @JvmField val PARTIAL_REFUND_OF_AIRLINE_TICKET = CreditReasonIndicator(JsonField.of("partial_refund_of_airline_ticket"))
                    ...
                    class RestrictedTicketIndicator @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                        ...
                        companion object {
                            ...
                            @JvmField val NO_RESTRICTIONS = RestrictedTicketIndicator(JsonField.of("no_restrictions"))

                            @JvmField val RESTRICTED_NON_REFUNDABLE_TICKET = RestrictedTicketIndicator(JsonField.of("restricted_non_refundable_ticket"))

                            @JvmStatic fun of(value: String) = RestrictedTicketIndicator(JsonField.of(value))
                        }
                    ...
                    class TicketChangeIndicator @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                        ...
                        companion object {
                            ...
                            @JvmField val NONE = TicketChangeIndicator(JsonField.of("none"))

                            @JvmField val CHANGE_TO_EXISTING_TICKET = TicketChangeIndicator(JsonField.of("change_to_existing_ticket"))

                            @JvmField val NEW_TICKET = TicketChangeIndicator(JsonField.of("new_ticket"))

                            @JvmStatic fun of(value: String) = TicketChangeIndicator(JsonField.of(value))
                        }
                    ...
                    class TripLeg private constructor(
                      ...
                      private val additionalProperties: Map<String, JsonValue>,
                        ...
                        fun carrierCode(): Optional<String> = Optional.ofNullable(carrierCode.getNullable("carrier_code"))

                        /** Code for the destination city or airport. */
                        fun destinationCityAirportCode(): Optional<String> = Optional.ofNullable(destinationCityAirportCode.getNullable("destination_city_airport_code"))

                        /** Fare basis code. */
                        fun fareBasisCode(): Optional<String> = Optional.ofNullable(fareBasisCode.getNullable("fare_basis_code"))

                        /** Flight number. */
                        fun flightNumber(): Optional<String> = Optional.ofNullable(flightNumber.getNullable("flight_number"))

                        /** Service class (e.g., first class, business class, etc.). */
                        fun serviceClass(): Optional<String> = Optional.ofNullable(serviceClass.getNullable("service_class"))

                        /** Indicates whether a stopover is allowed on this ticket. */
                        fun stopOverCode(): Optional<StopOverCode> = Optional.ofNullable(stopOverCode.getNullable("stop_over_code"))
                        ...
                        class StopOverCode @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                            ...
                            companion object {
                                ...
                                @JvmField val NONE = StopOverCode(JsonField.of("none"))

                                @JvmField val STOP_OVER_ALLOWED = StopOverCode(JsonField.of("stop_over_allowed"))

                                @JvmField val STOP_OVER_NOT_ALLOWED = StopOverCode(JsonField.of("stop_over_not_allowed"))
            ...
            class Type @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val CARD_REFUND = Type(JsonField.of("card_refund"))
        ...
        class CardRevenuePayment private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun transactedOnAccountId(): Optional<String> = Optional.ofNullable(transactedOnAccountId.getNullable("transacted_on_account_id"))
        ...
        class CardSettlement private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
             ...
             * exists.
             */
            fun cardAuthorization(): Optional<String> = Optional.ofNullable(cardAuthorization.getNullable("card_authorization"))
            ...
            class Type @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val CARD_SETTLEMENT = Type(JsonField.of("card_settlement"))
        ...
        class CashbackPayment private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun accruedOnCardId(): Optional<String> = Optional.ofNullable(accruedOnCardId.getNullable("accrued_on_card_id"))
        ...
        class Category @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
            ...
            companion object {
                ...
                @JvmField val ACCOUNT_TRANSFER_INTENTION = Category(JsonField.of("account_transfer_intention"))

                @JvmField val ACH_TRANSFER_INTENTION = Category(JsonField.of("ach_transfer_intention"))

                @JvmField val ACH_TRANSFER_REJECTION = Category(JsonField.of("ach_transfer_rejection"))

                @JvmField val ACH_TRANSFER_RETURN = Category(JsonField.of("ach_transfer_return"))

                @JvmField val CASHBACK_PAYMENT = Category(JsonField.of("cashback_payment"))

                @JvmField val CARD_DISPUTE_ACCEPTANCE = Category(JsonField.of("card_dispute_acceptance"))

                @JvmField val CARD_DISPUTE_LOSS = Category(JsonField.of("card_dispute_loss"))
                ...
                @JvmField val CHECK_DEPOSIT_ACCEPTANCE = Category(JsonField.of("check_deposit_acceptance"))

                @JvmField val CHECK_DEPOSIT_RETURN = Category(JsonField.of("check_deposit_return"))

                @JvmField val CHECK_TRANSFER_DEPOSIT = Category(JsonField.of("check_transfer_deposit"))

                @JvmField val CHECK_TRANSFER_STOP_PAYMENT_REQUEST = Category(JsonField.of("check_transfer_stop_payment_request"))

                @JvmField val FEE_PAYMENT = Category(JsonField.of("fee_payment"))

                @JvmField val INBOUND_ACH_TRANSFER = Category(JsonField.of("inbound_ach_transfer"))

                @JvmField val INBOUND_ACH_TRANSFER_RETURN_INTENTION = Category(JsonField.of("inbound_ach_transfer_return_intention"))

                @JvmField val INBOUND_CHECK_DEPOSIT_RETURN_INTENTION = Category(JsonField.of("inbound_check_deposit_return_intention"))

                @JvmField val INBOUND_INTERNATIONAL_ACH_TRANSFER = Category(JsonField.of("inbound_international_ach_transfer"))

                @JvmField val INBOUND_REAL_TIME_PAYMENTS_TRANSFER_CONFIRMATION = Category(JsonField.of("inbound_real_time_payments_transfer_confirmation"))

                @JvmField val INBOUND_WIRE_DRAWDOWN_PAYMENT = Category(JsonField.of("inbound_wire_drawdown_payment"))

                @JvmField val INBOUND_WIRE_REVERSAL = Category(JsonField.of("inbound_wire_reversal"))

                @JvmField val INBOUND_WIRE_TRANSFER = Category(JsonField.of("inbound_wire_transfer"))

                @JvmField val INBOUND_WIRE_TRANSFER_REVERSAL = Category(JsonField.of("inbound_wire_transfer_reversal"))

                @JvmField val INTEREST_PAYMENT = Category(JsonField.of("interest_payment"))

                @JvmField val INTERNAL_SOURCE = Category(JsonField.of("internal_source"))

                @JvmField val REAL_TIME_PAYMENTS_TRANSFER_ACKNOWLEDGEMENT = Category(JsonField.of("real_time_payments_transfer_acknowledgement"))

                @JvmField val SAMPLE_FUNDS = Category(JsonField.of("sample_funds"))

                @JvmField val WIRE_TRANSFER_INTENTION = Category(JsonField.of("wire_transfer_intention"))

                @JvmField val WIRE_TRANSFER_REJECTION = Category(JsonField.of("wire_transfer_rejection"))
        ...
        class CheckDepositAcceptance private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
             ...
             */
            fun auxiliaryOnUs(): Optional<String> = Optional.ofNullable(auxiliaryOnUs.getNullable("auxiliary_on_us"))
             ...
             */
            fun serialNumber(): Optional<String> = Optional.ofNullable(serialNumber.getNullable("serial_number"))
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            class ReturnReason @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val ACH_CONVERSION_NOT_SUPPORTED = ReturnReason(JsonField.of("ach_conversion_not_supported"))

                    @JvmField val CLOSED_ACCOUNT = ReturnReason(JsonField.of("closed_account"))

                    @JvmField val DUPLICATE_SUBMISSION = ReturnReason(JsonField.of("duplicate_submission"))
                    ...
                    @JvmField val ENDORSEMENT_IRREGULAR = ReturnReason(JsonField.of("endorsement_irregular"))

                    @JvmField val ALTERED_OR_FICTITIOUS_ITEM = ReturnReason(JsonField.of("altered_or_fictitious_item"))

                    @JvmField val FROZEN_OR_BLOCKED_ACCOUNT = ReturnReason(JsonField.of("frozen_or_blocked_account"))

                    @JvmField val POST_DATED = ReturnReason(JsonField.of("post_dated"))

                    @JvmField val ENDORSEMENT_MISSING = ReturnReason(JsonField.of("endorsement_missing"))

                    @JvmField val SIGNATURE_MISSING = ReturnReason(JsonField.of("signature_missing"))

                    @JvmField val STOP_PAYMENT_SUSPECT = ReturnReason(JsonField.of("stop_payment_suspect"))

                    @JvmField val UNUSABLE_IMAGE = ReturnReason(JsonField.of("unusable_image"))

                    @JvmField val IMAGE_FAILS_SECURITY_CHECK = ReturnReason(JsonField.of("image_fails_security_check"))

                    @JvmField val CANNOT_DETERMINE_AMOUNT = ReturnReason(JsonField.of("cannot_determine_amount"))

                    @JvmField val SIGNATURE_IRREGULAR = ReturnReason(JsonField.of("signature_irregular"))
                    ...
                    @JvmField val ITEM_EXCEEDS_DOLLAR_LIMIT = ReturnReason(JsonField.of("item_exceeds_dollar_limit"))

                    @JvmField val BRANCH_OR_ACCOUNT_SOLD = ReturnReason(JsonField.of("branch_or_account_sold"))
        ...
        class CheckTransferDeposit private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
             ...
             */
            fun bankOfFirstDepositRoutingNumber(): Optional<String> = Optional.ofNullable(bankOfFirstDepositRoutingNumber.getNullable("bank_of_first_deposit_routing_number"))
             ...
             * transaction.
             */
            fun inboundCheckDepositId(): Optional<String> = Optional.ofNullable(inboundCheckDepositId.getNullable("inbound_check_deposit_id"))

            /** The identifier of the Transaction object created when the check was deposited. */
            fun transactionId(): Optional<String> = Optional.ofNullable(transactionId.getNullable("transaction_id"))

            /** The identifier of the Check Transfer object that was deposited. */
            fun transferId(): Optional<String> = Optional.ofNullable(transferId.getNullable("transfer_id"))
        ...
        @NoAutoDetect
        class CheckTransferStopPaymentRequest private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            override fun toString() = "CheckTransferStopPaymentRequest{reason=$reason, requestedAt=$requestedAt, transferId=$transferId, type=$type, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                @JvmSynthetic
                internal fun from(checkTransferStopPaymentRequest: CheckTransferStopPaymentRequest) = apply {
                ...
                fun build(): CheckTransferStopPaymentRequest = CheckTransferStopPaymentRequest(
                    reason,
                    requestedAt,
                    transferId,
                    type,
        ...
        class InboundAchTransfer private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun originatorCompanyDescriptiveDate(): Optional<String> = Optional.ofNullable(originatorCompanyDescriptiveDate.getNullable("originator_company_descriptive_date"))

            /** Data set by the originator. */
            fun originatorCompanyDiscretionaryData(): Optional<String> = Optional.ofNullable(originatorCompanyDiscretionaryData.getNullable("originator_company_discretionary_data"))
            ...
            fun receiverIdNumber(): Optional<String> = Optional.ofNullable(receiverIdNumber.getNullable("receiver_id_number"))

            /**
             * The name of the transfer recipient. This value is informational and not verified
             * by Increase.
             */
            fun receiverName(): Optional<String> = Optional.ofNullable(receiverName.getNullable("receiver_name"))
        ...
        class InboundInternationalAchTransfer private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
             ...
             */
            fun foreignExchangeReference(): Optional<String> = Optional.ofNullable(foreignExchangeReference.getNullable("foreign_exchange_reference"))
            ...
            fun foreignTraceNumber(): Optional<String> = Optional.ofNullable(foreignTraceNumber.getNullable("foreign_trace_number"))
            ...
            /** A portion of the originator address. This may be incomplete. */
            fun originatorPostalCode(): Optional<String> = Optional.ofNullable(originatorPostalCode.getNullable("originator_postal_code"))

            /** A portion of the originator address. This may be incomplete. */
            fun originatorStateOrProvince(): Optional<String> = Optional.ofNullable(originatorStateOrProvince.getNullable("originator_state_or_province"))

            /** A portion of the originator address. This may be incomplete. */
            fun originatorStreetAddress(): String = originatorStreetAddress.getRequired("originator_street_address")

            /** A description field set by the originator. */
            fun paymentRelatedInformation(): Optional<String> = Optional.ofNullable(paymentRelatedInformation.getNullable("payment_related_information"))

            /** A description field set by the originator. */
            fun paymentRelatedInformation2(): Optional<String> = Optional.ofNullable(paymentRelatedInformation2.getNullable("payment_related_information2"))
            ...
            fun receiverIdentificationNumber(): Optional<String> = Optional.ofNullable(receiverIdentificationNumber.getNullable("receiver_identification_number"))

            /** A portion of the receiver address. This may be incomplete. */
            fun receiverPostalCode(): Optional<String> = Optional.ofNullable(receiverPostalCode.getNullable("receiver_postal_code"))

            /** A portion of the receiver address. This may be incomplete. */
            fun receiverStateOrProvince(): Optional<String> = Optional.ofNullable(receiverStateOrProvince.getNullable("receiver_state_or_province"))
            ...
            class ForeignExchangeIndicator @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val FIXED_TO_VARIABLE = ForeignExchangeIndicator(JsonField.of("fixed_to_variable"))

                    @JvmField val VARIABLE_TO_FIXED = ForeignExchangeIndicator(JsonField.of("variable_to_fixed"))

                    @JvmField val FIXED_TO_FIXED = ForeignExchangeIndicator(JsonField.of("fixed_to_fixed"))
            ...
            class ForeignExchangeReferenceIndicator @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val FOREIGN_EXCHANGE_RATE = ForeignExchangeReferenceIndicator(JsonField.of("foreign_exchange_rate"))

                    @JvmField val FOREIGN_EXCHANGE_REFERENCE_NUMBER = ForeignExchangeReferenceIndicator(JsonField.of("foreign_exchange_reference_number"))

                    @JvmField val BLANK = ForeignExchangeReferenceIndicator(JsonField.of("blank"))

                    @JvmStatic fun of(value: String) = ForeignExchangeReferenceIndicator(JsonField.of(value))
                }
            ...
            class InternationalTransactionTypeCode @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val BUSINESS_OR_COMMERCIAL = InternationalTransactionTypeCode(JsonField.of("business_or_commercial"))
                    ...
                    @JvmField val MISCELLANEOUS = InternationalTransactionTypeCode(JsonField.of("miscellaneous"))
                    ...
                    @JvmField val REMITTANCE = InternationalTransactionTypeCode(JsonField.of("remittance"))

                    @JvmField val RENT_OR_LEASE = InternationalTransactionTypeCode(JsonField.of("rent_or_lease"))

                    @JvmField val SALARY_OR_PAYROLL = InternationalTransactionTypeCode(JsonField.of("salary_or_payroll"))

                    @JvmField val TAX = InternationalTransactionTypeCode(JsonField.of("tax"))

                    @JvmField val ACCOUNTS_RECEIVABLE = InternationalTransactionTypeCode(JsonField.of("accounts_receivable"))

                    @JvmField val BACK_OFFICE_CONVERSION = InternationalTransactionTypeCode(JsonField.of("back_office_conversion"))

                    @JvmField val MACHINE_TRANSFER = InternationalTransactionTypeCode(JsonField.of("machine_transfer"))

                    @JvmField val POINT_OF_PURCHASE = InternationalTransactionTypeCode(JsonField.of("point_of_purchase"))

                    @JvmField val POINT_OF_SALE = InternationalTransactionTypeCode(JsonField.of("point_of_sale"))

                    @JvmField val REPRESENTED_CHECK = InternationalTransactionTypeCode(JsonField.of("represented_check"))

                    @JvmField val SHARED_NETWORK_TRANSACTION = InternationalTransactionTypeCode(JsonField.of("shared_network_transaction"))

                    @JvmField val TELPHONE_INITIATED = InternationalTransactionTypeCode(JsonField.of("telphone_initiated"))

                    @JvmField val INTERNET_INITIATED = InternationalTransactionTypeCode(JsonField.of("internet_initiated"))

                    @JvmStatic fun of(value: String) = InternationalTransactionTypeCode(JsonField.of(value))
                }
            ...
            class OriginatingDepositoryFinancialInstitutionIdQualifier @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val NATIONAL_CLEARING_SYSTEM_NUMBER = OriginatingDepositoryFinancialInstitutionIdQualifier(JsonField.of("national_clearing_system_number"))

                    @JvmField val BIC_CODE = OriginatingDepositoryFinancialInstitutionIdQualifier(JsonField.of("bic_code"))

                    @JvmField val IBAN = OriginatingDepositoryFinancialInstitutionIdQualifier(JsonField.of("iban"))

                    @JvmStatic fun of(value: String) = OriginatingDepositoryFinancialInstitutionIdQualifier(JsonField.of(value))
                }
            ...
            class ReceivingDepositoryFinancialInstitutionIdQualifier @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val NATIONAL_CLEARING_SYSTEM_NUMBER = ReceivingDepositoryFinancialInstitutionIdQualifier(JsonField.of("national_clearing_system_number"))

                    @JvmField val BIC_CODE = ReceivingDepositoryFinancialInstitutionIdQualifier(JsonField.of("bic_code"))

                    @JvmField val IBAN = ReceivingDepositoryFinancialInstitutionIdQualifier(JsonField.of("iban"))

                    @JvmStatic fun of(value: String) = ReceivingDepositoryFinancialInstitutionIdQualifier(JsonField.of(value))
                }
            ...
            class Type @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val INBOUND_INTERNATIONAL_ACH_TRANSFER = Type(JsonField.of("inbound_international_ach_transfer"))
        ...
        @NoAutoDetect
        class InboundWireDrawdownPayment private constructor(
          private val amount: JsonField<Long>,
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun beneficiaryReference(): Optional<String> = Optional.ofNullable(beneficiaryReference.getNullable("beneficiary_reference"))
             ...
             */
            fun inputMessageAccountabilityData(): Optional<String> = Optional.ofNullable(inputMessageAccountabilityData.getNullable("input_message_accountability_data"))
             ...
             * the transfer.
             */
            fun originatorRoutingNumber(): Optional<String> = Optional.ofNullable(originatorRoutingNumber.getNullable("originator_routing_number"))

            /** An Increase-created concatenation of the Originator-to-Beneficiary lines. */
            fun originatorToBeneficiaryInformation(): Optional<String> = Optional.ofNullable(originatorToBeneficiaryInformation.getNullable("originator_to_beneficiary_information"))
            ...
            override fun toString() = "InboundWireDrawdownPayment{amount=$amount, beneficiaryAddressLine1=$beneficiaryAddressLine1, beneficiaryAddressLine2=$beneficiaryAddressLine2, beneficiaryAddressLine3=$beneficiaryAddressLine3, beneficiaryName=$beneficiaryName, beneficiaryReference=$beneficiaryReference, description=$description, inputMessageAccountabilityData=$inputMessageAccountabilityData, originatorAddressLine1=$originatorAddressLine1, originatorAddressLine2=$originatorAddressLine2, originatorAddressLine3=$originatorAddressLine3, originatorName=$originatorName, originatorRoutingNumber=$originatorRoutingNumber, originatorToBeneficiaryInformation=$originatorToBeneficiaryInformation, originatorToBeneficiaryInformationLine1=$originatorToBeneficiaryInformationLine1, originatorToBeneficiaryInformationLine2=$originatorToBeneficiaryInformationLine2, originatorToBeneficiaryInformationLine3=$originatorToBeneficiaryInformationLine3, originatorToBeneficiaryInformationLine4=$originatorToBeneficiaryInformationLine4, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                internal fun from(inboundWireDrawdownPayment: InboundWireDrawdownPayment) = apply {
                    ...
                    this.beneficiaryAddressLine1 = inboundWireDrawdownPayment.beneficiaryAddressLine1
                    this.beneficiaryAddressLine2 = inboundWireDrawdownPayment.beneficiaryAddressLine2
                    this.beneficiaryAddressLine3 = inboundWireDrawdownPayment.beneficiaryAddressLine3
                    ...
                    this.inputMessageAccountabilityData = inboundWireDrawdownPayment.inputMessageAccountabilityData
                    ...
                    this.originatorRoutingNumber = inboundWireDrawdownPayment.originatorRoutingNumber
                    this.originatorToBeneficiaryInformation = inboundWireDrawdownPayment.originatorToBeneficiaryInformation
                    this.originatorToBeneficiaryInformationLine1 = inboundWireDrawdownPayment.originatorToBeneficiaryInformationLine1
                    this.originatorToBeneficiaryInformationLine2 = inboundWireDrawdownPayment.originatorToBeneficiaryInformationLine2
                    this.originatorToBeneficiaryInformationLine3 = inboundWireDrawdownPayment.originatorToBeneficiaryInformationLine3
                    this.originatorToBeneficiaryInformationLine4 = inboundWireDrawdownPayment.originatorToBeneficiaryInformationLine4
                ...
                fun build(): InboundWireDrawdownPayment = InboundWireDrawdownPayment(
                    amount,
                    beneficiaryAddressLine1,
                    beneficiaryAddressLine2,
                    beneficiaryAddressLine3,
        ...
        class InboundWireReversal private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun financialInstitutionToFinancialInstitutionInformation(): Optional<String> = Optional.ofNullable(financialInstitutionToFinancialInstitutionInformation.getNullable("financial_institution_to_financial_institution_information"))
             ...
             * institution.
             */
            fun receiverFinancialInstitutionInformation(): Optional<String> = Optional.ofNullable(receiverFinancialInstitutionInformation.getNullable("receiver_financial_institution_information"))
        ...
        class InterestPayment private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun accruedOnAccountId(): Optional<String> = Optional.ofNullable(accruedOnAccountId.getNullable("accrued_on_account_id"))
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            class Reason @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val ACCOUNT_CLOSURE = Reason(JsonField.of("account_closure"))
                    ...
                    @JvmField val COLLECTION_PAYMENT = Reason(JsonField.of("collection_payment"))

                    @JvmField val COLLECTION_RECEIVABLE = Reason(JsonField.of("collection_receivable"))

                    @JvmField val EMPYREAL_ADJUSTMENT = Reason(JsonField.of("empyreal_adjustment"))

                    @JvmField val ERROR = Reason(JsonField.of("error"))

                    @JvmField val ERROR_CORRECTION = Reason(JsonField.of("error_correction"))

                    @JvmField val FEES = Reason(JsonField.of("fees"))

                    @JvmField val INTEREST = Reason(JsonField.of("interest"))

                    @JvmField val NEGATIVE_BALANCE_FORGIVENESS = Reason(JsonField.of("negative_balance_forgiveness"))

                    @JvmField val SAMPLE_FUNDS = Reason(JsonField.of("sample_funds"))

                    @JvmField val SAMPLE_FUNDS_RETURN = Reason(JsonField.of("sample_funds_return"))
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val TRANSACTION = Type(JsonField.of("transaction"))
