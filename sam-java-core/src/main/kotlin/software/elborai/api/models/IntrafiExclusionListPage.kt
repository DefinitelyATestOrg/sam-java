...
class IntrafiExclusionListPage private constructor(private val exclusionsService: ExclusionService, private val params: IntrafiExclusionListParams, private val response: Response, ) {
    ...
    override fun toString() = "IntrafiExclusionListPage{exclusionsService=$exclusionsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<IntrafiExclusionListParams> {
      ...
      return Optional.of(IntrafiExclusionListParams.builder().from(params).apply {nextCursor().ifPresent{ this.cursor(it) } }.build())
    }

    fun getNextPage(): Optional<IntrafiExclusionListPage> {
      return getNextPageParams().map { exclusionsService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(exclusionsService: ExclusionService, params: IntrafiExclusionListParams, response: Response) = IntrafiExclusionListPage(
            exclusionsService,
            params,
            response,
        )
    ...
    class AutoPager constructor(private val firstPage: IntrafiExclusionListPage, ) : Iterable<IntrafiExclusion> {
