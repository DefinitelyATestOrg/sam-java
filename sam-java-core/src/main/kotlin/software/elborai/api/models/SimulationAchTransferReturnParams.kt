  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    class Reason @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val INSUFFICIENT_FUND = Reason(JsonField.of("insufficient_fund"))

            @JvmField val NO_ACCOUNT = Reason(JsonField.of("no_account"))

            @JvmField val ACCOUNT_CLOSED = Reason(JsonField.of("account_closed"))

            @JvmField val INVALID_ACCOUNT_NUMBER_STRUCTURE = Reason(JsonField.of("invalid_account_number_structure"))

            @JvmField val ACCOUNT_FROZEN_ENTRY_RETURNED_PER_OFAC_INSTRUCTION = Reason(JsonField.of("account_frozen_entry_returned_per_ofac_instruction"))

            @JvmField val CREDIT_ENTRY_REFUSED_BY_RECEIVER = Reason(JsonField.of("credit_entry_refused_by_receiver"))

            @JvmField val UNAUTHORIZED_DEBIT_TO_CONSUMER_ACCOUNT_USING_CORPORATE_SEC_CODE = Reason(JsonField.of("unauthorized_debit_to_consumer_account_using_corporate_sec_code"))
            ...
            @JvmField val NON_TRANSACTION_ACCOUNT = Reason(JsonField.of("non_transaction_account"))

            @JvmField val UNCOLLECTED_FUNDS = Reason(JsonField.of("uncollected_funds"))

            @JvmField val ROUTING_NUMBER_CHECK_DIGIT_ERROR = Reason(JsonField.of("routing_number_check_digit_error"))
            ...
            @JvmField val AMOUNT_FIELD_ERROR = Reason(JsonField.of("amount_field_error"))

            @JvmField val AUTHORIZATION_REVOKED_BY_CUSTOMER = Reason(JsonField.of("authorization_revoked_by_customer"))

            @JvmField val INVALID_ACH_ROUTING_NUMBER = Reason(JsonField.of("invalid_ach_routing_number"))

            @JvmField val FILE_RECORD_EDIT_CRITERIA = Reason(JsonField.of("file_record_edit_criteria"))

            @JvmField val ENR_INVALID_INDIVIDUAL_NAME = Reason(JsonField.of("enr_invalid_individual_name"))

            @JvmField val RETURNED_PER_ODFI_REQUEST = Reason(JsonField.of("returned_per_odfi_request"))

            @JvmField val LIMITED_PARTICIPATION_DFI = Reason(JsonField.of("limited_participation_dfi"))

            @JvmField val INCORRECTLY_CODED_OUTBOUND_INTERNATIONAL_PAYMENT = Reason(JsonField.of("incorrectly_coded_outbound_international_payment"))

            @JvmField val ACCOUNT_SOLD_TO_ANOTHER_DFI = Reason(JsonField.of("account_sold_to_another_dfi"))

            @JvmField val ADDENDA_ERROR = Reason(JsonField.of("addenda_error"))

            @JvmField val BENEFICIARY_OR_ACCOUNT_HOLDER_DECEASED = Reason(JsonField.of("beneficiary_or_account_holder_deceased"))

            @JvmField val CUSTOMER_ADVISED_NOT_WITHIN_AUTHORIZATION_TERMS = Reason(JsonField.of("customer_advised_not_within_authorization_terms"))
            ...
            @JvmField val ENR_DUPLICATE_ENROLLMENT = Reason(JsonField.of("enr_duplicate_enrollment"))

            @JvmField val ENR_INVALID_DFI_ACCOUNT_NUMBER = Reason(JsonField.of("enr_invalid_dfi_account_number"))

            @JvmField val ENR_INVALID_INDIVIDUAL_ID_NUMBER = Reason(JsonField.of("enr_invalid_individual_id_number"))

            @JvmField val ENR_INVALID_REPRESENTATIVE_PAYEE_INDICATOR = Reason(JsonField.of("enr_invalid_representative_payee_indicator"))

            @JvmField val ENR_INVALID_TRANSACTION_CODE = Reason(JsonField.of("enr_invalid_transaction_code"))

            @JvmField val ENR_RETURN_OF_ENR_ENTRY = Reason(JsonField.of("enr_return_of_enr_entry"))

            @JvmField val ENR_ROUTING_NUMBER_CHECK_DIGIT_ERROR = Reason(JsonField.of("enr_routing_number_check_digit_error"))

            @JvmField val ENTRY_NOT_PROCESSED_BY_GATEWAY = Reason(JsonField.of("entry_not_processed_by_gateway"))

            @JvmField val FIELD_ERROR = Reason(JsonField.of("field_error"))

            @JvmField val FOREIGN_RECEIVING_DFI_UNABLE_TO_SETTLE = Reason(JsonField.of("foreign_receiving_dfi_unable_to_settle"))

            @JvmField val IAT_ENTRY_CODING_ERROR = Reason(JsonField.of("iat_entry_coding_error"))

            @JvmField val IMPROPER_EFFECTIVE_ENTRY_DATE = Reason(JsonField.of("improper_effective_entry_date"))

            @JvmField val IMPROPER_SOURCE_DOCUMENT_SOURCE_DOCUMENT_PRESENTED = Reason(JsonField.of("improper_source_document_source_document_presented"))

            @JvmField val INVALID_COMPANY_ID = Reason(JsonField.of("invalid_company_id"))

            @JvmField val INVALID_FOREIGN_RECEIVING_DFI_IDENTIFICATION = Reason(JsonField.of("invalid_foreign_receiving_dfi_identification"))

            @JvmField val INVALID_INDIVIDUAL_ID_NUMBER = Reason(JsonField.of("invalid_individual_id_number"))

            @JvmField val ITEM_AND_RCK_ENTRY_PRESENTED_FOR_PAYMENT = Reason(JsonField.of("item_and_rck_entry_presented_for_payment"))

            @JvmField val ITEM_RELATED_TO_RCK_ENTRY_IS_INELIGIBLE = Reason(JsonField.of("item_related_to_rck_entry_is_ineligible"))

            @JvmField val MANDATORY_FIELD_ERROR = Reason(JsonField.of("mandatory_field_error"))

            @JvmField val MISROUTED_DISHONORED_RETURN = Reason(JsonField.of("misrouted_dishonored_return"))

            @JvmField val MISROUTED_RETURN = Reason(JsonField.of("misrouted_return"))

            @JvmField val NO_ERRORS_FOUND = Reason(JsonField.of("no_errors_found"))

            @JvmField val NON_ACCEPTANCE_OF_R62_DISHONORED_RETURN = Reason(JsonField.of("non_acceptance_of_r62_dishonored_return"))

            @JvmField val NON_PARTICIPANT_IN_IAT_PROGRAM = Reason(JsonField.of("non_participant_in_iat_program"))

            @JvmField val PERMISSIBLE_RETURN_ENTRY = Reason(JsonField.of("permissible_return_entry"))

            @JvmField val PERMISSIBLE_RETURN_ENTRY_NOT_ACCEPTED = Reason(JsonField.of("permissible_return_entry_not_accepted"))

            @JvmField val RDFI_NON_SETTLEMENT = Reason(JsonField.of("rdfi_non_settlement"))

            @JvmField val RDFI_PARTICIPANT_IN_CHECK_TRUNCATION_PROGRAM = Reason(JsonField.of("rdfi_participant_in_check_truncation_program"))
            ...
            @JvmField val RETURN_NOT_A_DUPLICATE = Reason(JsonField.of("return_not_a_duplicate"))

            @JvmField val RETURN_OF_ERRONEOUS_OR_REVERSING_DEBIT = Reason(JsonField.of("return_of_erroneous_or_reversing_debit"))

            @JvmField val RETURN_OF_IMPROPER_CREDIT_ENTRY = Reason(JsonField.of("return_of_improper_credit_entry"))

            @JvmField val RETURN_OF_IMPROPER_DEBIT_ENTRY = Reason(JsonField.of("return_of_improper_debit_entry"))

            @JvmField val RETURN_OF_XCK_ENTRY = Reason(JsonField.of("return_of_xck_entry"))

            @JvmField val SOURCE_DOCUMENT_PRESENTED_FOR_PAYMENT = Reason(JsonField.of("source_document_presented_for_payment"))

            @JvmField val STATE_LAW_AFFECTING_RCK_ACCEPTANCE = Reason(JsonField.of("state_law_affecting_rck_acceptance"))

            @JvmField val STOP_PAYMENT_ON_ITEM_RELATED_TO_RCK_ENTRY = Reason(JsonField.of("stop_payment_on_item_related_to_rck_entry"))

            @JvmField val STOP_PAYMENT_ON_SOURCE_DOCUMENT = Reason(JsonField.of("stop_payment_on_source_document"))

            @JvmField val TIMELY_ORIGINAL_RETURN = Reason(JsonField.of("timely_original_return"))

            @JvmField val TRACE_NUMBER_ERROR = Reason(JsonField.of("trace_number_error"))

            @JvmField val UNTIMELY_DISHONORED_RETURN = Reason(JsonField.of("untimely_dishonored_return"))

            @JvmField val UNTIMELY_RETURN = Reason(JsonField.of("untimely_return"))
