...
@NoAutoDetect
class InboundFundsHoldReleaseResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(inboundFundsHoldReleaseResponse: InboundFundsHoldReleaseResponse) = apply {
            this.amount = inboundFundsHoldReleaseResponse.amount
            this.automaticallyReleasesAt = inboundFundsHoldReleaseResponse.automaticallyReleasesAt
        ...
        fun build(): InboundFundsHoldReleaseResponse = InboundFundsHoldReleaseResponse(
            amount,
            automaticallyReleasesAt,
            createdAt,
            currency,
