...
class File private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
     ...
     */
    fun downloadUrl(): Optional<String> = Optional.ofNullable(downloadUrl.getNullable("download_url"))
    ...
    class Purpose @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val PROCESSED_CHECK_IMAGE_FRONT = Purpose(JsonField.of("processed_check_image_front"))

            @JvmField val PROCESSED_CHECK_IMAGE_BACK = Purpose(JsonField.of("processed_check_image_back"))
