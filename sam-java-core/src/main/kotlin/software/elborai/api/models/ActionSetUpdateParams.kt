...
class ActionSetUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    fun openAPIUrl(): Optional<String> = Optional.ofNullable(openAPIUrl)

    fun serverUrl(): Optional<String> = Optional.ofNullable(serverUrl)
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val OPENAPI = Type(JsonField.of("OPEN_API"))
