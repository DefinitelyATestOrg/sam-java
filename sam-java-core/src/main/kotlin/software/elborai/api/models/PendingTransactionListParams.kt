...
class PendingTransactionListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.sourceId?.let {
          params.put("source_id", listOf(it.toString()))
      }
    ...
    override fun toString() = "PendingTransactionListParams{accountId=$accountId, category=$category, createdAt=$createdAt, cursor=$cursor, limit=$limit, routeId=$routeId, sourceId=$sourceId, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Category private constructor(private val in_: List<In>?, private val additionalProperties: Map<String, List<String>>, ) {
        ...
        class In @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
            ...
            companion object {
                ...
                @JvmField val ACCOUNT_TRANSFER_INSTRUCTION = In(JsonField.of("account_transfer_instruction"))

                @JvmField val ACH_TRANSFER_INSTRUCTION = In(JsonField.of("ach_transfer_instruction"))

                @JvmField val CARD_AUTHORIZATION = In(JsonField.of("card_authorization"))

                @JvmField val CHECK_DEPOSIT_INSTRUCTION = In(JsonField.of("check_deposit_instruction"))

                @JvmField val CHECK_TRANSFER_INSTRUCTION = In(JsonField.of("check_transfer_instruction"))

                @JvmField val INBOUND_FUNDS_HOLD = In(JsonField.of("inbound_funds_hold"))

                @JvmField val REAL_TIME_PAYMENTS_TRANSFER_INSTRUCTION = In(JsonField.of("real_time_payments_transfer_instruction"))

                @JvmField val WIRE_TRANSFER_INSTRUCTION = In(JsonField.of("wire_transfer_instruction"))
