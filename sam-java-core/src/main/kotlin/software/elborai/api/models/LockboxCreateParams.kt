...
class LockboxCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class LockboxCreateBody internal constructor(private val accountId: String?, private val description: String?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "LockboxCreateBody{accountId=$accountId, description=$description, additionalProperties=$additionalProperties}"
    ...
    override fun toString() = "LockboxCreateParams{accountId=$accountId, description=$description, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
