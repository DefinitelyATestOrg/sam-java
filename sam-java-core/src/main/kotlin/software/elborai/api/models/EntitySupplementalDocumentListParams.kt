...
class EntitySupplementalDocumentListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "EntitySupplementalDocumentListParams{entityId=$entityId, cursor=$cursor, idempotencyKey=$idempotencyKey, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(entitySupplementalDocumentListParams: EntitySupplementalDocumentListParams) = apply {
        ...
        fun build(): EntitySupplementalDocumentListParams = EntitySupplementalDocumentListParams(
