...
constructor(
    ...
    fun complete(): Optional<Boolean> = Optional.ofNullable(complete)

    fun petId(): Optional<Long> = Optional.ofNullable(petId)

    fun quantity(): Optional<Long> = Optional.ofNullable(quantity)

    fun shipDate(): Optional<OffsetDateTime> = Optional.ofNullable(shipDate)
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val PLACED = Status(JsonField.of("placed"))

            @JvmField val APPROVED = Status(JsonField.of("approved"))

            @JvmField val DELIVERED = Status(JsonField.of("delivered"))
