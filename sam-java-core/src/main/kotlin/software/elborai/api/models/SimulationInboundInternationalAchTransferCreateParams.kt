...
class SimulationInboundInternationalAchTransferCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    fun originatorCompanyEntryDescription(): Optional<String> = Optional.ofNullable(originatorCompanyEntryDescription)

    fun originatorName(): Optional<String> = Optional.ofNullable(originatorName)

    fun receivingCompanyOrIndividualName(): Optional<String> = Optional.ofNullable(receivingCompanyOrIndividualName)
