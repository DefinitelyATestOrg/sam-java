...
class SimulationAchTransferNotificationOfChangeParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class SimulationAchTransferNotificationOfChangeBody internal constructor(private val changeCode: ChangeCode?, private val correctedData: String?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "SimulationAchTransferNotificationOfChangeBody{changeCode=$changeCode, correctedData=$correctedData, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(simulationAchTransferNotificationOfChangeBody: SimulationAchTransferNotificationOfChangeBody) = apply {
                ...
                additionalProperties(simulationAchTransferNotificationOfChangeBody.additionalProperties)
            }
            ...
            fun build(): SimulationAchTransferNotificationOfChangeBody = SimulationAchTransferNotificationOfChangeBody(
    ...
    override fun toString() = "SimulationAchTransferNotificationOfChangeParams{achTransferId=$achTransferId, changeCode=$changeCode, correctedData=$correctedData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(simulationAchTransferNotificationOfChangeParams: SimulationAchTransferNotificationOfChangeParams) = apply {
            ...
            additionalQueryParams(simulationAchTransferNotificationOfChangeParams.additionalQueryParams)
            additionalHeaders(simulationAchTransferNotificationOfChangeParams.additionalHeaders)
            additionalBodyProperties(simulationAchTransferNotificationOfChangeParams.additionalBodyProperties)
        }
        ...
        fun build(): SimulationAchTransferNotificationOfChangeParams = SimulationAchTransferNotificationOfChangeParams(
