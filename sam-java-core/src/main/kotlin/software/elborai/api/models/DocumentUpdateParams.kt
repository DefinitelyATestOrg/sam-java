...
constructor(
    ...
    fun corpusPolicy(): Optional<CorpusPolicy> = Optional.ofNullable(corpusPolicy)

    fun createdBy(): Optional<CreatedBy> = Optional.ofNullable(createdBy)

    fun externalLookupKey(): Optional<String> = Optional.ofNullable(externalLookupKey)

    fun languageCode(): Optional<LanguageCode> = Optional.ofNullable(languageCode)

    fun processingVersion(): Optional<Long> = Optional.ofNullable(processingVersion)

    fun sourceAuthor(): Optional<String> = Optional.ofNullable(sourceAuthor)

    fun sourceCreatedAt(): Optional<OffsetDateTime> = Optional.ofNullable(sourceCreatedAt)

    fun sourceUpdatedAt(): Optional<OffsetDateTime> = Optional.ofNullable(sourceUpdatedAt)
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val INCLUDE = CorpusPolicy(JsonField.of("INCLUDE"))

            @JvmField val EXCLUDE_ALWAYS = CorpusPolicy(JsonField.of("EXCLUDE_ALWAYS"))

            @JvmStatic fun of(value: String) = CorpusPolicy(JsonField.of(value))
        }
