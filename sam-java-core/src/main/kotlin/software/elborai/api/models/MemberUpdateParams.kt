...
constructor(
    ...
    fun pictureUrl(): Optional<String> = Optional.ofNullable(pictureUrl)

    fun role(): Optional<Role> = Optional.ofNullable(role)
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val OWNER = Role(JsonField.of("OWNER"))

            @JvmField val ADMIN = Role(JsonField.of("ADMIN"))

            @JvmField val READER = Role(JsonField.of("READER"))
