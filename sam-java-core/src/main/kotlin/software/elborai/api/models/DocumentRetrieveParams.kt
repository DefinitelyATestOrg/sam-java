...
class DocumentRetrieveParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    fun text(): Optional<Boolean> = Optional.ofNullable(text)

    @JvmSynthetic
    internal fun getQueryParams(): Map<String, List<String>> {
      val params = mutableMapOf<String, List<String>>()
      this.text?.let {
          params.put("text", listOf(it.toString()))
      }
    ...
    override fun toString() = "DocumentRetrieveParams{docId=$docId, text=$text, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
