...
class RealTimePaymentsTransfer private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
     ...
     */
    fun ultimateCreditorName(): Optional<String> = Optional.ofNullable(ultimateCreditorName.getNullable("ultimate_creditor_name"))

    /**
     * The name of the ultimate sender of the transfer. Set this if the funds are being
     * sent on behalf of someone who is not the account holder at Increase.
     */
    fun ultimateDebtorName(): Optional<String> = Optional.ofNullable(ultimateDebtorName.getNullable("ultimate_debtor_name"))
    ...
    class Rejection private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
         ...
         */
        fun rejectReasonAdditionalInformation(): Optional<String> = Optional.ofNullable(rejectReasonAdditionalInformation.getNullable("reject_reason_additional_information"))
         ...
         */
        fun rejectedAt(): Optional<OffsetDateTime> = Optional.ofNullable(rejectedAt.getNullable("rejected_at"))
        ...
        class RejectReasonCode @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
            ...
            companion object {
                ...
                @JvmField val INVALID_CREDITOR_ACCOUNT_TYPE = RejectReasonCode(JsonField.of("invalid_creditor_account_type"))

                @JvmField val INVALID_CREDITOR_ACCOUNT_NUMBER = RejectReasonCode(JsonField.of("invalid_creditor_account_number"))

                @JvmField val INVALID_CREDITOR_FINANCIAL_INSTITUTION_IDENTIFIER = RejectReasonCode(JsonField.of("invalid_creditor_financial_institution_identifier"))

                @JvmField val END_CUSTOMER_DECEASED = RejectReasonCode(JsonField.of("end_customer_deceased"))

                @JvmField val NARRATIVE = RejectReasonCode(JsonField.of("narrative"))

                @JvmField val TRANSACTION_FORBIDDEN = RejectReasonCode(JsonField.of("transaction_forbidden"))

                @JvmField val TRANSACTION_TYPE_NOT_SUPPORTED = RejectReasonCode(JsonField.of("transaction_type_not_supported"))

                @JvmField val UNEXPECTED_AMOUNT = RejectReasonCode(JsonField.of("unexpected_amount"))

                @JvmField val AMOUNT_EXCEEDS_BANK_LIMITS = RejectReasonCode(JsonField.of("amount_exceeds_bank_limits"))

                @JvmField val INVALID_CREDITOR_ADDRESS = RejectReasonCode(JsonField.of("invalid_creditor_address"))

                @JvmField val UNKNOWN_END_CUSTOMER = RejectReasonCode(JsonField.of("unknown_end_customer"))

                @JvmField val INVALID_DEBTOR_ADDRESS = RejectReasonCode(JsonField.of("invalid_debtor_address"))

                @JvmField val TIMEOUT = RejectReasonCode(JsonField.of("timeout"))

                @JvmField val UNSUPPORTED_MESSAGE_FOR_RECIPIENT = RejectReasonCode(JsonField.of("unsupported_message_for_recipient"))

                @JvmField val RECIPIENT_CONNECTION_NOT_AVAILABLE = RejectReasonCode(JsonField.of("recipient_connection_not_available"))

                @JvmField val REAL_TIME_PAYMENTS_SUSPENDED = RejectReasonCode(JsonField.of("real_time_payments_suspended"))

                @JvmField val INSTRUCTED_AGENT_SIGNED_OFF = RejectReasonCode(JsonField.of("instructed_agent_signed_off"))
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            @JvmField val REAL_TIME_PAYMENTS_TRANSFER = Type(JsonField.of("real_time_payments_transfer"))
