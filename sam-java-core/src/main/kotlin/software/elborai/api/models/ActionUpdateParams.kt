...
constructor(
    ...
    fun actionSetId(): Optional<String> = Optional.ofNullable(actionSetId)

    fun agentId(): Optional<String> = Optional.ofNullable(agentId)

    fun createdBy(): Optional<CreatedBy> = Optional.ofNullable(createdBy)

    fun description(): Optional<String> = Optional.ofNullable(description)

    fun errorMessage(): Optional<String> = Optional.ofNullable(errorMessage)

    fun method(): Optional<Method> = Optional.ofNullable(method)

    fun name(): Optional<String> = Optional.ofNullable(name)

    fun parameters(): Optional<List<Parameter>> = Optional.ofNullable(parameters)

    fun path(): Optional<String> = Optional.ofNullable(path)

    fun requestBodyType(): Optional<RequestBodyType> = Optional.ofNullable(requestBodyType)

    fun status(): Optional<Status> = Optional.ofNullable(status)

    fun updatedBy(): Optional<UpdatedBy> = Optional.ofNullable(updatedBy)
    ...
    internal constructor(
        ...
        @JsonProperty("actionSetId") fun actionSetId(): String? = actionSetId
        ...
        @JsonProperty("errorMessage") fun errorMessage(): String? = errorMessage

        @JsonProperty("method") fun method(): Method? = method

        @JsonProperty("name") fun name(): String? = name

        @JsonProperty("parameters") fun parameters(): List<Parameter>? = parameters

        @JsonProperty("path") fun path(): String? = path

        @JsonProperty("requestBodyType") fun requestBodyType(): RequestBodyType? = requestBodyType
        ...
        override fun toString() =
            "ActionUpdateBody{actionSetId=$actionSetId, agentId=$agentId, createdBy=$createdBy, description=$description, errorMessage=$errorMessage, method=$method, name=$name, parameters=$parameters, path=$path, requestBodyType=$requestBodyType, status=$status, updatedBy=$updatedBy, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun actionSetId(actionSetId: String) = apply { this.actionSetId = actionSetId }
    ...
    override fun toString() =
        "ActionUpdateParams{actionId=$actionId, actionSetId=$actionSetId, agentId=$agentId, createdBy=$createdBy, description=$description, errorMessage=$errorMessage, method=$method, name=$name, parameters=$parameters, path=$path, requestBodyType=$requestBodyType, status=$status, updatedBy=$updatedBy, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): ActionUpdateParams =
            ActionUpdateParams(
                checkNotNull(actionId) { "`actionId` is required but was not set" },
                actionSetId,
                agentId,
                createdBy,
                description,
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmField val GET = Method(JsonField.of("GET"))

            @JvmField val POST = Method(JsonField.of("POST"))

            @JvmField val PUT = Method(JsonField.of("PUT"))

            @JvmField val DELETE = Method(JsonField.of("DELETE"))
    ...
    private constructor(
        ...
        @JsonProperty("validationType") fun validationType(): ValidationType? = validationType

        @JsonProperty("required") fun required(): Boolean? = required
        ...
        override fun toString() =
            "Parameter{type=$type, name=$name, description=$description, validationType=$validationType, required=$required, status=$status, errorMessage=$errorMessage, additionalProperties=$additionalProperties}"
        ...
        private constructor(
            ...
            companion object {
                ...
                @JvmField val USER_CONTEXT = Status(JsonField.of("USER_CONTEXT"))

                @JvmField val EDITABLE = Status(JsonField.of("EDITABLE"))

                @JvmField val UNSUPPORTED = Status(JsonField.of("UNSUPPORTED"))
        ...
        private constructor(
            ...
            companion object {
                ...
                @JvmField val PATH = Type(JsonField.of("PATH"))

                @JvmField val QUERY = Type(JsonField.of("QUERY"))

                @JvmField val BODY = Type(JsonField.of("BODY"))
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is ValidationType && this.value == other.value
            }
            ...
            companion object {
                ...
                @JvmField val STRING = ValidationType(JsonField.of("STRING"))

                @JvmField val BOOLEAN = ValidationType(JsonField.of("BOOLEAN"))

                @JvmField val NUMBER = ValidationType(JsonField.of("NUMBER"))

                @JvmStatic fun of(value: String) = ValidationType(JsonField.of(value))
            }
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is RequestBodyType && this.value == other.value
        }
        ...
        companion object {
            ...
            @JvmField val JSON = RequestBodyType(JsonField.of("JSON"))

            @JvmStatic fun of(value: String) = RequestBodyType(JsonField.of(value))
        }
