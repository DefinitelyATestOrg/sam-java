...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SamError && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    class Builder {
        ...
        fun from(error: SamError) = apply { additionalProperties(error.additionalProperties) }
