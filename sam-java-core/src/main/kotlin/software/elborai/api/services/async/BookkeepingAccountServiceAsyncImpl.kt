...
class BookkeepingAccountServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : BookkeepingAccountServiceAsync {
    ...
    override fun create(params: BookkeepingAccountCreateParams, requestOptions: RequestOptions): CompletableFuture<BookkeepingAccount> {
    ...
    override fun update(params: BookkeepingAccountUpdateParams, requestOptions: RequestOptions): CompletableFuture<BookkeepingAccount> {
      val request = HttpRequest.builder()
    ...
    override fun list(params: BookkeepingAccountListParams, requestOptions: RequestOptions): CompletableFuture<BookkeepingAccountListPageAsync> {
      val request = HttpRequest.builder()
    ...
    override fun balance(params: BookkeepingAccountBalanceParams, requestOptions: RequestOptions): CompletableFuture<BookkeepingBalanceLookup> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
