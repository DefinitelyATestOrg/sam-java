...
class ReferenceSessionServiceImpl constructor(private val clientOptions: ClientOptions, ) : ReferenceSessionService {
    ...
    override fun retrieve(params: ReferenceSessionRetrieveParams, requestOptions: RequestOptions): BinaryResponseContent {
    ...
    override fun update(params: ReferenceSessionUpdateParams, requestOptions: RequestOptions): BinaryResponseContent {
      val request = HttpRequest.builder()
