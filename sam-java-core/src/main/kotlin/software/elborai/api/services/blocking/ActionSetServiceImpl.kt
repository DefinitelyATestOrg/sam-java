...
class ActionSetServiceImpl constructor(private val clientOptions: ClientOptions, ) : ActionSetService {
    ...
    override fun retrieve(params: ActionSetRetrieveParams, requestOptions: RequestOptions): BinaryResponseContent {
    ...
    override fun update(params: ActionSetUpdateParams, requestOptions: RequestOptions): BinaryResponseContent {
      val request = HttpRequest.builder()
    ...
    override fun delete(params: ActionSetDeleteParams, requestOptions: RequestOptions) {
      val request = HttpRequest.builder()
