...
class PhysicalCardServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : PhysicalCardServiceAsync {
     ...
     * failed delivery.
     */
    override fun shipmentAdvance(params: SimulationPhysicalCardShipmentAdvanceParams, requestOptions: RequestOptions): CompletableFuture<PhysicalCard> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("simulations", "physical_cards", params.getPathParam(0), "shipment_advance")
      ...
      .thenApply { response -> 
          response.use {
              shipmentAdvanceHandler.handle(it)
          }
          .apply  {
