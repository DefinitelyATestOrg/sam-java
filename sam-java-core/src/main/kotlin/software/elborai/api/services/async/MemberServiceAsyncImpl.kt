...
class MemberServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : MemberServiceAsync {
    ...
    override fun update(params: MemberUpdateParams, requestOptions: RequestOptions): CompletableFuture<BinaryResponseContent> {
    ...
    override fun delete(params: MemberDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void> {
      val request = HttpRequest.builder()
