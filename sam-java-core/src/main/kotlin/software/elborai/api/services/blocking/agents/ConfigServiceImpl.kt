...
class ConfigServiceImpl constructor(private val clientOptions: ClientOptions, ) : ConfigService {
    ...
    override fun retrieve(params: AgentConfigRetrieveParams, requestOptions: RequestOptions): BinaryResponseContent {
    ...
    override fun update(params: AgentConfigUpdateParams, requestOptions: RequestOptions): BinaryResponseContent {
      val request = HttpRequest.builder()
