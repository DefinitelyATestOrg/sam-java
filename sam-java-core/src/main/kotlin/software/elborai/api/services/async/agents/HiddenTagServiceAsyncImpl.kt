...
class HiddenTagServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : HiddenTagServiceAsync {
    ...
    override fun update(params: AgentHiddenTagUpdateParams, requestOptions: RequestOptions): CompletableFuture<BinaryResponseContent> {
