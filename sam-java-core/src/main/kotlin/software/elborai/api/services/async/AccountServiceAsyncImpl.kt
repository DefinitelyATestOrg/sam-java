...
class AccountServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : AccountServiceAsync {
    ...
    /** Create an Account */
    override fun create(params: AccountCreateParams, requestOptions: RequestOptions): CompletableFuture<Account> {
    ...
    /** Retrieve an Account */
    override fun retrieve(params: AccountRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Account> {
      val request = HttpRequest.builder()
    ...
    /** Update an Account */
    override fun update(params: AccountUpdateParams, requestOptions: RequestOptions): CompletableFuture<Account> {
      val request = HttpRequest.builder()
    ...
    /** List Accounts */
    override fun list(params: AccountListParams, requestOptions: RequestOptions): CompletableFuture<AccountListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("accounts")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun balance(params: AccountBalanceParams, requestOptions: RequestOptions): CompletableFuture<BalanceLookup> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
    ...
    /** Close an Account */
    override fun close(params: AccountCloseParams, requestOptions: RequestOptions): CompletableFuture<Account> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
