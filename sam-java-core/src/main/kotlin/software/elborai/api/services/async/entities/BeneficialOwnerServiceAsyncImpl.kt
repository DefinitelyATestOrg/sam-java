...
class BeneficialOwnerServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : BeneficialOwnerServiceAsync {
    ...
    override fun create(params: EntityBeneficialOwnerCreateParams, requestOptions: RequestOptions): CompletableFuture<Entity> {
    ...
    override fun archive(params: EntityBeneficialOwnerArchiveParams, requestOptions: RequestOptions): CompletableFuture<Entity> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override fun updateAddress(params: EntityBeneficialOwnerUpdateAddressParams, requestOptions: RequestOptions): CompletableFuture<Entity> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
