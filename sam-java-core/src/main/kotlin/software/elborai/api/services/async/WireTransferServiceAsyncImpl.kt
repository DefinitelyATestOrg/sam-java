...
class WireTransferServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : WireTransferServiceAsync {
    ...
    override fun create(params: WireTransferCreateParams, requestOptions: RequestOptions): CompletableFuture<WireTransfer> {
    ...
    override fun retrieve(params: WireTransferRetrieveParams, requestOptions: RequestOptions): CompletableFuture<WireTransfer> {
      val request = HttpRequest.builder()
    ...
    /** List Wire Transfers */
    override fun list(params: WireTransferListParams, requestOptions: RequestOptions): CompletableFuture<WireTransferListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("wire_transfers")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun approve(params: WireTransferApproveParams, requestOptions: RequestOptions): CompletableFuture<WireTransfer> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override fun cancel(params: WireTransferCancelParams, requestOptions: RequestOptions): CompletableFuture<WireTransfer> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun reverse(params: WireTransferReverseParams, requestOptions: RequestOptions): CompletableFuture<WireTransfer> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * `pending_creating`.
     */
    override fun submit(params: WireTransferSubmitParams, requestOptions: RequestOptions): CompletableFuture<WireTransfer> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
