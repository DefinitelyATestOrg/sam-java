...
class BookkeepingEntryServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : BookkeepingEntryServiceAsync {
    ...
    override fun retrieve(params: BookkeepingEntryRetrieveParams, requestOptions: RequestOptions): CompletableFuture<BookkeepingEntry> {
    ...
    override fun list(params: BookkeepingEntryListParams, requestOptions: RequestOptions): CompletableFuture<BookkeepingEntryListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
