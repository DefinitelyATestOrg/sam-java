...
interface WireTransferServiceAsync {
    ...
    @JvmOverloads
    fun createInbound(params: SimulationWireTransferCreateInboundParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<InboundWireTransfer>
}
