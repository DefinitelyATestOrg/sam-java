...
interface CheckDepositServiceAsync {
     ...
     */
    @JvmOverloads
    fun reject(params: SimulationCheckDepositRejectParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CheckDeposit>
     ...
     */
    @JvmOverloads
    fun return_(params: SimulationCheckDepositReturnParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CheckDeposit>
     ...
     */
    @JvmOverloads
    fun submit(params: SimulationCheckDepositSubmitParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CheckDeposit>
}
