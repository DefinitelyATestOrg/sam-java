...
class SimulationServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : SimulationServiceAsync {
    ...
    private val inboundInternationalAchTransfers: InboundInternationalAchTransferServiceAsync by lazy { InboundInternationalAchTransferServiceAsyncImpl(clientOptions) }
    ...
    override fun inboundInternationalAchTransfers(): InboundInternationalAchTransferServiceAsync = inboundInternationalAchTransfers
    ...
    override fun cardAuthorizationExpirations(params: SimulationCardAuthorizationExpirationsParams, requestOptions: RequestOptions): CompletableFuture<CardPayment> {
     ...
     */
    override fun cardFuelConfirmations(params: SimulationCardFuelConfirmationsParams, requestOptions: RequestOptions): CompletableFuture<CardPayment> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun cardIncrements(params: SimulationCardIncrementsParams, requestOptions: RequestOptions): CompletableFuture<CardPayment> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * reversed.
     */
    override fun cardReversals(params: SimulationCardReversalsParams, requestOptions: RequestOptions): CompletableFuture<CardPayment> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
