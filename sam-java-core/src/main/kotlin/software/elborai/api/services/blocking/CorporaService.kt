...
interface CorporaService {
    ...
    @JvmOverloads
    fun retrieve(params: CorporaRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): BinaryResponseContent

    @JvmOverloads
    fun update(params: CorporaUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): BinaryResponseContent
