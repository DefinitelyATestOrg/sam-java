...
class ReferenceSessionServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ReferenceSessionServiceAsync {
    ...
    override fun retrieve(params: ReferenceSessionRetrieveParams, requestOptions: RequestOptions): CompletableFuture<BinaryResponseContent> {
    ...
    override fun update(params: ReferenceSessionUpdateParams, requestOptions: RequestOptions): CompletableFuture<BinaryResponseContent> {
      val request = HttpRequest.builder()
    ...
    override fun delete(params: ReferenceSessionDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void> {
      val request = HttpRequest.builder()
