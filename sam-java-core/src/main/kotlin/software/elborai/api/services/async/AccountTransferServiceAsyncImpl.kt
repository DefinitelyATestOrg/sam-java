...
class AccountTransferServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : AccountTransferServiceAsync {
    ...
    override fun create(params: AccountTransferCreateParams, requestOptions: RequestOptions): CompletableFuture<AccountTransfer> {
    ...
    override fun retrieve(params: AccountTransferRetrieveParams, requestOptions: RequestOptions): CompletableFuture<AccountTransfer> {
      val request = HttpRequest.builder()
    ...
    override fun list(params: AccountTransferListParams, requestOptions: RequestOptions): CompletableFuture<AccountTransferListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("account_transfers")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun approve(params: AccountTransferApproveParams, requestOptions: RequestOptions): CompletableFuture<AccountTransfer> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override fun cancel(params: AccountTransferCancelParams, requestOptions: RequestOptions): CompletableFuture<AccountTransfer> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
