...
class MemberServiceImpl constructor(private val clientOptions: ClientOptions, ) : MemberService {
    ...
    override fun update(params: MemberUpdateParams, requestOptions: RequestOptions): BinaryResponseContent {
