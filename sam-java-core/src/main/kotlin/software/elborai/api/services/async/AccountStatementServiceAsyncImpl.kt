...
class AccountStatementServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : AccountStatementServiceAsync {
    ...
    override fun retrieve(params: AccountStatementRetrieveParams, requestOptions: RequestOptions): CompletableFuture<AccountStatement> {
    ...
    override fun list(params: AccountStatementListParams, requestOptions: RequestOptions): CompletableFuture<AccountStatementListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
