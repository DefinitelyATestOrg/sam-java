...
class AchPrenotificationServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : AchPrenotificationServiceAsync {
    ...
    override fun create(params: AchPrenotificationCreateParams, requestOptions: RequestOptions): CompletableFuture<AchPrenotification> {
    ...
    override fun retrieve(params: AchPrenotificationRetrieveParams, requestOptions: RequestOptions): CompletableFuture<AchPrenotification> {
      val request = HttpRequest.builder()
    ...
    override fun list(params: AchPrenotificationListParams, requestOptions: RequestOptions): CompletableFuture<AchPrenotificationListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("ach_prenotifications")
        .putAllQueryParams(clientOptions.queryParams)
