...
class IndustryCodeServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : IndustryCodeServiceAsync {
    ...
    override fun create(params: EntityIndustryCodeCreateParams, requestOptions: RequestOptions): CompletableFuture<Entity> {
