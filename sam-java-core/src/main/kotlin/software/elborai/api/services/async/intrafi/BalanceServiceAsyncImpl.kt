...
class BalanceServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : BalanceServiceAsync {
    ...
    override fun retrieve(params: IntrafiBalanceRetrieveParams, requestOptions: RequestOptions): CompletableFuture<IntrafiBalance> {
