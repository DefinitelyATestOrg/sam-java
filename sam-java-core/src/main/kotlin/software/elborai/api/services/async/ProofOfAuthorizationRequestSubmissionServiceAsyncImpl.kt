...
class ProofOfAuthorizationRequestSubmissionServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ProofOfAuthorizationRequestSubmissionServiceAsync {
    ...
    override fun create(params: ProofOfAuthorizationRequestSubmissionCreateParams, requestOptions: RequestOptions): CompletableFuture<ProofOfAuthorizationRequestSubmission> {
    ...
    override fun retrieve(params: ProofOfAuthorizationRequestSubmissionRetrieveParams, requestOptions: RequestOptions): CompletableFuture<ProofOfAuthorizationRequestSubmission> {
      val request = HttpRequest.builder()
    ...
    override fun list(params: ProofOfAuthorizationRequestSubmissionListParams, requestOptions: RequestOptions): CompletableFuture<ProofOfAuthorizationRequestSubmissionListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("proof_of_authorization_request_submissions")
        .putAllQueryParams(clientOptions.queryParams)
