...
interface CardService {
     ...
     */
    @JvmOverloads
    fun authorize(params: SimulationCardAuthorizeParams, requestOptions: RequestOptions = RequestOptions.none()): CardAuthorizationSimulation
     ...
     */
    @JvmOverloads
    fun settlement(params: SimulationCardSettlementParams, requestOptions: RequestOptions = RequestOptions.none()): Transaction
}
