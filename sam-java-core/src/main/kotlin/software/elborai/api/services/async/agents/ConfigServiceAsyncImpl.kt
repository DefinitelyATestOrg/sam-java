...
class ConfigServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ConfigServiceAsync {
    ...
    override fun retrieve(params: AgentConfigRetrieveParams, requestOptions: RequestOptions): CompletableFuture<BinaryResponseContent> {
    ...
    override fun update(params: AgentConfigUpdateParams, requestOptions: RequestOptions): CompletableFuture<BinaryResponseContent> {
      val request = HttpRequest.builder()
