...
interface ProofOfAuthorizationRequestSubmissionServiceAsync {
    ...
    @JvmOverloads
    fun list(params: ProofOfAuthorizationRequestSubmissionListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ProofOfAuthorizationRequestSubmissionListPageAsync>
}
