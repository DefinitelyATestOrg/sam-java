...
class DocumentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : DocumentServiceAsync {
    ...
    /** Retrieve a Document */
    override fun retrieve(params: DocumentRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Document> {
    ...
    /** List Documents */
    override fun list(params: DocumentListParams, requestOptions: RequestOptions): CompletableFuture<DocumentListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
