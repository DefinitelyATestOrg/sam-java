...
class AccountEnrollmentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : AccountEnrollmentServiceAsync {
    ...
    override fun create(params: IntrafiAccountEnrollmentCreateParams, requestOptions: RequestOptions): CompletableFuture<IntrafiAccountEnrollment> {
    ...
    override fun retrieve(params: IntrafiAccountEnrollmentRetrieveParams, requestOptions: RequestOptions): CompletableFuture<IntrafiAccountEnrollment> {
      val request = HttpRequest.builder()
    ...
    override fun list(params: IntrafiAccountEnrollmentListParams, requestOptions: RequestOptions): CompletableFuture<IntrafiAccountEnrollmentListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("intrafi_account_enrollments")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun unenroll(params: IntrafiAccountEnrollmentUnenrollParams, requestOptions: RequestOptions): CompletableFuture<IntrafiAccountEnrollment> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
