...
class SupplementalDocumentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : SupplementalDocumentServiceAsync {
    ...
    override fun create(params: EntitySupplementalDocumentCreateParams, requestOptions: RequestOptions): CompletableFuture<Entity> {
    ...
    override fun list(params: EntitySupplementalDocumentListParams, requestOptions: RequestOptions): CompletableFuture<EntitySupplementalDocumentListPageAsync> {
      val request = HttpRequest.builder()
      ...
      .thenApply { response -> 
          ...
          .let {
              EntitySupplementalDocumentListPageAsync.of(this, params, it)
          }
      }
    }
}
