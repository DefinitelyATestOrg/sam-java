...
class DigitalCardProfileServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : DigitalCardProfileServiceAsync {
    ...
    override fun create(params: DigitalCardProfileCreateParams, requestOptions: RequestOptions): CompletableFuture<DigitalCardProfile> {
    ...
    override fun retrieve(params: DigitalCardProfileRetrieveParams, requestOptions: RequestOptions): CompletableFuture<DigitalCardProfile> {
      val request = HttpRequest.builder()
    ...
    /** List Card Profiles */
    override fun list(params: DigitalCardProfileListParams, requestOptions: RequestOptions): CompletableFuture<DigitalCardProfileListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("digital_card_profiles")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun archive(params: DigitalCardProfileArchiveParams, requestOptions: RequestOptions): CompletableFuture<DigitalCardProfile> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override fun clone(params: DigitalCardProfileCloneParams, requestOptions: RequestOptions): CompletableFuture<DigitalCardProfile> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
