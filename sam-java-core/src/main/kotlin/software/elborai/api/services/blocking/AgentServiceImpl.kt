...
class AgentServiceImpl constructor(private val clientOptions: ClientOptions, ) : AgentService {
    ...
    override fun retrieve(params: AgentRetrieveParams, requestOptions: RequestOptions): BinaryResponseContent {
    ...
    override fun update(params: AgentUpdateParams, requestOptions: RequestOptions): BinaryResponseContent {
      val request = HttpRequest.builder()
