...
interface PetService {
    ...
    @JvmOverloads
    fun retrieve(params: PetRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): Pet
    ...
    @JvmOverloads
    fun findByStatus(params: PetFindByStatusParams, requestOptions: RequestOptions = RequestOptions.none()): List<Pet>
     ...
     */
    @JvmOverloads
    fun findByTags(params: PetFindByTagsParams, requestOptions: RequestOptions = RequestOptions.none()): List<Pet>

    /** uploads an image */
    @JvmOverloads
    fun uploadImage(params: PetUploadImageParams, requestOptions: RequestOptions = RequestOptions.none()): ApiResponse
}
