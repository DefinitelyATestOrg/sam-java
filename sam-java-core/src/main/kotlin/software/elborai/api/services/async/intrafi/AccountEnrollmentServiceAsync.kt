...
interface AccountEnrollmentServiceAsync {
    ...
    @JvmOverloads
    fun list(params: IntrafiAccountEnrollmentListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<IntrafiAccountEnrollmentListPageAsync>
