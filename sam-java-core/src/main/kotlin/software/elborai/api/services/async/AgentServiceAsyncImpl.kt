...
class AgentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : AgentServiceAsync {
    ...
    override fun retrieve(params: AgentRetrieveParams, requestOptions: RequestOptions): CompletableFuture<BinaryResponseContent> {
    ...
    override fun update(params: AgentUpdateParams, requestOptions: RequestOptions): CompletableFuture<BinaryResponseContent> {
      val request = HttpRequest.builder()
    ...
    override fun delete(params: AgentDeleteParams, requestOptions: RequestOptions): CompletableFuture<Void> {
      val request = HttpRequest.builder()
