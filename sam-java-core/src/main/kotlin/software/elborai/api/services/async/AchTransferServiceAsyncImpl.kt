...
class AchTransferServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : AchTransferServiceAsync {
    ...
    override fun create(params: AchTransferCreateParams, requestOptions: RequestOptions): CompletableFuture<AchTransfer> {
    ...
    override fun retrieve(params: AchTransferRetrieveParams, requestOptions: RequestOptions): CompletableFuture<AchTransfer> {
      val request = HttpRequest.builder()
    ...
    /** List ACH Transfers */
    override fun list(params: AchTransferListParams, requestOptions: RequestOptions): CompletableFuture<AchTransferListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("ach_transfers")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun approve(params: AchTransferApproveParams, requestOptions: RequestOptions): CompletableFuture<AchTransfer> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override fun cancel(params: AchTransferCancelParams, requestOptions: RequestOptions): CompletableFuture<AchTransfer> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
