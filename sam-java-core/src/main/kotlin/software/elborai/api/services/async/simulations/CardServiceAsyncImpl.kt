...
class CardServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : CardServiceAsync {
     ...
     */
    override fun authorize(params: SimulationCardAuthorizeParams, requestOptions: RequestOptions): CompletableFuture<CardAuthorizationSimulation> {
     ...
     */
    override fun settlement(params: SimulationCardSettlementParams, requestOptions: RequestOptions): CompletableFuture<Transaction> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
