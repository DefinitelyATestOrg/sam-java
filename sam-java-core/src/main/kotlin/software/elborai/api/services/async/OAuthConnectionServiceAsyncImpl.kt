...
class OAuthConnectionServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : OAuthConnectionServiceAsync {
    ...
    override fun retrieve(params: OAuthConnectionRetrieveParams, requestOptions: RequestOptions): CompletableFuture<OAuthConnection> {
    ...
    override fun list(params: OAuthConnectionListParams, requestOptions: RequestOptions): CompletableFuture<OAuthConnectionListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
