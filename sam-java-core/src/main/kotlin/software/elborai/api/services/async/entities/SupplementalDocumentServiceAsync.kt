...
interface SupplementalDocumentServiceAsync {
    ...
    @JvmOverloads
    fun create(params: EntitySupplementalDocumentCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Entity>

    /** List Entity Supplemental Document Submissions */
    @JvmOverloads
    fun list(params: EntitySupplementalDocumentListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<EntitySupplementalDocumentListPageAsync>
}
