...
class ExternalAccountServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ExternalAccountServiceAsync {
    ...
    override fun create(params: ExternalAccountCreateParams, requestOptions: RequestOptions): CompletableFuture<ExternalAccount> {
    ...
    override fun retrieve(params: ExternalAccountRetrieveParams, requestOptions: RequestOptions): CompletableFuture<ExternalAccount> {
      val request = HttpRequest.builder()
    ...
    override fun update(params: ExternalAccountUpdateParams, requestOptions: RequestOptions): CompletableFuture<ExternalAccount> {
      val request = HttpRequest.builder()
    ...
    override fun list(params: ExternalAccountListParams, requestOptions: RequestOptions): CompletableFuture<ExternalAccountListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("external_accounts")
        .putAllQueryParams(clientOptions.queryParams)
