...
class EntityServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : EntityServiceAsync {
    ...
    /** Create an Entity */
    override fun create(params: EntityCreateParams, requestOptions: RequestOptions): CompletableFuture<Entity> {
    ...
    /** Retrieve an Entity */
    override fun retrieve(params: EntityRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Entity> {
      val request = HttpRequest.builder()
    ...
    /** Archive an Entity */
    override fun archive(params: EntityArchiveParams, requestOptions: RequestOptions): CompletableFuture<Entity> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun confirm(params: EntityConfirmParams, requestOptions: RequestOptions): CompletableFuture<Entity> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override fun updateAddress(params: EntityUpdateAddressParams, requestOptions: RequestOptions): CompletableFuture<Entity> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
