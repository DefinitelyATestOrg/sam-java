...
class CorporaServiceImpl constructor(private val clientOptions: ClientOptions, ) : CorporaService {
    ...
    override fun retrieve(params: CorporaRetrieveParams, requestOptions: RequestOptions): BinaryResponseContent {
    ...
    override fun update(params: CorporaUpdateParams, requestOptions: RequestOptions): BinaryResponseContent {
      val request = HttpRequest.builder()
