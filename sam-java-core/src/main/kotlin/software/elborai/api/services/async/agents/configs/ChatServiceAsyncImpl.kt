...
class ChatServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ChatServiceAsync {
    ...
    override fun retrieve(params: AgentConfigChatRetrieveParams, requestOptions: RequestOptions): CompletableFuture<BinaryResponseContent> {
    ...
    override fun update(params: AgentConfigChatUpdateParams, requestOptions: RequestOptions): CompletableFuture<BinaryResponseContent> {
      val request = HttpRequest.builder()
