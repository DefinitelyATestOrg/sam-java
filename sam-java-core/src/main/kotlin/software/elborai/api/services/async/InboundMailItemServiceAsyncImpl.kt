...
class InboundMailItemServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : InboundMailItemServiceAsync {
    ...
    override fun retrieve(params: InboundMailItemRetrieveParams, requestOptions: RequestOptions): CompletableFuture<InboundMailItem> {
    ...
    override fun list(params: InboundMailItemListParams, requestOptions: RequestOptions): CompletableFuture<InboundMailItemListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
