...
class ExclusionServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ExclusionServiceAsync {
    ...
    override fun create(params: IntrafiExclusionCreateParams, requestOptions: RequestOptions): CompletableFuture<IntrafiExclusion> {
    ...
    override fun retrieve(params: IntrafiExclusionRetrieveParams, requestOptions: RequestOptions): CompletableFuture<IntrafiExclusion> {
      val request = HttpRequest.builder()
    ...
    override fun list(params: IntrafiExclusionListParams, requestOptions: RequestOptions): CompletableFuture<IntrafiExclusionListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("intrafi_exclusions")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun archive(params: IntrafiExclusionArchiveParams, requestOptions: RequestOptions): CompletableFuture<IntrafiExclusion> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
