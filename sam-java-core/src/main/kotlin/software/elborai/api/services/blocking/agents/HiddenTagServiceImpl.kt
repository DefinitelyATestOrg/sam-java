...
class HiddenTagServiceImpl constructor(private val clientOptions: ClientOptions, ) : HiddenTagService {
    ...
    override fun update(params: AgentHiddenTagUpdateParams, requestOptions: RequestOptions): BinaryResponseContent {
