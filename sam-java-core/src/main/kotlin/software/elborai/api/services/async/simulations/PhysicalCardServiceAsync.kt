...
interface PhysicalCardServiceAsync {
     ...
     */
    @JvmOverloads
    fun shipmentAdvance(params: SimulationPhysicalCardShipmentAdvanceParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<PhysicalCard>
}
