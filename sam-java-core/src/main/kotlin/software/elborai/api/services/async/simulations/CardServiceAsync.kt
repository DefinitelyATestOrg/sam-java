...
interface CardServiceAsync {
     ...
     */
    @JvmOverloads
    fun authorize(params: SimulationCardAuthorizeParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CardAuthorizationSimulation>
     ...
     */
    @JvmOverloads
    fun settlement(params: SimulationCardSettlementParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Transaction>
}
