...
class InboundAchTransferServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : InboundAchTransferServiceAsync {
    ...
    override fun retrieve(params: InboundAchTransferRetrieveParams, requestOptions: RequestOptions): CompletableFuture<InboundAchTransfer> {
    ...
    override fun list(params: InboundAchTransferListParams, requestOptions: RequestOptions): CompletableFuture<InboundAchTransferListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
    ...
    override fun decline(params: InboundAchTransferDeclineParams, requestOptions: RequestOptions): CompletableFuture<InboundAchTransfer> {
      val request = HttpRequest.builder()
    ...
    override fun notificationOfChange(params: InboundAchTransferNotificationOfChangeParams, requestOptions: RequestOptions): CompletableFuture<InboundAchTransfer> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override fun transferReturn(params: InboundAchTransferTransferReturnParams, requestOptions: RequestOptions): CompletableFuture<InboundAchTransfer> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
