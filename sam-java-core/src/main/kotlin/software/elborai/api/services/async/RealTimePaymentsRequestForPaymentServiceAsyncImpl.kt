...
class RealTimePaymentsRequestForPaymentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : RealTimePaymentsRequestForPaymentServiceAsync {
    ...
    override fun create(params: RealTimePaymentsRequestForPaymentCreateParams, requestOptions: RequestOptions): CompletableFuture<RealTimePaymentsRequestForPayment> {
    ...
    override fun retrieve(params: RealTimePaymentsRequestForPaymentRetrieveParams, requestOptions: RequestOptions): CompletableFuture<RealTimePaymentsRequestForPayment> {
      val request = HttpRequest.builder()
    ...
    override fun list(params: RealTimePaymentsRequestForPaymentListParams, requestOptions: RequestOptions): CompletableFuture<RealTimePaymentsRequestForPaymentListPageAsync> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("real_time_payments_request_for_payments")
        .putAllQueryParams(clientOptions.queryParams)
