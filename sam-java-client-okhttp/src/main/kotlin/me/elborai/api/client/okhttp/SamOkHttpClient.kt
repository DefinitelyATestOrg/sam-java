...
/**
 * A class that allows building an instance of [SamClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class SamOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [SamClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): SamClient = builder().fromEnv().build()
    }

    /** A builder for [SamOkHttpClient]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [me.elborai.api.core.jsonMapper]. The default is usually sufficient and
         ...
         *
         * Defaults to the production environment: `/api/v3`.
         */
