...
package software.elborai.api.client.okhttp
...
import software.elborai.api.client.SamClientAsync
import software.elborai.api.client.SamClientAsyncImpl
...
class SamOkHttpClientAsync private constructor() {
    ...
    class Builder {
        ...
        fun build(): SamClientAsync {
          return SamClientAsyncImpl(clientOptions
